...
/* renamed from: androidx.customview.widget.b, reason: use source file name */
...
class FocusStrategy {
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f2501e = new Rect();

        /* renamed from: f, reason: collision with root package name */
        private final Rect f2502f = new Rect();

        /* renamed from: g, reason: collision with root package name */
        private final boolean f2503g;

        /* renamed from: h, reason: collision with root package name */
        private final a<T> f2504h;
        ...
        public int compare(T t7, T t10) {
            Rect rect = this.f2501e;
            Rect rect2 = this.f2502f;
            this.f2504h.a(t7, rect);
            this.f2504h.a(t10, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
    ...
    public static <L, T> T c(L l10, b<L, T> bVar, a<T> aVar, T t7, Rect rect, int i10) {
    ...
    public static <L, T> T d(L l10, b<L, T> bVar, a<T> aVar, T t7, int i10, boolean z10, boolean z11) {
        int b10 = bVar.b(l10);
        ...
        if (i10 == 1) {
            return (T) f(t7, arrayList, z11);
        }
        if (i10 == 2) {
            return (T) e(t7, arrayList, z11);
        }
        throw new IllegalArgumentException("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD}.");
    }

    private static <T> T e(T t7, ArrayList<T> arrayList, boolean z10) {
    ...
    private static <T> T f(T t7, ArrayList<T> arrayList, boolean z10) {
        int size = arrayList.size();

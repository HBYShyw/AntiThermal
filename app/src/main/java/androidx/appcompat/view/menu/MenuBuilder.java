...
/* renamed from: androidx.appcompat.view.menu.g, reason: use source file name */
...
public class MenuBuilder implements SupportMenu {
    ...
    private void setHeaderInternal(int i10, CharSequence charSequence, int i11, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i11 > 0) {
                this.mHeaderIcon = ContextCompat.e(getContext(), i11);
    ...
    private void setShortcutsVisibleInner(boolean z10) {
        this.mShortcutsVisible = z10 && this.mResources.getConfiguration().keyboard != 1 && ViewConfigurationCompat.c(ViewConfiguration.get(this.mContext), this.mContext);
    }
    ...
    public MenuItem addInternal(int i10, int i11, int i12, CharSequence charSequence) {
        ...
        if (contextMenuInfo != null) {
            createNewMenuItem.u(contextMenuInfo);
        }
    ...
    public void setGroupVisible(int i10, boolean z10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i11);
            if (menuItemImpl.getGroupId() == i10 && menuItemImpl.x(z10)) {
                z11 = true;
            }
        }
        if (z11) {
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i10) {
        ...
        boolean k10 = menuItemImpl.k();
        ActionProvider b10 = menuItemImpl.b();
        boolean z10 = b10 != null && b10.a();
        if (menuItemImpl.j()) {
            k10 |= menuItemImpl.expandActionView();
            if (k10) {
                close(true);
            }
            ...
            if (!menuItemImpl.hasSubMenu()) {
                menuItemImpl.w(new SubMenuBuilder(getContext(), this, menuItemImpl));
            }
            SubMenuBuilder subMenuBuilder = (SubMenuBuilder) menuItemImpl.getSubMenu();
            if (z10) {
                b10.f(subMenuBuilder);
            }
            k10 |= dispatchSubMenuSelected(subMenuBuilder, menuPresenter);
            if (!k10) {
                close(true);
            }
        } else if ((i10 & 1) == 0) {

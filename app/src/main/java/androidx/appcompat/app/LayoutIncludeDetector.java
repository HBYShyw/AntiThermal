...
/* renamed from: androidx.appcompat.app.l, reason: use source file name */
/* loaded from: classes.dex */
class LayoutIncludeDetector {

    /* renamed from: a, reason: collision with root package name */
    private final Deque<WeakReference<XmlPullParser>> f496a = new ArrayDeque();
    ...
    public boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser c10 = c(this.f496a);
        this.f496a.push(new WeakReference<>(xmlPullParser));

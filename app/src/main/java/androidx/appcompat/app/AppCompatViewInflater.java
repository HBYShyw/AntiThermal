...
/* renamed from: androidx.appcompat.app.i, reason: use source file name */
...
public class AppCompatViewInflater {
    ...
    public static class a implements View.OnClickListener {
        ...
        private void a(Context context) {
            ...
            int id2 = this.f486e.getId();
            if (id2 == -1) {
                str = "";
            } else {
                str = " with id '" + this.f486e.getContext().getResources().getResourceEntryName(id2) + "'";
            }
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if ((context instanceof ContextWrapper) && ViewCompat.L(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z10, boolean z11) {
        ...
        if (z11 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(R$styleable.View_theme, 0)) != 0) {

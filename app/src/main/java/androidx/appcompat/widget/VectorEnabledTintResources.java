...
/* renamed from: androidx.appcompat.widget.m0, reason: use source file name */
/* loaded from: classes.dex */
public class VectorEnabledTintResources extends ResourcesWrapper {

    /* renamed from: c, reason: collision with root package name */
    private static boolean f1264c = false;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference<Context> f1265b;

    public VectorEnabledTintResources(Context context, Resources resources) {
        super(resources);
        this.f1265b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f1265b.get();
        if (context != null) {
            return ResourceManagerInternal.g().s(context, this, i10);
        }
        return a(i10);
    }

...
/* renamed from: k.e, reason: use source file name */
/* loaded from: classes.dex */
public class MonotonicCurveFit extends CurveFit {

    /* renamed from: a, reason: collision with root package name */
    private double[] f13970a;

    /* renamed from: b, reason: collision with root package name */
    private double[][] f13971b;
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        for (int i14 = 0; i14 < i10; i14++) {
            for (int i15 = 0; i15 < length2; i15++) {
                if (dArr3[i14][i15] == UserProfileInfo.Constant.NA_LAT_LON) {
                    dArr4[i14][i15] = 0.0d;
    ...
    private static double i(double d10, double d11, double d12, double d13, double d14, double d15) {
        double d16 = d11 * d11;
        double d17 = d11 * 6.0d;
        double d18 = 3.0d * d10;
    ...
    public double c(double d10, int i10) {
        double[] dArr = this.f13970a;
        int length = dArr.length;
        int i11 = 0;
        if (d10 <= dArr[0]) {
            return this.f13971b[0][i10];
        }
        int i12 = length - 1;
        if (d10 >= dArr[i12]) {
            return this.f13971b[i12][i10];
        }
        while (i11 < i12) {
            double[] dArr2 = this.f13970a;
            if (d10 == dArr2[i11]) {
                return this.f13971b[i11][i10];
            }
            int i13 = i11 + 1;
            if (d10 < dArr2[i13]) {
                double d11 = dArr2[i13] - dArr2[i11];
                double d12 = (d10 - dArr2[i11]) / d11;
                double[][] dArr3 = this.f13971b;
                double d13 = dArr3[i11][i10];
                double d14 = dArr3[i13][i10];
                double[][] dArr4 = this.f13972c;
                return j(d11, d12, d13, d14, dArr4[i11][i10], dArr4[i13][i10]);
            }
            i11 = i13;
        }
    ...
    public void d(double d10, double[] dArr) {
        ...
        int i10 = 0;
        int length2 = this.f13971b[0].length;
        if (d10 <= dArr2[0]) {
            for (int i11 = 0; i11 < length2; i11++) {
                dArr[i11] = this.f13971b[0][i11];
            }
            return;
        }
        int i12 = length - 1;
        ...
        int i13 = 0;
        while (i13 < i12) {
            if (d10 == this.f13970a[i13]) {
                for (int i14 = 0; i14 < length2; i14++) {
                    dArr[i14] = this.f13971b[i13][i14];
                }
            }
            double[] dArr3 = this.f13970a;
            int i15 = i13 + 1;
            if (d10 < dArr3[i15]) {
                double d11 = dArr3[i15] - dArr3[i13];
                double d12 = (d10 - dArr3[i13]) / d11;
                while (i10 < length2) {
                    double[][] dArr4 = this.f13971b;
                    double d13 = dArr4[i13][i10];
                    double d14 = dArr4[i15][i10];
                    double[][] dArr5 = this.f13972c;
                    dArr[i10] = j(d11, d12, d13, d14, dArr5[i13][i10], dArr5[i15][i10]);
                    i10++;
                }
                return;
            }
    ...
    public void e(double d10, float[] fArr) {
        ...
        if (d10 <= dArr[0]) {
            for (int i11 = 0; i11 < length2; i11++) {
                fArr[i11] = (float) this.f13971b[0][i11];
            }
            return;
        }
        int i12 = length - 1;
        if (d10 >= dArr[i12]) {
            while (i10 < length2) {
                fArr[i10] = (float) this.f13971b[i12][i10];
                i10++;
            }
            return;
        }
        ...
        while (i13 < i12) {
            if (d10 == this.f13970a[i13]) {
                for (int i14 = 0; i14 < length2; i14++) {
                    fArr[i14] = (float) this.f13971b[i13][i14];
                }
            }
            double[] dArr2 = this.f13970a;
            int i15 = i13 + 1;
            if (d10 < dArr2[i15]) {
                ...
                while (i10 < length2) {
                    ...
                    double[][] dArr4 = this.f13972c;
                    fArr[i10] = (float) j(d11, d12, d13, d14, dArr4[i13][i10], dArr4[i15][i10]);
                    i10++;
                }
                return;
            }
    ...
    public double f(double d10, int i10) {
        ...
        while (i11 < length - 1) {
            ...
            if (d11 <= dArr2[i13]) {
                ...
                double[][] dArr4 = this.f13972c;
                return i(d12, d13, d14, d15, dArr4[i11][i10], dArr4[i13][i10]) / d12;
            }
            i11 = i13;
        }
        return UserProfileInfo.Constant.NA_LAT_LON;
        ...
        while (i11 < length - 1) {
            ...
            if (d11 <= dArr3[i12]) {
                ...
                for (int i13 = 0; i13 < length2; i13++) {
                    ...
                    double[][] dArr5 = this.f13972c;
                    dArr[i13] = i(d12, d13, d14, d15, dArr5[i11][i13], dArr5[i12][i13]) / d12;
                }
                return;
            }
            i11 = i12;

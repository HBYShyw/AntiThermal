...
public final class AwarenessServiceClient$unregisterAwarenessServiceAsync$task$1$1 extends Lambda implements ya.a<Bundle> {
    public static final AwarenessServiceClient$unregisterAwarenessServiceAsync$task$1$1 INSTANCE = new AwarenessServiceClient$unregisterAwarenessServiceAsync$task$1$1();

    AwarenessServiceClient$unregisterAwarenessServiceAsync$task$1$1() {
        super(0);
    }

...
public class RecyclerHeadScaleWithSearchBhv extends ToolBarBehavior {
    private static final int DEVIATION_HEIGHT = 1;
    ...
    public class ReboundListener extends SimpleSpringListener {
        ...
        public void onSpringUpdate(f fVar) {
            if (RecyclerHeadScaleWithSearchBhv.this.mTempLocationY < ((int) fVar.e())) {
                RecyclerHeadScaleWithSearchBhv.this.mScrollView.scrollBy(0, (-((int) (fVar.c() - RecyclerHeadScaleWithSearchBhv.this.mTempLocationY))) - 1);
                Log.d(RecyclerHeadScaleWithSearchBhv.TAG, "onSpringUpdate: scroll=" + ((int) (fVar.c() - RecyclerHeadScaleWithSearchBhv.this.mTempLocationY)));
            }
            RecyclerHeadScaleWithSearchBhv.this.mTempLocationY = (int) fVar.c();
            Log.d(RecyclerHeadScaleWithSearchBhv.TAG, "onSpringUpdate: mTempLocationY=" + RecyclerHeadScaleWithSearchBhv.this.mTempLocationY + " current=" + ((int) fVar.c()) + " endValue=" + ((int) fVar.e()));
        }
    }

    public RecyclerHeadScaleWithSearchBhv() {
    ...
    private void init(Context context) {
        ...
        this.mSpring.p(SpringConfig.b(40.0d, 8.0d));
    ...
    public void onListScroll() {
        ...
        if ((cOUIRecyclerView instanceof ViewGroup) && cOUIRecyclerView.getChildCount() > 0) {
            int i12 = 0;
            while (true) {
                if (i12 >= cOUIRecyclerView.getChildCount()) {
                    break;
                }
                if (cOUIRecyclerView.getChildAt(i12).getVisibility() == 0) {
                    this.mChild = cOUIRecyclerView.getChildAt(i12);
                    break;
                }
                i12++;
            }
    ...
    public void setSpringEndValue(double d10) {
        this.mSpring.o(d10);
    }

    public void setSpringReset() {
        this.mSpring.l();
    }

    public void setSpringValue(double d10) {
        this.mSpring.m(d10);
    }

    @Override // com.oplus.powermanager.fuelgaue.base.ToolBarBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, View view2, int i10, int i11) {
        if (((i10 & 2) != 0 && coordinatorLayout.getHeight() - view.getHeight() <= appBarLayout.getHeight()) && this.mListFirstChildInitY <= 0) {
            ...
            this.mScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.oplus.powermanager.fuelgaue.base.RecyclerHeadScaleWithSearchBhv.1
                @Override // android.view.View.OnScrollChangeListener
                public void onScrollChange(View view3, int i16, int i17, int i18, int i19) {
                    if (RecyclerHeadScaleWithSearchBhv.this.mFlagListScroll) {
                        RecyclerHeadScaleWithSearchBhv.this.onListScroll();
                    }
                }
            });
        }
    ...
    public RecyclerHeadScaleWithSearchBhv(Context context, AttributeSet attributeSet) {

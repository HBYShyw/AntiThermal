...
import m8.PowerSaveFragment;

/* loaded from: classes.dex */
public class PowerSaveActivity extends BaseAppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getSupportFragmentManager().m().r(R.id.fragment_container, new PowerSaveFragment()).i();
    }

...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        setWillNotDraw(true);
        ViewCompat.z0(this, new t() { // from class: com.google.android.material.internal.ScrimInsetsFrameLayout.1
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                ScrimInsetsFrameLayout.this.setWillNotDraw(!windowInsetsCompat.m() || ScrimInsetsFrameLayout.this.insetForeground == null);
                ViewCompat.b0(ScrimInsetsFrameLayout.this);

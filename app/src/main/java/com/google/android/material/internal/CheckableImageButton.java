...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.checkable = true;
        this.pressable = true;
        ViewCompat.l0(this, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.T(CheckableImageButton.this.isCheckable());
                accessibilityNodeInfoCompat.U(CheckableImageButton.this.isChecked());
            }
        });
    }
}

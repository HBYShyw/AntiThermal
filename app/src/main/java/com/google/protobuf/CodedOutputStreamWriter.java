...
public final class CodedOutputStreamWriter implements Writer {
    ...
    private <V> void writeDeterministicBooleanMapEntry(int i10, boolean z10, V v7, MapEntryLite.Metadata<Boolean, V> metadata) {
        this.output.writeTag(i10, 2);
        this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Boolean.valueOf(z10), v7));
        MapEntryLite.writeTo(this.output, metadata, Boolean.valueOf(z10), v7);
    }
    ...
    private <V> void writeDeterministicIntegerMap(int i10, MapEntryLite.Metadata<Integer, V> metadata, Map<Integer, V> map) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            int i13 = iArr[i12];
            V v7 = map.get(Integer.valueOf(i13));
            this.output.writeTag(i10, 2);
            this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Integer.valueOf(i13), v7));
            MapEntryLite.writeTo(this.output, metadata, Integer.valueOf(i13), v7);
        }
    }
    ...
    private <V> void writeDeterministicLongMap(int i10, MapEntryLite.Metadata<Long, V> metadata, Map<Long, V> map) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            long j10 = jArr[i12];
            V v7 = map.get(Long.valueOf(j10));
            this.output.writeTag(i10, 2);
            this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Long.valueOf(j10), v7));
            MapEntryLite.writeTo(this.output, metadata, Long.valueOf(j10), v7);
        }
    }
    ...
    private <K, V> void writeDeterministicMap(int i10, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[metadata.keyType.ordinal()]) {
            case 1:
                ...
                if (v7 != null) {
                    writeDeterministicBooleanMapEntry(i10, false, v7, metadata);
                }

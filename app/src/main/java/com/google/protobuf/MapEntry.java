...
public final class MapEntry<K, V> extends AbstractMessage {
    ...
    public static class Builder<K, V> extends AbstractMessage.Builder<Builder<K, V>> {
        ...
        public Builder<K, V> setValue(V v7) {
            this.value = v7;
            this.hasValue = true;
            return this;
        }
        ...
        private Builder(Metadata<K, V> metadata, K k10, V v7, boolean z10, boolean z11) {
    ...
    public static <K, V> MapEntry<K, V> newDefaultInstance(Descriptors.Descriptor descriptor, WireFormat.FieldType fieldType, K k10, WireFormat.FieldType fieldType2, V v7) {
        return new MapEntry<>(descriptor, fieldType, k10, fieldType2, v7);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <V> boolean isInitialized(Metadata metadata, V v7) {
    ...
    private MapEntry(Descriptors.Descriptor descriptor, WireFormat.FieldType fieldType, K k10, WireFormat.FieldType fieldType2, V v7) {
    ...
    private MapEntry(Metadata metadata, K k10, V v7) {
        this.cachedSerializedSize = -1;
        this.key = k10;
        this.value = v7;
        this.metadata = metadata;

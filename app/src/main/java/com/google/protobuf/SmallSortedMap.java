...
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class Entry implements Map.Entry<K, V>, Comparable<SmallSortedMap<K, V>.Entry> {
        ...
        public String toString() {
            return this.key + InnerUtils.EQUAL + this.value;
        }
    ...
    public int hashCode() {
        ...
        return getNumOverflowEntries() > 0 ? i10 + this.overflowEntries.hashCode() : i10;
    }
    ...
    public V put(K k10, V v7) {
        ...
        if (binarySearchInArray >= 0) {
            return this.entryList.get(binarySearchInArray).setValue(v7);
        }
        ensureEntryArrayMutable();
        int i10 = -(binarySearchInArray + 1);
        if (i10 >= this.maxArraySize) {
            return getOverflowEntriesMutable().put(k10, v7);
        }
        ...
        this.entryList.add(i10, new Entry(k10, v7));
        return null;
    }
}

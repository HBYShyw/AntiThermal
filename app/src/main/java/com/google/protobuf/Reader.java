...
interface Reader {
    ...
    <T> void mergeGroupField(T t7, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

    <T> void mergeMessageField(T t7, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

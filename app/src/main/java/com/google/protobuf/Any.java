...
public final class Any extends GeneratedMessageV3 implements AnyOrBuilder {
    ...
    public static <T extends Message> Any pack(T t7) {
        return newBuilder().setTypeUrl(getTypeUrl("type.googleapis.com", t7.getDescriptorForType())).setValue(t7.toByteString()).build();
    }
    ...
    public <T extends Message> T unpack(Class<T> cls) {
        ...
        if (!z10 && is(cls)) {
            T t7 = (T) ((Message) Internal.getDefaultInstance(cls)).getParserForType().parseFrom(getValue());
            this.cachedUnpackValue = t7;
            return t7;
        }
    ...
    public static <T extends Message> Any pack(T t7, String str) {
        return newBuilder().setTypeUrl(getTypeUrl(str, t7.getDescriptorForType())).setValue(t7.toByteString()).build();
    }

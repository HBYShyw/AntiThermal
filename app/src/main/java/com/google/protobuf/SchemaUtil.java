...
public final class SchemaUtil {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T, FT extends FieldSet.FieldDescriptorLite<FT>> void mergeExtensions(ExtensionSchema<FT> extensionSchema, T t7, T t10) {
        FieldSet<FT> extensions = extensionSchema.getExtensions(t10);
        if (extensions.isEmpty()) {
            return;
        }
        extensionSchema.getMutableExtensions(t7).mergeFrom(extensions);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> void mergeMap(MapFieldSchema mapFieldSchema, T t7, T t10, long j10) {
        UnsafeUtil.putObject(t7, j10, mapFieldSchema.mergeFrom(UnsafeUtil.getObject(t7, j10), UnsafeUtil.getObject(t10, j10)));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T, UT, UB> void mergeUnknownFields(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t7, T t10) {
        unknownFieldSchema.setToMessage(t7, unknownFieldSchema.merge(unknownFieldSchema.getFromMessage(t7), unknownFieldSchema.getFromMessage(t10)));
    }

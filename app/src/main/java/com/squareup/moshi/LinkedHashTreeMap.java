...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> node2) {
        ...
        int i10 = node.hash;
        this.table[i10 & (r2.length - 1)] = node2;
    }
    ...
    Node<K, V> find(K k10, boolean z10) {
        ...
        if (node2 != null) {
            ...
            while (true) {
                if (comparable != null) {
                    i10 = comparable.compareTo(node2.key);
                } else {
                    i10 = comparator.compare(k10, node2.key);
                }
                if (i10 == 0) {
                    return node2;
                }
        ...
        if (node4 == null) {
            ...
            node = new Node<>(node4, k10, secondaryHash, node5, node5.prev);
            nodeArr[length] = node;
        } else {
            node = new Node<>(node4, k10, secondaryHash, node5, node5.prev);
            if (i11 < 0) {

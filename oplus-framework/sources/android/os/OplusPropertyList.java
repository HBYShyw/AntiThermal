...
public class OplusPropertyList {
    ...
    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPERTY_CUSTOMMEDIA_RINGTONE_VERSION = "ro.sys.custommedia.ringtone.version";

    @OplusProperty(OplusProperty.OplusPropertyType.PERSIST_PROPERTY)
    public static final String PROPERTY_CUSTOMMEDIA_RINGTONE_VERSION_BACKUP = "persist.sys.custommedia.ringtone.version";

    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPERTY_CUSTOM_ROLLBACK = "persist.sys.custom.rollback";
    ...
    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPERTY_INPUTMETHOD_CUSTOMIZE = "ro.sys.oplus.inputmethod.customize.package";
    ...
    public static final String PROPERTY_ROUNDCORNERS = "sys.oplus.roundcorners";
    ...
    @OplusProperty(OplusProperty.OplusPropertyType.PERSIST_PROPERTY)
    public static final String PROPETY_CUSTOM_INIT_LAST_RINGTONE_TITLE = "persist.sys.custommedia.init_last_default_ringtone_title";

    @OplusProperty(OplusProperty.OplusPropertyType.PERSIST_PROPERTY)
    public static final String PROPETY_CUSTOM_LAST_RINGTONE_TITLE = "persist.sys.custommedia.last_default_ringtone_title";

    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPETY_CUSTOM_RINGTONE_TITLE = "ro.sys.custommedia.default_ringtone_title";
    ...
    @OplusProperty(OplusProperty.OplusPropertyType.SYS_PROPERTY)
    public static final String PROPETY_SIM_SWITCH_SSV = "sys.oplus.switch.operator";
    ...
    public static final String BUILD_VERSION_OPLUSROM_CONFIDENTIAL = SystemProperties.get(PROPERTY_BUILD_VERSION_OPLUSROM_CONFIDENTIAL, "");

    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPERTY_VERSION_UPGRADE_DECRYPT_CONFIG = "ro.version.upgrade.decrypt.config";
    public static final String VERSION_UPGRADE_DECRYPT_CONFIG = SystemProperties.get(PROPERTY_VERSION_UPGRADE_DECRYPT_CONFIG, "");
    ...
    public static final String AUDIO_LOWPOWER_AUDIOPARAMETER_STATUS = SystemProperties.get(PROPERTY_AUDIO_LOWPOWER_AUDIOPARAMETER, "0");
    ...
    public static final String BRIGHTNESS_PANEL_NUM = SystemProperties.get(PROPERTY_BRIGHTNESS_PANEL_NUM, "1");
    ...
    public static final String COLORMODE_SOFT = SystemProperties.get(PROPERTY_COLORMODE_SOFT, "1");

    @OplusProperty(OplusProperty.OplusPropertyType.RO_PROPERTY)
    public static final String PROPERTY_COLORMODE_CINEMA = "ro.oplus.display.colormode.cinema";
    public static final String COLORMODE_CINEMA = SystemProperties.get(PROPERTY_COLORMODE_CINEMA, "1");

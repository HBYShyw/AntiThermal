...
public class OplusBasePowerManager {
    ...
    public static final int GO_TO_SLEEP_REASON_PROXIMITY = 14;
    public static final int GO_TO_SLEEP_REASON_SYSTEM_UI_CLEAN_UP = 16;
    ...
    void printStackTraceInfo(String methodName) {

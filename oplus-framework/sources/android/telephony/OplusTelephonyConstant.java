...
public interface OplusTelephonyConstant {
    ...
    public static final int IMS_REREG_GET_TIMER = 1;
    public static final int IMS_REREG_RESET = 2;
    ...
    public static final int VIRTUALCOMM_DEFAULT_CAPABILITY = 0;
    public static final int VIRTUALCOMM_DEVICE_CONSUMER = 2;
    public static final int VIRTUALCOMM_DEVICE_PROVIDER = 1;
    public static final int VIRTUALCOMM_DEVICE_UNKNOWN = 0;
    public static final int VIRTUALCOMM_LOCAL_CAPABILITY = 1;
    public static final int VIRTUALCOMM_PEER_CAPABILITY = 2;
    ...
    public enum ApCmd2ModemType {
        ...
        AP_2_MODEM_MAX_CMD(OplusMaxLinearLayout.INVALID_MAX_VALUE);
    ...
    public enum ApCmd2QcrilType {
        ...
        QCRILHOOK_MAX_CMD(OplusMaxLinearLayout.INVALID_MAX_VALUE);

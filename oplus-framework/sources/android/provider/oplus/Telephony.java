...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static boolean moveMessageToFolder(Context context, Uri uri, int folder, int error) {
            ...
            return 1 == SqliteWrapper.update(context, context.getContentResolver(), uri, values, (String) null, (String[]) null);
        }
        ...
        public static final class Intents {
            ...
            public static SmsMessage[] getMessagesFromIntent(Intent intent) {
                try {
                    ...
                    int subId = intent.getIntExtra(OplusTelephonyConstant.SUBSCRIPTION_KEY, SubscriptionManager.getDefaultSmsSubscriptionId());
    ...
    public static final class CellBroadcasts implements BaseColumns {
        ...
        public static final String[] QUERY_COLUMNS = {"_id", GEOGRAPHICAL_SCOPE, PLMN, LAC, "cid", SERIAL_NUMBER, SERVICE_CATEGORY, LANGUAGE_CODE, "body", "date", "read", MESSAGE_FORMAT, "priority", ETWS_WARNING_TYPE, CMAS_MESSAGE_CLASS, CMAS_CATEGORY, CMAS_RESPONSE_TYPE, CMAS_SEVERITY, CMAS_URGENCY, CMAS_CERTAINTY};
    ...
    public static final class ServiceStateTable {
        ...
        public static ContentValues getContentValuesForServiceState(ServiceState state) {
            ...
            values.put(DATA_OPERATOR_ALPHA_LONG, state.getOperatorAlphaLong());

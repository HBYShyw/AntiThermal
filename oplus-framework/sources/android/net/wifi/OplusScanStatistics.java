...
public class OplusScanStatistics implements Parcelable {
    ...
    public String toString() {
        ...
        sbuf.append(" uid:").append(this.packageUid);
        sbuf.append("  request time:").append(this.requestTimestamp);
        sbuf.append("  request status:").append(this.requestStatus);
        sbuf.append("  result time:").append(this.resultTimestamp);
        sbuf.append("  result status:").append(this.resultStatus);
        sbuf.append("  result size:").append(this.resultSize);

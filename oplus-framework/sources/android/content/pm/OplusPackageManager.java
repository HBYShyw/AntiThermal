...
public class OplusPackageManager {
    ...
    public OplusRemovableAppInfo getRemovableAppInfo(String packageName) throws RemoteException {
        if (getService() != null) {
            return getService().getRemovableAppInfo(packageName);
        }
    ...
    public void dynamicDetectApp(OplusAppDynamicFeatureData featureData) throws RemoteException {
        if (getService() != null) {
            getService().dynamicDetectApp(featureData);
        } else {
    ...
    public boolean registerFeatureObserverInner(List<String> features, IOplusFeatureObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().registerFeatureObserverInner(features, observer);
        }
    ...
    public boolean unregisterFeatureObserverInner(IOplusFeatureObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().unregisterFeatureObserverInner(observer);
        }
    ...
    public boolean registerFeatureMapObserverInner(List<String> featureList, int featureID, IOplusFeatureMapObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().registerFeatureMapObserverInner(featureList, featureID, observer);
        }
        Log.e(TAG, "registerFeatureObserverInner failed because service has not been created");
        return false;
    }
    ...
    public boolean unregisterFeatureMapObserverInner(int featureID, IOplusFeatureMapObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().unregisterFeatureMapObserverInner(featureID, observer);
        }
        Log.e(TAG, "unregisterFeatureObserverInner failed because service has not been created");
        return false;
    }
    ...
    public boolean registerFeatureActionObserverInner(IOplusFeatureActionObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().registerFeatureActionObserverInner(observer);
        }
    ...
    public boolean unregisterFeatureActionObserverInner(IOplusFeatureActionObserver observer) throws RemoteException {
        if (getService() != null) {
            return getService().unregisterFeatureActionObserverInner(observer);
        }
    ...
    public boolean setMarketRecommendPause(long millseconds) {
        try {
            if (getService() != null) {
                return getService().setMarketRecommendPause(millseconds);
            }
    ...
    public boolean isTranslatorWhitelistApp(String packageName) {
        try {
            if (getService() != null) {
                return getService().isTranslatorWhitelistApp(packageName);
            }

...
public final class OplusAppSwitchConfig implements Parcelable {
    ...
    public String toString() {
        ...
        sb.append(" mConfigs = " + pkg.replace(".", "@@").replace("com", "TOM").replace("oplusos", "CO").replace(OplusThemeResources.OPLUS_PACKAGE, "NM").replace(OplusThemeResources.OPLUS_PACKAGE, "OP"));

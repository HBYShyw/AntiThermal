...
public class OplusAppInfo implements Parcelable {
    ...
    public void readFromParcel(Parcel source) {
        ...
        if (source.readInt() != 0) {
            this.appInfo = (ApplicationInfo) ApplicationInfo.CREATOR.createFromParcel(source);
        }
        if (source.readInt() != 0) {
            this.topActivity = (ComponentName) ComponentName.CREATOR.createFromParcel(source);
        }

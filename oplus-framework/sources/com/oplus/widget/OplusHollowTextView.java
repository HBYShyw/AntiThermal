...
public class OplusHollowTextView extends TextView {
    ...
    public OplusHollowTextView(Context context) {
        this(context, null);
    }

    public OplusHollowTextView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public OplusHollowTextView(Context context, AttributeSet attrs, int defStyleAttr) {

...
public class OplusViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: com.oplus.widget.OplusViewPager.1
        @Override // java.util.Comparator
        public int compare(ItemInfo lhs, ItemInfo rhs) {
            return lhs.position - rhs.position;
        }
    };
    private static final Interpolator sInterpolator = OplusBottomMenuCallback.ANIMATOR_INTERPOLATOR;
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged(OplusPagerAdapter oplusPagerAdapter, OplusPagerAdapter oplusPagerAdapter2);
    }
    ...
    public OplusViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: com.oplus.widget.OplusViewPager.2
            @Override // java.lang.Runnable
            public void run() {
                OplusViewPager.this.setScrollState(0);
                OplusViewPager.this.populate();
            }
        };
        this.mScrollState = 0;
    ...
    public void setAdapter(OplusPagerAdapter adapter) {
        ...
        OplusPagerAdapter oldAdapter = this.mAdapter;
    ...
    boolean setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        if (this.mFirstLayout) {
            this.mCurItem = item2;
            this.mMenuDelegate.onPageMenuSelected(item2);
            ...
            if (dispatchSelected && (list = this.mOnPageChangeListeners) != null) {
                ...
                for (int i4 = 0; i4 < z; i4++) {
                    OnPageChangeListener listener = this.mOnPageChangeListeners.get(i4);
                    if (listener != null) {
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        if (dx != 0 || dy != 0) {
            ...
            this.mScroller.startScroll(sx, sy, dx, dy, (int) (Math.min(duration, 600) * DURATION_SCALE));
    ...
    void populate(int newCurrentItem) {
        ...
        if (getWindowToken() != null) {
            ...
            if (N != this.mExpectedAdapterCount) {
                ...
                throw new IllegalStateException("The application's OplusPagerAdapter changed the adapter's contents without calling OplusPagerAdapter#notifyDataSetChanged! Expected adapter item count: " + this.mExpectedAdapterCount + ", found: " + N + " Pager id: " + resName + " Pager class: " + getClass() + " Problematic adapter: " + this.mAdapter.getClass());
            }
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.ClassLoaderCreator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.oplus.widget.OplusViewPager.SavedState.1
    ...
    public Parcelable onSaveInstanceState() {
        ...
        OplusPagerAdapter oplusPagerAdapter = this.mAdapter;
        if (oplusPagerAdapter != null) {
            ss.adapterState = oplusPagerAdapter.saveState();
        }
        return ss;
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        OplusPagerAdapter oplusPagerAdapter = this.mAdapter;
        if (oplusPagerAdapter != null) {
            oplusPagerAdapter.restoreState(ss.adapterState, ss.loader);
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        if (oldWidth > 0 && !this.mItems.isEmpty()) {
            ...
            if (!this.mScroller.isFinished()) {
                int newDuration = (int) ((this.mScroller.getDuration() - this.mScroller.timePassed()) * DURATION_SCALE);
            ...
            if (i < count2) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (lp.isDecor) {
                        ...
                        int childLeft2 = lp.gravity;
                        int vgrav = childLeft2 & 112;
                        switch (hgrav) {
                            case 1:
                                int childLeft3 = child.getMeasuredWidth();
                                childLeft = Math.max((width2 - childLeft3) / 2, paddingLeft2);
                                break;
                            case 2:
                            case 4:
                            default:
                            ...
                            case 3:
                                ...
                                paddingLeft2 += childLeft4;
                                break;
                            case 5:
                                int childLeft5 = width2 - paddingRight;
                                childLeft = childLeft5 - child.getMeasuredWidth();
                                int childLeft6 = child.getMeasuredWidth();
                                paddingRight += childLeft6;
                                break;
                        }
                        switch (vgrav) {
                            case 16:
                        ...
                        int childLeft7 = childLeft + scrollX2;
                        int paddingLeft3 = paddingLeft2;
                        int paddingLeft4 = childLeft7 + child.getMeasuredWidth();
                        int paddingTop2 = paddingTop;
                        int paddingTop3 = childTop + child.getMeasuredHeight();
                        child.layout(childLeft7, childTop, paddingLeft4, paddingTop3);
                        decorCount++;
                    ...
                    if (child2.getVisibility() == i2) {
                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                int childLeft8 = paddingLeft2 + loff;
                                ...
                                if (isLayoutRtl()) {
                                    childLeft8 = ((16777216 - paddingRight) - loff) - childMeasuredWidth;
                                }
                                child2.layout(childLeft8, childTop2, child2.getMeasuredWidth() + childLeft8, child2.getMeasuredHeight() + childTop2);
                            }
                        }
                    }
                    i4++;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        OplusPagerAdapter oplusPagerAdapter;
        float f;
        if (this.mDisableTouch) {
            return false;
        }
        ...
        if ((ev.getAction() == 0 && ev.getEdgeFlags() != 0) || (oplusPagerAdapter = this.mAdapter) == null || oplusPagerAdapter.getCount() == 0) {
            return false;
        }
        if (this.mVelocityTracker == null) {
            this.mVelocityTracker = VelocityTracker.obtain();
        ...
        switch (action & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    needsInvalidate = (this.mLeftEdge.isFinished() && this.mRightEdge.isFinished()) ? false : true;
                    break;
                }
                break;
            case 2:
    ...
    private boolean performDrag(float x) {
        ...
        float scrollOffset = getScrollStart() + (isLayoutRtl() ? -deltaX : deltaX);
        ...
        if (this.mItems.size() > 0) {
            ...
            if (!startAbsolute) {
                startBound = width * this.mFirstOffset;
            } else {
            ...
            if (!endAbsolute) {
                endBound = width * this.mLastOffset;
            } else {
        ...
        if (scrollOffset < startBound) {
            if (startAbsolute) {
                startEdge.onPull(Math.abs(deltaX) / width);
                needsInvalidate = true;
            }
            clampedScrollStart = startBound;
        } else if (scrollOffset > endBound) {
            if (endAbsolute) {
                endEdge.onPull(Math.abs(deltaX) / width);
                needsInvalidate = true;
            }
        ...
        if (isLayoutRtl()) {
            targetScrollX = (1.6777216E7f - clampedScrollStart) - width;
        } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == 1 && (oplusPagerAdapter = this.mAdapter) != null && oplusPagerAdapter.getCount() > 1)) {
            if (!this.mLeftEdge.isFinished()) {
                ...
                canvas.translate((-height) + getPaddingTop(), isLayoutRtl() ? getScrollStart() - (this.mLastOffset * width) : this.mFirstOffset * width);
            ...
            if (!this.mRightEdge.isFinished()) {
                ...
                canvas.rotate(90.0f);
                canvas.translate(-getPaddingTop(), isLayoutRtl() ? getScrollStart() - ((this.mFirstOffset + 1.0f) * width2) : (-(this.mLastOffset + 1.0f)) * width2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (isLayoutRtl()) {
                    left = (1.6777216E7f - scaledOffset) - width;
                } else {
                    float left2 = width;
    ...
    public void fakeDragBy(float xOffset) {
        if (this.mFakeDragging) {
            ...
            float oldScrollX = getScrollStart();
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p != null && (p instanceof LayoutParams) && super.checkLayoutParams(p);
    }
    ...
    public class MyAccessibilityDelegate extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(OplusViewPager.class.getName());
        }

        @Override // android.view.View.AccessibilityDelegate
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
            super.onInitializeAccessibilityNodeInfo(host, info);
            info.setClassName(OplusViewPager.class.getName());
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            switch (action) {
                ...
                case 8192:
                    ...
                    OplusViewPager oplusViewPager2 = OplusViewPager.this;
                    oplusViewPager2.setCurrentItem(oplusViewPager2.mCurItem - 1);
                    return true;
                default:
                    return false;
            }
        ...
        private boolean canScroll() {
            return OplusViewPager.this.mAdapter != null && OplusViewPager.this.mAdapter.getCount() > 1;
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.widthFactor = 0.0f;
            TypedArray a = context.obtainStyledAttributes(attrs, OplusViewPager.LAYOUT_ATTRS);

...
public interface IOplusWindowManagerConstans {
    ...
    public static final int PRIVATE_FLAG_SUGGEST_REMOVE_STARTING_WINDOW_IMMEDIATELY = Integer.MIN_VALUE;
    ...
    public static class BaseLayoutParams extends WindowManager.LayoutParams {
        public static final int OPLUSOS_FIRST_SYSTEM_WINDOW = 300;
        public static final int TYPE_CAR_DOCK_BAR = 2322;
        public static final int TYPE_CASE_PANEL = 2323;
        ...
        public static final int TYPE_MIRAGE_DIM_WINDOW = 2320;
        public static final int TYPE_MIRAGE_WINDOW = 2319;
        public static final int TYPE_OPLUS_APP_BACK_ANIMATION_WINDOW = 2316;
        public static final int TYPE_POWERVIEW = 2300;
        public static final int TYPE_SUB_CASE_PANEL = 2324;
        ...
        public static boolean isForceFullScreen(int type) {
            switch (type) {
                ...
                case TYPE_ZOOM_CONTROLLER /* 2318 */:
                    return true;
                default:

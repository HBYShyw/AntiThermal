...
public class OplusRecorder {
    ...
    public interface OnErrorListener {
        void onError(OplusRecorder oplusRecorder, int i, int i2);
    }

    /* loaded from: classes.dex */
    public interface OnInfoListener {
        void onInfo(OplusRecorder oplusRecorder, int i, int i2);
    }
    ...
    public native void expandFile(FileDescriptor fileDescriptor, long j, long j2, int i) throws IllegalStateException;
    ...
    public void setCaptureRate(double fps) {
        ...
        setParameter(String.format("time-between-time-lapse-frame-capture=%d", Integer.valueOf(timeBetweenFrameCaptureMs)));
    }
    ...
    private class EventHandler extends Handler {
        ...
        public EventHandler(OplusRecorder mr, Looper looper) {
            super(looper);
            this.mOplusRecorder = mr;
        }

        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            if (this.mOplusRecorder.mNativeContext == 0) {
            ...
            switch (msg.what) {
                ...
                case 100:
                    if (OplusRecorder.this.mOnErrorListener != null) {
                        OplusRecorder.this.mOnErrorListener.onError(this.mOplusRecorder, msg.arg1, msg.arg2);
                        return;
                    }
                    return;
                case 2:
                case 101:
                    if (OplusRecorder.this.mOnInfoListener != null) {
                        OplusRecorder.this.mOnInfoListener.onInfo(this.mOplusRecorder, msg.arg1, msg.arg2);
                        return;
                    }
                    return;
                default:
                    Log.e(OplusRecorder.TAG, "Unknown message type " + msg.what);
                    return;
            }
        }
    }
    ...
    private static void postEventFromNative(Object mediarecorder_ref, int what, int arg1, int arg2, Object obj) {
        ...
        OplusRecorder mr = (OplusRecorder) ((WeakReference) mediarecorder_ref).get();

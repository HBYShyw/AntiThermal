...
public interface IOplusUIFirstManager extends IOplusCommonFeature {
    ...
    public static final int APP_STATUS_PAUSE_ACTIVITY = 6;
    ...
    public static final int BOOST_ADD_FRAME_TASK_IMS = 401;
    ...
    public static final int CURRENT_COMM_PID_FOR_BINDER_THREAD_UX = -1;
    ...
    public static final int DISABLE_ASYNC_BINDER_THREAD_UX = 0;
    public static final int ENABLE_ASYNC_BINDER_THREAD_UX_ENQUEUE = 1;
    public static final int ENABLE_ASYNC_BINDER_THREAD_UX_INSERT_QUEUE = 2;
    ...
    public static final int UIFIRST_OPT_SET_PRIORITY = 512;
    ...
    default void setUxImFlag(int pid, int flag) {
    }

    default void setSchedAssistScene(String scene) {
    }

    default void enableUXTrace(boolean enable) {
    }
    ...
    default void addApplicationHwuiTaskThread(String packageName, int pid, int tid) {
    }
    ...
    default void setImFlag(int tid, int im) {
    }

    default void notifyRomUpdate() {
    }

...
public class TotalPredictResult implements Parcelable {
    ...
    public String toString() {
        ...
        String sleepString = deepSleepCluster != null ? deepSleepCluster.toString() : NULL;
        DeepSleepCluster deepSleepCluster2 = this.mWakeCluster;
        String wakeString = deepSleepCluster2 != null ? deepSleepCluster2.toString() : NULL;
        TrainConfig trainConfig = this.mOptimalSleepConfig;
        String sleepConfig = trainConfig != null ? trainConfig.toString() : NULL;

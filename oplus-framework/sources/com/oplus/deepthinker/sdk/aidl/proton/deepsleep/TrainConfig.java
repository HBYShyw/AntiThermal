...
public class TrainConfig implements Parcelable {
    ...
    public static final Parcelable.Creator<TrainConfig> CREATOR = new Parcelable.Creator<TrainConfig>() { // from class: com.oplus.deepthinker.sdk.aidl.proton.deepsleep.TrainConfig.1
    ...
    public TrainConfig(String config) {
        this.mType = -1;
        String[] configDatas = config.split(SPLIT);
    ...
    public String spliceParameter() {
        return this.mClusterMinPoints + SPLIT + this.mClusterEps + SPLIT + this.mDayForPredict + SPLIT + this.mType;
    }
    ...
    public int hashCode() {
        int result = this.mClusterMinPoints;
        return (((((result * 31) + ((int) (this.mClusterEps * 1000.0d))) * 31) + this.mDayForPredict) * 31) + this.mType;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.mClusterMinPoints == config.getClusterMinPoints() && Math.abs(this.mClusterEps - config.getClusterEps()) >= SIGMA && this.mDayForPredict == config.getdayForPredict() && this.mType == config.getType();
    }

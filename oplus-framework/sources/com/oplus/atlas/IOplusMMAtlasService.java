...
public interface IOplusMMAtlasService extends IInterface {
    public static final String DESCRIPTOR = "com.oplus.atlas.IOplusMMAtlasService";
    ...
    /* loaded from: classes.dex */
    public static class Default implements IOplusMMAtlasService {
    ...
    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements IOplusMMAtlasService {
        ...
        public Stub() {
            attachInterface(this, IOplusMMAtlasService.DESCRIPTOR);
        }

        public static IOplusMMAtlasService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(IOplusMMAtlasService.DESCRIPTOR);
            if (iin != null && (iin instanceof IOplusMMAtlasService)) {
                return (IOplusMMAtlasService) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code >= 1 && code <= 16777215) {
                data.enforceInterface(IOplusMMAtlasService.DESCRIPTOR);
            }
            switch (code) {
                case 1598968902:
                    reply.writeString(IOplusMMAtlasService.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
        ...
        /* loaded from: classes.dex */
        private static class Proxy implements IOplusMMAtlasService {
            ...
            public String getInterfaceDescriptor() {
                return IOplusMMAtlasService.DESCRIPTOR;
            }
            ...
            public void setEvent(String event, String value) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IOplusMMAtlasService.DESCRIPTOR);

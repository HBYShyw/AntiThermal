...
public final class OplusProcDependData implements Parcelable {
    ...
    public String toString() {
        ...
        builder.append("pid=").append(this.mPid).append(",").append("uid=").append(this.mUid).append(",").append("pkg=").append(this.mPackageName).append(",").append("proc=").append(this.mProcessName).append(",").append("depend ON=").append(this.mServices).append(",").append("depend BY=").append(this.mClients).append(",");
    ...
    public static final class ProcItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder();
            builder.append(this.pid).append("+").append(this.uid).append("+").append(this.packageName).append("+").append(this.processName);
            return builder.toString();
        }

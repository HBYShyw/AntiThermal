...
public class OplusWebViewCaptureHelper extends OplusScrollCaptureViewHelper<WebView> {
    private static final boolean DEBUG = false;
    private static final String TAG = "OplusWebViewScrollCapture";
    ...
    public void onScrollRequested(WebView view, Rect scrollBounds, Rect requestRect, CancellationSignal cancellationSignal, Consumer<ScrollCaptureViewHelper.ScrollResult> resultConsumer) {
        ...
        view.scrollBy(0, scrollMovement);

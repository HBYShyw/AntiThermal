...
public interface IOplusScreenshotCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOplusScreenshotCallback {
        ...
        public static IOplusScreenshotCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(IOplusScreenshotCallback.DESCRIPTOR);
            if (iin != null && (iin instanceof IOplusScreenshotCallback)) {
                return (IOplusScreenshotCallback) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code >= 1 && code <= 16777215) {
                data.enforceInterface(IOplusScreenshotCallback.DESCRIPTOR);
            }
            switch (code) {
                case 1598968902:
                    reply.writeString(IOplusScreenshotCallback.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
        ...
        private static class Proxy implements IOplusScreenshotCallback {
            ...
            public void stop() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IOplusScreenshotCallback.DESCRIPTOR);

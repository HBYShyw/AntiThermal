...
public class RemoteTransition {
    ...
    public RemoteTransition(final IRemoteTransition wrapperRemoteTransition, IApplicationThread wrapperAppThread, String debugName) {
        android.window.IRemoteTransition iRemoteTransition = wrapperRemoteTransition != null ? new IRemoteTransition.Stub() { // from class: com.oplus.wrapper.window.RemoteTransition.1
            public void startAnimation(IBinder iBinder, android.window.TransitionInfo transitionInfo, SurfaceControl.Transaction transaction, final android.window.IRemoteTransitionFinishedCallback iRemoteTransitionFinishedCallback) throws RemoteException {
                ...
                if (iRemoteTransitionFinishedCallback != null) {
                    wrapperRemoteTransitionFinishedCallback = new IRemoteTransitionFinishedCallback.Stub() { // from class: com.oplus.wrapper.window.RemoteTransition.1.1
                        ...
                        public void onTransitionFinished(WindowContainerTransaction wct, SurfaceControl.Transaction sct) throws RemoteException {
                            iRemoteTransitionFinishedCallback.onTransitionFinished(wct.getWindowContainerTransaction(), sct);
                        }
                    };
                }
                wrapperRemoteTransition.startAnimation(iBinder, new TransitionInfo(transitionInfo), transaction, wrapperRemoteTransitionFinishedCallback);
            }

            public void mergeAnimation(IBinder iBinder, android.window.TransitionInfo transitionInfo, SurfaceControl.Transaction transaction, IBinder iBinder1, final android.window.IRemoteTransitionFinishedCallback iRemoteTransitionFinishedCallback) throws RemoteException {
                IRemoteTransitionFinishedCallback wrapperRemoteTransitionFinishedCallback = null;
                if (iRemoteTransitionFinishedCallback != null) {
                    wrapperRemoteTransitionFinishedCallback = new IRemoteTransitionFinishedCallback.Stub() { // from class: com.oplus.wrapper.window.RemoteTransition.1.2
                        @Override // com.oplus.wrapper.window.IRemoteTransitionFinishedCallback
                        public void onTransitionFinished(WindowContainerTransaction wct, SurfaceControl.Transaction sct) throws RemoteException {
                            iRemoteTransitionFinishedCallback.onTransitionFinished(wct.getWindowContainerTransaction(), sct);
                        }
                ...
                wrapperRemoteTransition.mergeAnimation(iBinder, new TransitionInfo(transitionInfo), transaction, iBinder1, wrapperRemoteTransitionFinishedCallback);
            }
        } : null;
        android.app.IApplicationThread iApplicationThread = wrapperAppThread != null ? new IApplicationThread.Stub() { // from class: com.oplus.wrapper.window.RemoteTransition.2
        ...
        this.mRemoteTransition = new android.window.RemoteTransition(iRemoteTransition, iApplicationThread, debugName);
    }

    ...
    public static abstract class Stub implements IInterface, IWindowManager {
        private final android.view.IWindowManager mIWindowManager = new IWindowManager.Stub() { // from class: com.oplus.wrapper.view.IWindowManager.Stub.1
            ...
            public void getBaseDisplaySize(int displayId, Point size) throws RemoteException {
                Stub.this.getBaseDisplaySize(displayId, size);
            }
            ...
            public int watchRotation(final android.view.IRotationWatcher watcher, int displayId) throws RemoteException {
                ...
                IRotationWatcher rotationWatcher = new IRotationWatcher() { // from class: com.oplus.wrapper.view.IWindowManager$Stub$1$$ExternalSyntheticLambda0
                    @Override // com.oplus.wrapper.view.IRotationWatcher
                    public final void onRotationChanged(int i) {
                        watcher.onRotationChanged(i);
                    }
                };
                return Stub.this.watchRotation(rotationWatcher, displayId);
            }
            ...
            public boolean hasNavigationBar(int displayId) throws RemoteException {
                return Stub.this.hasNavigationBar(displayId);
            }
        ...
        public static IWindowManager asInterface(IBinder obj) {
            return new Proxy(IWindowManager.Stub.asInterface(obj));
        }

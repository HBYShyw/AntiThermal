...
public class RemoteAnimationAdapter {
    ...
    public RemoteAnimationAdapter(final IRemoteAnimationRunner runner, long duration, long statusBarTransitionDelay) {
        this.mRemoteAnimationAdapter = new android.view.RemoteAnimationAdapter(runner != null ? new IRemoteAnimationRunner.Stub() { // from class: com.oplus.wrapper.view.RemoteAnimationAdapter.1
            public void onAnimationStart(int i, android.view.RemoteAnimationTarget[] remoteAnimationTargets, android.view.RemoteAnimationTarget[] remoteAnimationTargets1, android.view.RemoteAnimationTarget[] remoteAnimationTargets2, final android.view.IRemoteAnimationFinishedCallback iRemoteAnimationFinishedCallback) throws RemoteException {
                ...
                if (iRemoteAnimationFinishedCallback != null) {
                    wrapperRemoteAnimationFinishedCallback = new IRemoteAnimationFinishedCallback.Stub() { // from class: com.oplus.wrapper.view.RemoteAnimationAdapter.1.1
                ...
                runner.onAnimationStart(i, RemoteAnimationTarget.getWrapperRemoteAnimationTarget(remoteAnimationTargets), RemoteAnimationTarget.getWrapperRemoteAnimationTarget(remoteAnimationTargets1), RemoteAnimationTarget.getWrapperRemoteAnimationTarget(remoteAnimationTargets2), wrapperRemoteAnimationFinishedCallback);
            }

            public void onAnimationCancelled() throws RemoteException {
                runner.onAnimationCancelled();
            }
        } : null, duration, statusBarTransitionDelay);
    }

    public RemoteAnimationAdapter(final IRemoteAnimationRunner runner, long duration, long statusBarTransitionDelay, IApplicationThread callingApplication) {
        IApplicationThread.Stub stub;
        IRemoteAnimationRunner.Stub stub2 = runner != null ? new IRemoteAnimationRunner.Stub() { // from class: com.oplus.wrapper.view.RemoteAnimationAdapter.2
            public void onAnimationStart(int i, android.view.RemoteAnimationTarget[] remoteAnimationTargets, android.view.RemoteAnimationTarget[] remoteAnimationTargets1, android.view.RemoteAnimationTarget[] remoteAnimationTargets2, final android.view.IRemoteAnimationFinishedCallback iRemoteAnimationFinishedCallback) throws RemoteException {
                IRemoteAnimationFinishedCallback wrapperRemoteAnimationFinishedCallback = null;
                if (iRemoteAnimationFinishedCallback != null) {
                    wrapperRemoteAnimationFinishedCallback = new IRemoteAnimationFinishedCallback.Stub() { // from class: com.oplus.wrapper.view.RemoteAnimationAdapter.2.1
                        @Override // com.oplus.wrapper.view.IRemoteAnimationFinishedCallback
                        public void onAnimationFinished() throws RemoteException {
                            iRemoteAnimationFinishedCallback.onAnimationFinished();
                        }
        ...
        if (callingApplication == null) {
            ...
            stub = new IApplicationThread.Stub() { // from class: com.oplus.wrapper.view.RemoteAnimationAdapter.3
        ...
        this.mRemoteAnimationAdapter = new android.view.RemoteAnimationAdapter(stub2, duration, statusBarTransitionDelay, stub);
    }

    public RemoteAnimationAdapter(android.view.RemoteAnimationAdapter remoteAnimationAdapter) {

...
public final class QosBearerSession implements Parcelable {
    public static final Parcelable.Creator<QosBearerSession> CREATOR = new Parcelable.Creator<QosBearerSession>() { // from class: com.oplus.telephony.QosBearerSession.1
    ...
    public static QosBearerSession create(QosSession qosSession) {
        ...
        if (qosSession.qosFilters != null) {
            Iterator it = qosSession.qosFilters.iterator();
            while (it.hasNext()) {
                QosFilter filter = (QosFilter) it.next();

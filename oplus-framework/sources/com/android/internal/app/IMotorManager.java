...
public interface IMotorManager extends IInterface {
    public static final String DESCRIPTOR = "com.android.internal.app.IMotorManager";
    ...
    /* loaded from: classes.dex */
    public static class Default implements IMotorManager {
        @Override // com.android.internal.app.IMotorManager
    ...
    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements IMotorManager {
        ...
        public Stub() {
            attachInterface(this, IMotorManager.DESCRIPTOR);
        }

        public static IMotorManager asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(IMotorManager.DESCRIPTOR);
            if (iin != null && (iin instanceof IMotorManager)) {
                return (IMotorManager) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code >= 1 && code <= 16777215) {
                data.enforceInterface(IMotorManager.DESCRIPTOR);
            }
            switch (code) {
                case 1598968902:
                    reply.writeString(IMotorManager.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
        ...
        /* loaded from: classes.dex */
        private static class Proxy implements IMotorManager {
            ...
            public String getInterfaceDescriptor() {
                return IMotorManager.DESCRIPTOR;
            }
            ...
            public int getMotorStateBySystemApp() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IMotorManager.DESCRIPTOR);

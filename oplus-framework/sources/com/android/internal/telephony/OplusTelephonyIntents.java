...
public interface OplusTelephonyIntents {
    ...
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_ENDC_SETTING_GET = "oplus.intent.action.smart5g_if_test_endc_setting_get";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_LOCAL_RELEASE = "oplus.intent.action.smart5g_if_test_local_release";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_NETWORK_CONTROL = "oplus.intent.action.smart5g_if_test_network_control";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_NR_CELL_DROP = "oplus.intent.action.smart5g_if_test_nr_scell_drop";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_NR_PRIO = "oplus.intent.action.smart5g_if_test_nr_prio";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_QCOM_THERMAL_SET = "oplus.intent.action.smart5g_if_test_qcom_thermal_set";
    public static final String ACTION_COMMAND_SMART5G_IF_TEST_SA_SILIENCE_MODE = "oplus.intent.action.smart5g_if_test_silence_mode";
    public static final String ACTION_DATA_ABNORMAL_DETECTED_INFORM = "android.intent.data_abnormal_detected";
    public static final String ACTION_DDS_SWITCH_DONE = "org.codeaurora.intent.action.ACTION_DDS_SWITCH_DONE";
    ...
    public static final String ACTION_REALTIME_OOS = "com.oplus.telephony.action.ACTION_REALTIME_OOS";
    ...
    public static final String ACTION_WFC_STATE_CHANGED = "oplus.intent.action.WFC_STATE_CHANGED";

...
public final class Vendor2Config {
    ...
    public static final int GET_COLOR_MATRIX = 530;
    ...
    public static final int TYPE_MAX_V1_2 = 767;
    public static final int TYPE_MIN_V1_2 = 530;
    ...
    public static final String dumpBitfield(int i) {
        ...
        if (i4 == 530) {
            arrayList.add("GET_COLOR_MATRIX");
            i2 |= 530;
        }
        if ((i & 767) == 767) {

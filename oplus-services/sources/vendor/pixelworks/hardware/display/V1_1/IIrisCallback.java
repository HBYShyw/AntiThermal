...
public interface IIrisCallback extends vendor.pixelworks.hardware.display.V1_0.IIrisCallback {
    public static final String kInterfaceName = "vendor.pixelworks.hardware.display@1.1::IIrisCallback";

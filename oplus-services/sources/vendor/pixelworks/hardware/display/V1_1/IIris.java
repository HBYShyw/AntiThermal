...
public interface IIris extends vendor.pixelworks.hardware.display.V1_0.IIris {
    public static final String kInterfaceName = "vendor.pixelworks.hardware.display@1.1::IIris";

    @FunctionalInterface
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes3.dex */
    public interface getCurrentConfigCallback {
        void onValues(int i, IrisFixedConfig irisFixedConfig);
    }

    @FunctionalInterface
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes3.dex */
    public interface getLayerToneMappingLutCallback {
        void onValues(int i, LutData lutData);
    }

    @FunctionalInterface
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes3.dex */
    public interface updateDisplayBrightnessCallback {
    ...
    void getCurrentConfig(getCurrentConfigCallback getcurrentconfigcallback) throws RemoteException;
    ...
    void getLayerToneMappingLut(long j, int i, getLayerToneMappingLutCallback getlayertonemappinglutcallback) throws RemoteException;
    ...
    void isHDR10Plus(boolean z) throws RemoteException;
    ...
    void registerCallback_1_1(long j, IIrisCallback iIrisCallback) throws RemoteException;

    void registerSoftIrisClient(ISoftIrisClient iSoftIrisClient) throws RemoteException;
    ...
    void setLayerBuffer(long j, long j2, NativeHandle nativeHandle, int i, BufferInfo bufferInfo) throws RemoteException;
    ...
    void updateDisplayBrightness(long j, int i, ArrayList<Integer> arrayList, updateDisplayBrightnessCallback updatedisplaybrightnesscallback) throws RemoteException;
    ...
    public static final class Proxy implements IIris {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.pixelworks.hardware.display@1.1::IIris]@Proxy";
            }
        }
        ...
        @Override // vendor.pixelworks.hardware.display.V1_1.IIris
        public void registerCallback_1_1(long j, IIrisCallback iIrisCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IIris.kInterfaceName);
            hwParcel.writeInt64(j);
            hwParcel.writeStrongBinder(iIrisCallback == null ? null : iIrisCallback.asBinder());
        ...
        @Override // vendor.pixelworks.hardware.display.V1_1.IIris
        public void getLayerToneMappingLut(long j, int i, getLayerToneMappingLutCallback getlayertonemappinglutcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IIris.kInterfaceName);
            hwParcel.writeInt64(j);
            hwParcel.writeInt32(i);
        ...
        @Override // vendor.pixelworks.hardware.display.V1_1.IIris
        public void updateDisplayBrightness(long j, int i, ArrayList<Integer> arrayList, updateDisplayBrightnessCallback updatedisplaybrightnesscallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IIris.kInterfaceName);
            hwParcel.writeInt64(j);
            hwParcel.writeInt32(i);
        ...
        @Override // vendor.pixelworks.hardware.display.V1_1.IIris
        public void getCurrentConfig(getCurrentConfigCallback getcurrentconfigcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IIris.kInterfaceName);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IIris {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IIris.kInterfaceName, vendor.pixelworks.hardware.display.V1_0.IIris.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }

        @Override // vendor.pixelworks.hardware.display.V1_1.IIris, vendor.pixelworks.hardware.display.V1_0.IIris
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-125, 68, 46, -104, 90, -121, -2, -62, -126, 39, -110, 45, 69, -5, 35, -22, -39, -26, -98, 68, 74, -113, 36, 72, -86, -8, 70, 2, 92, 48, -86, 7}, new byte[]{126, 28, 77, -7, 102, 35, -100, 73, 26, 9, -56, 86, -88, 29, -123, -88, 111, -68, 13, 43, 1, 11, -19, 105, -111, 85, 122, 16, -99, -55, 104, -123}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 2:
                    hwParcel.enforceInterface(vendor.pixelworks.hardware.display.V1_0.IIris.kInterfaceName);
                    irisConfigureGet(hwParcel.readInt32(), hwParcel.readInt32Vector(), new IIris.irisConfigureGetCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.1
                ...
                case 5:
                    hwParcel.enforceInterface(vendor.pixelworks.hardware.display.V1_0.IIris.kInterfaceName);
                    panelReadWrite(hwParcel.readBool(), hwParcel.readInt8(), hwParcel.readInt8(), hwParcel.readBool(), hwParcel.readInt8Vector(), hwParcel.readInt8(), new IIris.panelReadWriteCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.2
                ...
                case 6:
                    hwParcel.enforceInterface(vendor.pixelworks.hardware.display.V1_0.IIris.kInterfaceName);
                    irisConfigureBatch(hwParcel.readInt32(), hwParcel.readString(), new IIris.irisConfigureBatchCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.3
                ...
                case 8:
                    hwParcel.enforceInterface(IIris.kInterfaceName);
                    registerCallback_1_1(hwParcel.readInt64(), IIrisCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                    hwParcel2.send();
                    return;
                case 9:
                ...
                case 14:
                    hwParcel.enforceInterface(IIris.kInterfaceName);
                    getLayerToneMappingLut(hwParcel.readInt64(), hwParcel.readInt32(), new getLayerToneMappingLutCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.4
                ...
                case 16:
                    hwParcel.enforceInterface(IIris.kInterfaceName);
                    updateDisplayBrightness(hwParcel.readInt64(), hwParcel.readInt32(), hwParcel.readInt32Vector(), new updateDisplayBrightnessCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.5
                ...
                case 35:
                    hwParcel.enforceInterface(IIris.kInterfaceName);
                    getCurrentConfig(new getCurrentConfigCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.6

...
public interface IIrisFeature extends IBase {
    public static final String kInterfaceName = "vendor.pixelworks.hardware.feature@1.0::IIrisFeature";
    ...
    void getFeature(getFeatureCallback getfeaturecallback) throws RemoteException;
    ...
    public static final class Proxy implements IIrisFeature {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.pixelworks.hardware.feature@1.0::IIrisFeature]@Proxy";
            }
        }
        ...
        @Override // vendor.pixelworks.hardware.feature.V1_0.IIrisFeature
        public void getFeature(getFeatureCallback getfeaturecallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IIrisFeature.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IIrisFeature {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IIrisFeature.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }

        @Override // vendor.pixelworks.hardware.feature.V1_0.IIrisFeature
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{125, -17, 122, -16, 20, -124, 28, 56, -48, 89, 1, -124, 3, -22, 10, -93, -65, 14, -31, -65, -35, 41, -23, -5, -24, 5, 122, -11, 62, -100, 70, -69}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(IIrisFeature.kInterfaceName);
                    getFeature(new getFeatureCallback() { // from class: vendor.pixelworks.hardware.feature.V1_0.IIrisFeature.Stub.1

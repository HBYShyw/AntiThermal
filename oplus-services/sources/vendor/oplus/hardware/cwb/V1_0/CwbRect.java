...
public final class CwbRect {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != CwbRect.class) {
            return false;
        }
        CwbRect cwbRect = (CwbRect) obj;
        return this.left == cwbRect.left && this.top == cwbRect.top && this.right == cwbRect.right && this.bottom == cwbRect.bottom;
    }
    ...
    public static final ArrayList<CwbRect> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<CwbRect> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            cwbRect.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 16);
            arrayList.add(cwbRect);
        }
        return arrayList;
    }
    ...
    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<CwbRect> arrayList) {
        HwBlob hwBlob = new HwBlob(16);

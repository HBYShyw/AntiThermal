...
public class StringPair implements Parcelable {
    public static final Parcelable.Creator<StringPair> CREATOR = new Parcelable.Creator<StringPair>() { // from class: vendor.oplus.hardware.commondcs.StringPair.1
        @Override // android.os.Parcelable.Creator
        public StringPair createFromParcel(Parcel parcel) {
            StringPair stringPair = new StringPair();
            stringPair.readFromParcel(parcel);
            return stringPair;
        }

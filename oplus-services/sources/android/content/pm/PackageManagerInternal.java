...
public abstract class PackageManagerInternal {
    ...
    public static final String EXTRA_ENABLE_ROLLBACK_SESSION_ID = "android.content.pm.extra.ENABLE_ROLLBACK_SESSION_ID";
    ...
    public abstract long getCeDataInode(String str, int i);
    ...
    public abstract List<String> getMimeGroup(String str, String str2);
    ...
    public abstract boolean isEnabledAndMatches(ParsedMainComponent parsedMainComponent, long j, int i);
    ...
    public void onDefaultSimCallManagerAppChanged(String str, int i) {
    }

    public void onDefaultSmsAppChanged(String str, int i) {
    }
    ...
    public abstract ResolveInfo resolveIntent(Intent intent, String str, long j, long j2, int i, boolean z, int i2);
    ...
    public static abstract class InstalledLoadingProgressCallback {
        ...
        /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes.dex */
        private class LoadingProgressCallbackBinder extends IPackageLoadingProgressCallback.Stub {

...
public class PrivateDnsConfig {
    ...
    public static PrivateDnsConfig fromParcel(PrivateDnsConfigParcel privateDnsConfigParcel) {
        ...
        return new PrivateDnsConfig(privateDnsConfigParcel.hostname, (InetAddress[]) ParcelableUtil.fromParcelableArray(strArr, new InitialConfiguration$$ExternalSyntheticLambda0()).toArray(new InetAddress[strArr.length]));
    }
}

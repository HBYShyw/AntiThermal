...
public class ConnectivityModuleConnector {
    ...
    private class ModuleServiceConnection implements ServiceConnection {
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ConnectivityModuleConnector.this.log("ModuleServiceConnection mPackageName:" + this.mPackageName + ",getPackageName:" + componentName.getPackageName() + ", getClassName" + componentName.getClassName());

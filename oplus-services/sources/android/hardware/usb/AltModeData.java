...
public final class AltModeData implements Parcelable {
    ...
    private AltModeData(Parcel parcel) {
        readFromParcel(parcel);
    }

    private AltModeData(int i, Object obj) {
        this._tag = i;
        this._value = obj;
    }
    ...
    public static AltModeData displayPortAltModeData(DisplayPortAltModeData displayPortAltModeData2) {
        return new AltModeData(0, displayPortAltModeData2);
    }
    ...
    public void setDisplayPortAltModeData(DisplayPortAltModeData displayPortAltModeData2) {

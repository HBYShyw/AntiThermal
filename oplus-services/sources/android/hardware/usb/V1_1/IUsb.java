...
public interface IUsb extends android.hardware.usb.V1_0.IUsb {
    public static final String kInterfaceName = "android.hardware.usb@1.1::IUsb";
    ...
    public static final class Proxy implements IUsb {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.usb@1.1::IUsb]@Proxy";
            }
        }
        ...
        @Override // android.hardware.usb.V1_0.IUsb
        public void setCallback(android.hardware.usb.V1_0.IUsbCallback iUsbCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.V1_0.IUsb.kInterfaceName);

...
public interface IUsbCallback extends android.hardware.usb.V1_0.IUsbCallback {
    public static final String kInterfaceName = "android.hardware.usb@1.1::IUsbCallback";
    ...
    void notifyPortStatusChange_1_1(ArrayList<PortStatus_1_1> arrayList, int i) throws RemoteException;
    ...
    public static final class Proxy implements IUsbCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.usb@1.1::IUsbCallback]@Proxy";
            }
        }
        ...
        public void notifyPortStatusChange(ArrayList<PortStatus> arrayList, int i) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IUsbCallback.kInterfaceName, android.hardware.usb.V1_0.IUsbCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                notifyPortStatusChange(PortStatus.readVectorFromParcel(hwParcel), hwParcel.readInt32());
                return;
            }
            if (i == 2) {
                hwParcel.enforceInterface(android.hardware.usb.V1_0.IUsbCallback.kInterfaceName);

...
public interface IBootControl extends IBase {
    ...
    int isSlotBootable(int i) throws RemoteException;

    int isSlotMarkedSuccessful(int i) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    boolean linkToDeath(IHwBinder.DeathRecipient deathRecipient, long j) throws RemoteException;

    CommandResult markBootSuccessful() throws RemoteException;
    ...
    CommandResult setActiveBootSlot(int i) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws RemoteException;

    CommandResult setSlotAsUnbootable(int i) throws RemoteException;
    ...
    public static abstract class Stub extends HwBinder implements IBootControl {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IBootControl.kInterfaceName, IBase.kInterfaceName));
        }

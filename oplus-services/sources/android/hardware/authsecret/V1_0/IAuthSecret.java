...
public interface IAuthSecret extends IBase {
    ...
    public static final class Proxy implements IAuthSecret {
        ...
        @Override // android.hardware.authsecret.V1_0.IAuthSecret, android.hidl.base.V1_0.IBase
        ...
        @Override // android.hardware.authsecret.V1_0.IAuthSecret
    ...
    public static abstract class Stub extends HwBinder implements IAuthSecret {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{66, -96, 109, -62, -120, -10, 27, 6, -112, 88, 15, 61, 55, -77, 11, 102, 60, 49, -41, 77, 80, -69, 88, -48, 119, 35, -122, -75, 80, -43, -6, -85}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }

...
public final class HealthConfig {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j7 + 0, false);
        long j8 = j + 104;
        this.batteryTechnologyPath = hwBlob.getString(j8);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j8 + 0, false);
        long j9 = j + 120;
        this.batteryCurrentNowPath = hwBlob.getString(j9);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j9 + 0, false);
        long j10 = j + 136;
        this.batteryCurrentAvgPath = hwBlob.getString(j10);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j10 + 0, false);
        long j11 = j + 152;
        this.batteryChargeCounterPath = hwBlob.getString(j11);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j11 + 0, false);
        long j12 = j + 168;
        this.batteryFullChargePath = hwBlob.getString(j12);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j12 + 0, false);
        long j13 = j + 184;
        this.batteryCycleCountPath = hwBlob.getString(j13);
        hwParcel.readEmbeddedBuffer(r6.getBytes().length + 1, hwBlob.handle(), j13 + 0, false);
    }

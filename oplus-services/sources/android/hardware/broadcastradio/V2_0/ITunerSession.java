...
public interface ITunerSession extends IBase {
    ...
    static ITunerSession castFrom(IHwInterface iHwInterface) {
    ...
    static ITunerSession getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static ITunerSession getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static ITunerSession getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str));
    }

    @Deprecated
    static ITunerSession getService() throws RemoteException {
    ...
    public static final class Proxy implements ITunerSession {
        ...
        public int tune(ProgramSelector programSelector) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(ITunerSession.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ITunerSession {
        ...
        public final String interfaceDescriptor() {
            return ITunerSession.kInterfaceName;
        }
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ITunerSession.kInterfaceName, IBase.kInterfaceName));
        }

        @Override // android.hardware.broadcastradio.V2_0.ITunerSession, android.hidl.base.V1_0.IBase
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-41, 4, 100, -59, AcquiredInfo.VENDOR, -92, -95, -75, AcquiredInfo.SENSOR_DIRTY, 119, 48, -124, 55, 117, -87, Byte.MAX_VALUE, 69, 81, 2, -111, -98, -108, 91, 4, -9, AcquiredInfo.VENDOR, -71, -38, 57, 12, 15, 57}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (ITunerSession.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(ITunerSession.kInterfaceName);

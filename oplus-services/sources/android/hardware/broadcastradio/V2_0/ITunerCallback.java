...
public interface ITunerCallback extends IBase {
    ...
    static ITunerCallback castFrom(IHwInterface iHwInterface) {
    ...
    static ITunerCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static ITunerCallback getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static ITunerCallback getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements ITunerCallback {
        ...
        public void onTuneFailed(int i, ProgramSelector programSelector) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(ITunerCallback.kInterfaceName);
        ...
        public void onCurrentProgramInfoChanged(ProgramInfo programInfo) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ITunerCallback.kInterfaceName);
            programInfo.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        public void onProgramListUpdated(ProgramListChunk programListChunk) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ITunerCallback.kInterfaceName);
            programListChunk.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements ITunerCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (ITunerCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            if (i == 1) {
                hwParcel.enforceInterface(ITunerCallback.kInterfaceName);

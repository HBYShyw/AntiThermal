...
public interface IBiometricsFace extends IBase {
    ...
    static IBiometricsFace castFrom(IHwInterface iHwInterface) {
    ...
    static IBiometricsFace getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IBiometricsFace getService(boolean z) throws RemoteException {
    ...
    public static final class Proxy implements IBiometricsFace {
        ...
        public OptionalUint64 setCallback(IBiometricsFaceClientCallback iBiometricsFaceClientCallback) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(IBiometricsFace.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFace {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IBiometricsFace.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(IBiometricsFace.kInterfaceName);

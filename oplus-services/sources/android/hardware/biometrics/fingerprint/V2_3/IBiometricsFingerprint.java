...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint {
    public static final String kInterfaceName = "android.hardware.biometrics.fingerprint@2.3::IBiometricsFingerprint";
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFingerprint {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IBiometricsFingerprint.kInterfaceName, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.kInterfaceName, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName, IBase.kInterfaceName));
        }

        @Override // android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{122, 120, -23, -106, 59, -20, 11, 7, 30, 125, 70, -110, -116, 97, 0, -30, AcquiredInfo.VENDOR, 66, 112, -119, 45, 63, AcquiredInfo.START, -95, -22, -83, 7, 73, -105, -83, -14, 121}, new byte[]{AcquiredInfo.FACE_OBSCURED, 15, -113, 98, AcquiredInfo.TOO_SIMILAR, 12, -49, -100, -46, -126, -82, 54, -123, -96, -12, -17, 10, -97, -105, 29, 119, -33, -68, 115, 80, -52, -76, -32, 76, -14, -107, -20}, new byte[]{31, -67, -63, -8, 82, -8, -67, 46, 74, 108, 92, -77, 10, -62, -73, -122, 104, -55, -115, -50, AcquiredInfo.PAN_TOO_EXTREME, -118, 97, 118, 45, 64, 52, -82, -123, -97, 67, -40}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }

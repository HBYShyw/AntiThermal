...
public class StateResidencyResult implements Parcelable {
    public static final Parcelable.Creator<StateResidencyResult> CREATOR = new Parcelable.Creator<StateResidencyResult>() { // from class: android.hardware.power.stats.StateResidencyResult.1
    ...
    public final void readFromParcel(Parcel parcel) {
        ...
        try {
            ...
            if (parcel.dataPosition() - dataPosition < readInt) {
                ...
                if (parcel.dataPosition() - dataPosition < readInt) {
                    this.stateResidencyData = (StateResidency[]) parcel.createTypedArray(StateResidency.CREATOR);

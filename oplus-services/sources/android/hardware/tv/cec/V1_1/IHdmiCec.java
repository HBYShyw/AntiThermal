...
public interface IHdmiCec extends android.hardware.tv.cec.V1_0.IHdmiCec {
    ...
    static IHdmiCec castFrom(IHwInterface iHwInterface) {
    ...
    @Deprecated
    static IHdmiCec getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IHdmiCec {
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public void getPhysicalAddress(IHdmiCec.getPhysicalAddressCallback getphysicaladdresscallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public int sendMessage(android.hardware.tv.cec.V1_0.CecMessage cecMessage) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public void setCallback(android.hardware.tv.cec.V1_0.IHdmiCecCallback iHdmiCecCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
        ...
        public int addLogicalAddress_1_1(int i) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHdmiCec.kInterfaceName);
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public int sendMessage_1_1(CecMessage cecMessage) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHdmiCec.kInterfaceName);
            cecMessage.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public void setCallback_1_1(IHdmiCecCallback iHdmiCecCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHdmiCec.kInterfaceName);
            hwParcel.writeStrongBinder(iHdmiCecCallback == null ? null : iHdmiCecCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IHdmiCec {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IHdmiCec.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 12:
                    ...
                    return;
                case 13:
                    hwParcel.enforceInterface(IHdmiCec.kInterfaceName);

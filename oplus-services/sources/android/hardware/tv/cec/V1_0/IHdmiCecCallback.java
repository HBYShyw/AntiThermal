...
public interface IHdmiCecCallback extends IBase {
    public static final String kInterfaceName = "android.hardware.tv.cec@1.0::IHdmiCecCallback";
    ...
    void onHotplugEvent(HotplugEvent hotplugEvent) throws RemoteException;
    ...
    public static final class Proxy implements IHdmiCecCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.tv.cec@1.0::IHdmiCecCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IHdmiCecCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IHdmiCecCallback.kInterfaceName, IBase.kInterfaceName));
        }

        @Override // android.hardware.tv.cec.V1_0.IHdmiCecCallback, android.hidl.base.V1_0.IBase
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-25, 91, 110, -22, 113, 29, 54, -6, -58, 120, -68, -32, 114, -77, -50, -58, 84, 75, 39, -6, -97, 76, -39, 3, -103, -108, 4, -27, -63, AcquiredInfo.TOO_SIMILAR, -54, AcquiredInfo.TOO_SIMILAR}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }

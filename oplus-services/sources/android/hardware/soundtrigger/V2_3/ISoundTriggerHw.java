...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
    ...
    public static abstract class Stub extends HwBinder implements ISoundTriggerHw {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISoundTriggerHw.kInterfaceName, android.hardware.soundtrigger.V2_2.ISoundTriggerHw.kInterfaceName, android.hardware.soundtrigger.V2_1.ISoundTriggerHw.kInterfaceName, android.hardware.soundtrigger.V2_0.ISoundTriggerHw.kInterfaceName, IBase.kInterfaceName));
        }

        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw, android.hardware.soundtrigger.V2_2.ISoundTriggerHw, android.hardware.soundtrigger.V2_1.ISoundTriggerHw, android.hardware.soundtrigger.V2_0.ISoundTriggerHw, android.hidl.base.V1_0.IBase
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-77, Byte.MAX_VALUE, 120, -29, -3, -57, -102, -8, -77, 42, 84, 91, 43, 66, 111, 31, -47, 53, 91, 53, -99, -98, 120, 53, -13, -65, 30, -48, -86, 69, AcquiredInfo.FIRST_FRAME_RECEIVED, -40}, new byte[]{-50, 75, -104, 33, AcquiredInfo.DARK_GLASSES_DETECTED, 89, 68, -109, 97, AcquiredInfo.FACE_OBSCURED, 109, 75, 30, 85, 84, -36, -124, 28, -21, 77, 69, 119, AcquiredInfo.START, 77, 123, 47, -74, -47, -21, 80, 79, 118}, new byte[]{-76, -11, 7, -76, -36, -101, 92, -43, -16, -28, 68, 89, 38, -84, -73, -39, 69, 37, -82, 96, -36, 48, 123, 57, 81, AcquiredInfo.FACE_OBSCURED, 34, -125, 99, 34, 7, -74}, new byte[]{91, -17, -64, AcquiredInfo.DARK_GLASSES_DETECTED, -53, -23, 73, 83, 102, 30, 44, -37, -107, -29, -49, 100, -11, -27, 101, -62, -108, 3, -31, -62, -38, -20, -62, -66, 68, -32, -91, 92}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    getProperties(new ISoundTriggerHw.getPropertiesCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.1
                ...
                case 2:
                    ...
                    loadSoundModel(soundModel, ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.2
                ...
                case 3:
                    ...
                    loadPhraseSoundModel(phraseSoundModel, ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.3
                ...
                case 8:
                    ...
                    loadSoundModel_2_1(soundModel2, android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.4
                ...
                case 9:
                    ...
                    loadPhraseSoundModel_2_1(phraseSoundModel2, android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadPhraseSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.5
                ...
                case 12:
                    ...
                    getProperties_2_3(new getProperties_2_3Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.6
                ...
                case 15:
                    hwParcel.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    getParameter(hwParcel.readInt32(), hwParcel.readInt32(), new getParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.7
                ...
                case 16:
                    hwParcel.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    queryParameter(hwParcel.readInt32(), hwParcel.readInt32(), new queryParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.8
                        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw.queryParameterCallback
                        public void onValues(int i3, OptionalModelParameterRange optionalModelParameterRange) {
                            hwParcel2.writeStatus(0);
                            hwParcel2.writeInt32(i3);

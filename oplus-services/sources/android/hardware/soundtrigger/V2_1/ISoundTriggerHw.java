...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_0.ISoundTriggerHw {
    ...
    public static final class SoundModel {
        ...
        public static final ArrayList<SoundModel> readVectorFromParcel(HwParcel hwParcel) {
        ...
        public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<SoundModel> arrayList) {
    ...
    public static final class PhraseSoundModel {
        ...
        public static final ArrayList<PhraseSoundModel> readVectorFromParcel(HwParcel hwParcel) {
            ArrayList<PhraseSoundModel> arrayList = new ArrayList<>();
            HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
        ...
        public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
            ...
            this.phrases.clear();
            for (int i = 0; i < int32; i++) {
                ISoundTriggerHw.Phrase phrase = new ISoundTriggerHw.Phrase();
        ...
        public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<PhraseSoundModel> arrayList) {
            HwBlob hwBlob = new HwBlob(16);
            int size = arrayList.size();
            hwBlob.putInt32(8L, size);
            hwBlob.putBool(12L, false);
    ...
    public static final class Proxy implements ISoundTriggerHw {
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public void loadSoundModel(ISoundTriggerHw.SoundModel soundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, ISoundTriggerHw.loadSoundModelCallback loadsoundmodelcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.soundtrigger.V2_0.ISoundTriggerHw.kInterfaceName);
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public void loadPhraseSoundModel(ISoundTriggerHw.PhraseSoundModel phraseSoundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, ISoundTriggerHw.loadPhraseSoundModelCallback loadphrasesoundmodelcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.soundtrigger.V2_0.ISoundTriggerHw.kInterfaceName);
        ...
        @Override // android.hardware.soundtrigger.V2_0.ISoundTriggerHw
        public int startRecognition(int i, ISoundTriggerHw.RecognitionConfig recognitionConfig, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback iSoundTriggerHwCallback, int i2) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.soundtrigger.V2_0.ISoundTriggerHw.kInterfaceName);
            hwParcel.writeInt32(i);
        ...
        public void loadSoundModel_2_1(SoundModel soundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadSoundModel_2_1Callback loadsoundmodel_2_1callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            soundModel.writeToParcel(hwParcel);
            hwParcel.writeStrongBinder(iSoundTriggerHwCallback == null ? null : iSoundTriggerHwCallback.asBinder());
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
        ...
        @Override // android.hardware.soundtrigger.V2_1.ISoundTriggerHw
        public void loadPhraseSoundModel_2_1(PhraseSoundModel phraseSoundModel, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i, loadPhraseSoundModel_2_1Callback loadphrasesoundmodel_2_1callback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            phraseSoundModel.writeToParcel(hwParcel);
            hwParcel.writeStrongBinder(iSoundTriggerHwCallback == null ? null : iSoundTriggerHwCallback.asBinder());
        ...
        @Override // android.hardware.soundtrigger.V2_1.ISoundTriggerHw
        public int startRecognition_2_1(int i, RecognitionConfig recognitionConfig, ISoundTriggerHwCallback iSoundTriggerHwCallback, int i2) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            hwParcel.writeInt32(i);
            recognitionConfig.writeToParcel(hwParcel);
    ...
    public static abstract class Stub extends HwBinder implements ISoundTriggerHw {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (ISoundTriggerHw.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, final HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 2:
                    ...
                    loadSoundModel(soundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.2
                ...
                case 3:
                    ...
                    loadPhraseSoundModel(phraseSoundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.3
                ...
                case 7:
                    ...
                    return;
                case 8:
                    hwParcel.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    SoundModel soundModel2 = new SoundModel();
                    soundModel2.readFromParcel(hwParcel);
                    loadSoundModel_2_1(soundModel2, ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new loadSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.4
                ...
                case 9:
                    hwParcel.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    PhraseSoundModel phraseSoundModel2 = new PhraseSoundModel();
                    phraseSoundModel2.readFromParcel(hwParcel);
                    loadPhraseSoundModel_2_1(phraseSoundModel2, ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new loadPhraseSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_1.ISoundTriggerHw.Stub.5
                ...
                case 10:
                    ...
                    int startRecognition_2_1 = startRecognition_2_1(readInt322, recognitionConfig2, ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32());
                    hwParcel2.writeStatus(0);

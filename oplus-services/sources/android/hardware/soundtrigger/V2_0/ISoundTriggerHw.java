...
public interface ISoundTriggerHw extends IBase {
    ...
    public static final class Phrase {
        ...
        public static final ArrayList<Phrase> readVectorFromParcel(HwParcel hwParcel) {
        ...
        public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<Phrase> arrayList) {
            HwBlob hwBlob = new HwBlob(16);
            int size = arrayList.size();
            hwBlob.putInt32(8L, size);
            hwBlob.putBool(12L, false);

...
public interface IBase extends IHwInterface {
    ...
    public static abstract class Stub extends HwBinder implements IBase {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Collections.singletonList(new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }

...
public interface IServiceNotification extends IBase {
    ...
    void onRegistration(String str, String str2, boolean z) throws RemoteException;
    ...
    static IServiceNotification getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IServiceNotification getService(boolean z) throws RemoteException {
        return getService("default", z);
    }

    @Deprecated
    static IServiceNotification getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str));
    }

    @Deprecated
    static IServiceNotification getService() throws RemoteException {
        return getService("default");
    }

    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes.dex */
    public static final class Proxy implements IServiceNotification {
        ...
        public void onRegistration(String str, String str2, boolean z) throws RemoteException {
    ...
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes.dex */
    public static abstract class Stub extends HwBinder implements IServiceNotification {
        @Override // android.hidl.manager.V1_0.IServiceNotification, android.hidl.base.V1_0.IBase
        public IHwBinder asBinder() {
            return this;
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-4, -34, 29, 7, -120, 6, 106, 98, -43, 118, 111, 77, -63, -99, 76, 30, -57, 105, 103, -43, -35, -74, 54, -11, -100, -52, 102, 96, 52, 96, -68, -8}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }

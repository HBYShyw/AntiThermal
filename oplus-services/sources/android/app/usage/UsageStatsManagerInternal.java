...
public abstract class UsageStatsManagerInternal {
    ...
    public abstract void setAdminProtectedPackages(Set<String> set, int i);

    public abstract void setLastJobRunTime(String str, int i, long j);

    public abstract void unregisterLaunchTimeChangedListener(EstimatedLaunchTimeChangedListener estimatedLaunchTimeChangedListener);

...
public interface IInstalld extends IInterface {
    ...
    public static class Default implements IInstalld {
        ...
        @Override // android.os.IInstalld
        public PersistableBundle oplusCommonInterface(String str, PersistableBundle persistableBundle) throws RemoteException {
            return null;
        }

        @Override // android.os.IInstalld
        public void oplusCustomizeInterface(String str, PersistableBundle persistableBundle, ICustomizePmsCallback iCustomizePmsCallback) throws RemoteException {
        }
    ...
    void oplusCustomizeInterface(String str, PersistableBundle persistableBundle, ICustomizePmsCallback iCustomizePmsCallback) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IInstalld {
        ...
        static final int TRANSACTION_cleanupInvalidPackageDirs = 52;
        ...
        static final int TRANSACTION_getOdexVisibility = 53;
        ...
        static final int TRANSACTION_oplusCommonInterface = 50;
        static final int TRANSACTION_oplusCustomizeInterface = 51;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 50:
                    ...
                    parcel.enforceNoDataAvail();
                    PersistableBundle oplusCommonInterface = oplusCommonInterface(readString100, persistableBundle);
                    parcel2.writeNoException();
                    parcel2.writeTypedObject(oplusCommonInterface, 1);
                    return true;
                case 51:
                    ...
                    ICustomizePmsCallback asInterface = ICustomizePmsCallback.Stub.asInterface(parcel.readStrongBinder());
                    parcel.enforceNoDataAvail();
                    oplusCustomizeInterface(readString101, persistableBundle2, asInterface);
                    parcel2.writeNoException();
                    return true;
                case 52:
                    ...
                    parcel.enforceNoDataAvail();
                    cleanupInvalidPackageDirs(readString102, readInt57, readInt58);
                    parcel2.writeNoException();
                    return true;
                case 53:
                    ...
                    parcel.enforceNoDataAvail();
                    int odexVisibility = getOdexVisibility(readString103, readString104, readString105, readString106);
                    parcel2.writeNoException();
        ...
        private static class Proxy implements IInstalld {
            ...
            public void oplusCustomizeInterface(String str, PersistableBundle persistableBundle, ICustomizePmsCallback iCustomizePmsCallback) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeTypedObject(persistableBundle, 0);
                    obtain.writeStrongInterface(iCustomizePmsCallback);

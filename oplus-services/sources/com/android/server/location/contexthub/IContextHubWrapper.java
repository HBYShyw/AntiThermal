    ...
    public static class ContextHubWrapperAidl extends IContextHubWrapper implements IBinder.DeathRecipient {
        ...
        public class ContextHubAidlCallback extends IContextHubCallback.Stub {
            ...
            public String getInterfaceHash() {
                return "b0fd976b134e549e03726d3ebeeae848e520d3d3";
            }
        ...
        private synchronized IContextHub getHub() {
            return this.mHub;
        }

        private synchronized void setHub(IContextHub iContextHub) {
            this.mHub = iContextHub;
        }

        @Override // android.os.IBinder.DeathRecipient
        public void binderDied() {
            Log.i(IContextHubWrapper.TAG, "Context Hub AIDL HAL died");
            setHub(IContextHubWrapper.maybeConnectToAidlGetProxy());
            if (getHub() == null) {
                Log.e(IContextHubWrapper.TAG, "Could not reconnect to Context Hub AIDL HAL");
                return;
            }
            linkWrapperToHubDeath();
            ...
            if (runnable != null) {
                ...
                Log.e(IContextHubWrapper.TAG, "mHandleServiceRestartCallback is not set");
            }
        }
        ...
        public long[] getPreloadedNanoappIds(int i) {
            ...
            try {
                ...
                Log.e(IContextHubWrapper.TAG, "Exception while getting preloaded nanoapp IDs: " + e.getMessage());
                return null;
            }
        }
        ...
        public void registerExistingCallback(int i) {
            ...
            if (contextHubAidlCallback == null) {
                Log.e(IContextHubWrapper.TAG, "Could not find existing callback to register for context hub ID = " + i);
                return;
            }
            try {
        ...
        public boolean setTestMode(boolean z) {
            ...
            try {
                ...
                Log.e(IContextHubWrapper.TAG, sb.toString());
                return false;
            }
        }
        ...
        private void linkWrapperToHubDeath() {
            ...
            try {
                ...
                Log.e(IContextHubWrapper.TAG, "Context Hub AIDL service death receipt could not be linked");
            }
        }
    }
    ...
    private static abstract class ContextHubWrapperHidl extends IContextHubWrapper {
        ...
        public void registerExistingCallback(int i) throws RemoteException {
            ...
            if (contextHubWrapperHidlCallback == null) {
                Log.e(IContextHubWrapper.TAG, "Could not find existing callback for context hub with ID = " + i);
                return;
            }

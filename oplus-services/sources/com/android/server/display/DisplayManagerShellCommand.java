...
class DisplayManagerShellCommand extends ShellCommand {
    ...
    IOplusDisplayManagerShellCommandExt mDisplayManagerShellCommandExt = (IOplusDisplayManagerShellCommandExt) ExtLoader.type(IOplusDisplayManagerShellCommandExt.class).base(this).create();
    ...
    public int onCommand(String str) {
        ...
        switch (c) {
            ...
            default:
                if (this.mDisplayManagerShellCommandExt.customMatchedOnCommand(this.mService, str)) {
                    return this.mDisplayManagerShellCommandExt.customRunOnCommand(this, str);
                }
                return handleDefaultCommands(str);
        }
    }
    ...
    private int toRefreshRateSwitchingType(int i) {
        ...
        Slog.e(TAG, i + " is not a valid value of matchContentFrameRate type.");
        return -1;
    }

...
public class AmbientBrightnessStatsTracker {
    ...
    class AmbientBrightnessStats {
        ...
        public void writeToXML(OutputStream outputStream) throws IOException {
            ...
            resolveSerializer.startTag((String) null, TAG_AMBIENT_BRIGHTNESS_STATS);
            for (Map.Entry<Integer, Deque<AmbientBrightnessDayStats>> entry : this.mStats.entrySet()) {
                for (AmbientBrightnessDayStats ambientBrightnessDayStats : entry.getValue()) {
                    ...
                    if (userSerialNumber != -1 && ambientBrightnessDayStats.getLocalDate().isAfter(minusDays)) {
                        resolveSerializer.startTag((String) null, TAG_AMBIENT_BRIGHTNESS_DAY_STATS);
                        resolveSerializer.attributeInt((String) null, ATTR_USER, userSerialNumber);
                        resolveSerializer.attribute((String) null, ATTR_LOCAL_DATE, ambientBrightnessDayStats.getLocalDate().toString());
                        ...
                        resolveSerializer.attribute((String) null, ATTR_BUCKET_BOUNDARIES, sb.toString());
                        resolveSerializer.attribute((String) null, ATTR_BUCKET_STATS, sb2.toString());
                        resolveSerializer.endTag((String) null, TAG_AMBIENT_BRIGHTNESS_DAY_STATS);
                    }
                }
            }
            resolveSerializer.endTag((String) null, TAG_AMBIENT_BRIGHTNESS_STATS);
        ...
        */
        public void readFromXML(InputStream inputStream) throws IOException {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (next2 != 3 && next2 != 4 && TAG_AMBIENT_BRIGHTNESS_DAY_STATS.equals(resolvePullParser.getName())) {
                        int attributeInt = resolvePullParser.getAttributeInt((String) null, ATTR_USER);
                        LocalDate parse = LocalDate.parse(resolvePullParser.getAttributeValue((String) null, ATTR_LOCAL_DATE));
                        String[] split = resolvePullParser.getAttributeValue((String) null, ATTR_BUCKET_BOUNDARIES).split(",");
                        String[] split2 = resolvePullParser.getAttributeValue((String) null, ATTR_BUCKET_STATS).split(",");
        ...
        private AmbientBrightnessDayStats getOrCreateDayStats(Deque<AmbientBrightnessDayStats> deque, LocalDate localDate) {
            ...
            if (peekLast != null) {
                FrameworkStatsLog.write(FrameworkStatsLog.AMBIENT_BRIGHTNESS_STATS_REPORTED, peekLast.getStats(), peekLast.getBucketBoundaries());
            }

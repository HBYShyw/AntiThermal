...
public final class UriMetricsHelper {
    ...
    public void registerPuller() {
        ((StatsManager) this.mContext.getSystemService(StatsManager.class)).setPullAtomCallback(10148, DAILY_PULL_METADATA, ConcurrentUtils.DIRECT_EXECUTOR, new StatsManager.StatsPullAtomCallback() { // from class: com.android.server.uri.UriMetricsHelper$$ExternalSyntheticLambda0
    ...
    private void reportPersistentUriPermissionsPerPackage(List<StatsEvent> list) {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            list.add(FrameworkStatsLog.buildStatsEvent(10148, sparseArray.keyAt(i3), ((Integer) sparseArray.valueAt(i3)).intValue()));
        }
    }
}

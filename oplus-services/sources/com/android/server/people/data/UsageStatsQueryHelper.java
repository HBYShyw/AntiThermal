...
class UsageStatsQueryHelper {
    ...
    private static int sumChooserCounts(ArrayMap<String, ArrayMap<String, Integer>> arrayMap) {
        if (arrayMap == null) {
            return 0;
        }
    ...
    private void onInAppConversationEnded(PackageData packageData, UsageEvents.Event event) {
    ...
    private void addEventByShortcutId(PackageData packageData, String str, Event event) {

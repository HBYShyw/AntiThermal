...
public class WebViewUpdateService extends SystemService {
    ...
    private class BinderService extends IWebViewUpdateService.Stub {
        ...
        private void grantVisibilityToCaller(String str, int i) {
            PackageManagerInternal packageManagerInternal = (PackageManagerInternal) LocalServices.getService(PackageManagerInternal.class);
            packageManagerInternal.grantImplicitAccess(UserHandle.getUserId(i), (Intent) null, UserHandle.getAppId(i), packageManagerInternal.getPackageUid(str, 0L, UserHandle.getUserId(i)), true);
        }

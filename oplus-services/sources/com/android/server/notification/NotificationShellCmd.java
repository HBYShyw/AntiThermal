...
public class NotificationShellCmd extends ShellCommand {
    ...
    Icon parseIcon(Resources resources, String str) throws IllegalArgumentException {
        ...
        if (str.startsWith("@")) {
            int identifier = resources.getIdentifier(str.substring(1), "drawable", PackageManagerService.PLATFORM_PACKAGE_NAME);
            if (identifier != 0) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:135:0x0403 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int doNotify(PrintWriter printWriter, String str, int i) throws RemoteException, URISyntaxException {
        char c;
            ...
            if (nextOption != null) {
                ...
                switch (c) {
                    ...
                    case 25:
                        ...
                        String[] split = getNextArgRequired().split(":", 2);
                        if (split.length > 1) {
                ...
                this.mBinderService.enqueueNotificationWithTag(str, str, nextArg2, NOTIFICATION_ID, build, UserHandle.getUserId(i));
                if (z) {
                    NotificationRecord findNotificationLocked = this.mDirectService.findNotificationLocked(str, nextArg2, NOTIFICATION_ID, UserHandle.getUserId(i));
                    while (true) {
                        int i3 = i2 - 1;
                        if (i2 > 0 && findNotificationLocked == null) {
                            ...
                            findNotificationLocked = this.mDirectService.findNotificationLocked(str, nextArg2, NOTIFICATION_ID, UserHandle.getUserId(i));
                            i2 = i3;
                        }
                    }
    ...
    public static class ShellNls extends NotificationListenerService {
        private static ShellNls sNotificationListenerInstance;
        boolean isConnected;

...
public final class UpdatableFontDir {
        ...
        try {
            ...
            while (i < length) {
                ...
                if (readPersistentConfig.updatedFontDirs.contains(file.getName())) {
                    File file2 = new File(file, FONT_SIGNATURE_FILE);
                    if (file2.exists()) {
                        try {
    ...
    public void update(List<FontUpdateRequest> list) throws FontManagerService.SystemFontException {
        ...
        try {
            ...
            while (it.hasNext()) {
                if (resolveFontFilesForNamedFamily((FontUpdateRequest.Family) it.next()) == null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    File file3 = new File(randomDir, FONT_SIGNATURE_FILE);
                                    try {
    ...
    private FontFileInfo validateFontFile(File file, byte[] bArr) throws FontManagerService.SystemFontException {
    ...
    private FontConfig.NamedFamilyList resolveFontFilesForNamedFamily(FontUpdateRequest.Family family) {
    ...
    public Map<String, FontConfig.NamedFamilyList> getFontFamilyMap() {
        ...
        for (int i = 0; i < readPersistentConfig.fontFamilies.size(); i++) {
            FontUpdateRequest.Family family = readPersistentConfig.fontFamilies.get(i);
            FontConfig.NamedFamilyList resolveFontFilesForNamedFamily = resolveFontFilesForNamedFamily(family);
            if (resolveFontFilesForNamedFamily != null) {

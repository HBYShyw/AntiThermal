...
public class FontManagerShellCommand extends ShellCommand {
    ...
    private void dumpSingleFontConfig(IndentingPrintWriter indentingPrintWriter, FontConfig.Font font) {
    ...
    private void dumpFontConfig(IndentingPrintWriter indentingPrintWriter, FontConfig fontConfig) {
    ...
    private void dumpFallback(IndentingPrintWriter indentingPrintWriter, FontFamily[] fontFamilyArr) {
        for (FontFamily fontFamily : fontFamilyArr) {
            dumpFamily(indentingPrintWriter, fontFamily);
        }
    }

    private void dumpFamily(IndentingPrintWriter indentingPrintWriter, FontFamily fontFamily) {
    ...
    private void dumpFont(IndentingPrintWriter indentingPrintWriter, Font font) {
    ...
    private int execCommand(ShellCommand shellCommand, String str) {
        char c;
        if (str == null) {

...
class NetworkPolicyManagerShellCommand extends ShellCommand {
    ...
    private int listUidList(String str, int[] iArr) {
        PrintWriter outPrintWriter = getOutPrintWriter();
    ...
    private int getRestrictedModeState() {
        ...
        outPrintWriter.println(this.mInterface.isRestrictedModeEnabled() ? ServiceConfigAccessor.PROVIDER_MODE_ENABLED : ServiceConfigAccessor.PROVIDER_MODE_DISABLED);
        return 0;
    }
    ...
    private int getRestrictBackground() throws RemoteException {
        ...
        outPrintWriter.println(this.mInterface.getRestrictBackground() ? ServiceConfigAccessor.PROVIDER_MODE_ENABLED : ServiceConfigAccessor.PROVIDER_MODE_DISABLED);
        return 0;
    }
    ...
    private int setAppIdleWhitelist(boolean z) {
        int uidFromNextArg = getUidFromNextArg();
        if (uidFromNextArg < 0) {
            return uidFromNextArg;
        }

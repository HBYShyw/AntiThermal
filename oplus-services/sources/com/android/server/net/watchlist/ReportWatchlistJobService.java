...
public class ReportWatchlistJobService extends JobService {
    ...
    public static void schedule(Context context) {
        ((JobScheduler) context.getSystemService("jobscheduler")).schedule(new JobInfo.Builder(REPORT_WATCHLIST_RECORDS_JOB_ID, new ComponentName(context, (Class<?>) ReportWatchlistJobService.class)).setPeriodic(REPORT_WATCHLIST_RECORDS_PERIOD_MILLIS).setRequiresDeviceIdle(true).setRequiresBatteryNotLow(true).setPersisted(false).build());
    }
}

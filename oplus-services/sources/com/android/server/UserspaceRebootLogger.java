...
public final class UserspaceRebootLogger {
    ...
    public static void logEventAsync(boolean z, Executor executor) {
        ...
        final long j = computeOutcome == 1 ? SystemProperties.getLong(USERSPACE_REBOOT_LAST_FINISHED_PROPERTY, 0L) - SystemProperties.getLong(USERSPACE_REBOOT_LAST_STARTED_PROPERTY, 0L) : 0L;
        final int i = z ? 1 : 2;
    ...
    public static /* synthetic */ void lambda$logEventAsync$0(int i, long j, int i2) {
        Slog.i(TAG, "Logging UserspaceRebootReported atom: { outcome: " + i + " durationMillis: " + j + " encryptionState: " + i2 + " }");
        FrameworkStatsLog.write(FrameworkStatsLog.USERSPACE_REBOOT_REPORTED, i, j, i2);

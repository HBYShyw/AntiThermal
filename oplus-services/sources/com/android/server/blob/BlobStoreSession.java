...
public class BlobStoreSession extends IBlobStoreSession.Stub {
    ...
    private FileDescriptor openWriteInternal(long j, long j2) throws IOException {
        try {
    ...
    public void verifyBlobData() {
        synchronized (this.mSessionLock) {
            ...
            if (bArr != null && Arrays.equals(bArr, this.mBlobHandle.digest)) {
                ...
                sb.append(")");
                Slog.d(BlobStoreConfig.TAG, sb.toString());
                this.mState = 5;
                FrameworkStatsLog.write(FrameworkStatsLog.BLOB_COMMITTED, getOwnerUid(), this.mSessionId, getSize(), 3);
    ...
    @GuardedBy({"mSessionLock"})
    private void trackRevocableFdLocked(final RevocableFileDescriptor revocableFileDescriptor) {
        synchronized (this.mRevocableFds) {

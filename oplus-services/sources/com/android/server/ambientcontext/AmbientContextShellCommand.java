...
final class AmbientContextShellCommand extends ShellCommand {
    ...
    private static final AmbientContextEventRequest WEARABLE_REQUEST = new AmbientContextEventRequest.Builder().addEventType(100001).build();
    private static final AmbientContextEventRequest MIXED_REQUEST = new AmbientContextEventRequest.Builder().addEventType(1).addEventType(100001).build();
    ...
    public static class TestableCallbackInternal {
        ...
        public IAmbientContextObserver createAmbientContextObserver() {

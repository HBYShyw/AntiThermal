...
final class BooleanPolicySerializer extends PolicySerializer<Boolean> {
    ...
    public void saveToXml(PolicyKey policyKey, TypedXmlSerializer typedXmlSerializer, Boolean bool) throws IOException {
        ...
        typedXmlSerializer.attributeBoolean((String) null, ATTR_VALUE, bool.booleanValue());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.android.server.devicepolicy.PolicySerializer
    public BooleanPolicyValue readFromXml(TypedXmlPullParser typedXmlPullParser) {
        try {
            return new BooleanPolicyValue(typedXmlPullParser.getAttributeBoolean((String) null, ATTR_VALUE));

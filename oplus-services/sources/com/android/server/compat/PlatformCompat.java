...
public class PlatformCompat extends IPlatformCompat.Stub {
    ...
    @VisibleForTesting
    PlatformCompat(Context context, CompatConfig compatConfig, AndroidBuildClassifier androidBuildClassifier) {
        this.mContext = context;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean isShownInUI(CompatibilityChangeInfo compatibilityChangeInfo) {

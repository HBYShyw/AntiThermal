...
final class UsageStatsProto {
            ...
            switch (protoInputStream.getFieldNumber()) {
                ...
                case 7:
                    try {
                        ...
                        Slog.e(TAG, "Unable to read chooser counts for " + usageStats.mPackageName, e);
                        break;
                    }
                case 8:
    ...
    private static void loadCountsForAction(ProtoInputStream protoInputStream, ArrayMap<String, Integer> arrayMap) throws IOException {
        String str = null;
        int i = 0;
        while (true) {
            int nextField = protoInputStream.nextField();
    ...
    private static void loadConfigStats(ProtoInputStream protoInputStream, long j, IntervalStats intervalStats) throws IOException {
    ...
    private static void writeStringPool(ProtoOutputStream protoOutputStream, IntervalStats intervalStats) throws IllegalArgumentException {
    ...
    private static void writeUsageStats(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, UsageStats usageStats) throws IllegalArgumentException {
    ...
    private static void writeCountsForAction(ProtoOutputStream protoOutputStream, ArrayMap<String, Integer> arrayMap) throws IllegalArgumentException {
    ...
    private static void writeConfigStats(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, ConfigurationStats configurationStats, boolean z) throws IllegalArgumentException {
        long start = protoOutputStream.start(j);
    ...
    private static void writeEvent(ProtoOutputStream protoOutputStream, long j, IntervalStats intervalStats, UsageEvents.Event event) throws IllegalArgumentException {
        int indexOf;
        String str;
        int indexOf2;
        int indexOf3;

...
final class UsageStatsProtoV2 {
    ...
    private static UsageStats parseUsageStats(ProtoInputStream protoInputStream, long j) throws IOException {
                ...
                switch (nextField) {
                    ...
                    case 7:
                        try {
                            ...
                            Slog.e(TAG, "Unable to read chooser counts for " + usageStats.mPackageToken);
                            break;
                        }
                    case 8:
                    ...
                    case 13:
                        try {
                            usageStats.mErrorCount = protoInputStream.readInt(1120986464269L);
                            break;
                        } catch (IllegalArgumentException e) {
                            usageStats.mErrorCount = 0;
                            Slog.e(TAG, "IllegalArgumentException Unable to read mErrorCount" + e);
                            break;
                        }
                }
            }
    ...
    private static void loadCountsForAction(ProtoInputStream protoInputStream, SparseIntArray sparseIntArray) throws IOException {
        int i = 0;
        int i2 = -1;
        while (true) {
            int nextField = protoInputStream.nextField();
    ...
    private static void loadConfigStats(ProtoInputStream protoInputStream, IntervalStats intervalStats) throws IOException {
    ...
    */
    private static UsageEvents.Event parseEvent(ProtoInputStream protoInputStream, long j) throws IOException {
    ...
    private static void writeUsageStats(ProtoOutputStream protoOutputStream, long j, UsageStats usageStats) throws IllegalArgumentException {
        ...
        protoOutputStream.write(1120986464269L, usageStats.mErrorCount);
        try {
    ...
    private static void loadPackagesMap(ProtoInputStream protoInputStream, SparseArray<ArrayList<String>> sparseArray) throws IOException {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private static UsageEvents.Event parsePendingEvent(ProtoInputStream protoInputStream) throws IOException {
        UsageEvents.Event event = new UsageEvents.Event();
        while (true) {
            switch (protoInputStream.nextField()) {
                case 1:
    ...
    private static Pair<String, Long> parseGlobalComponentUsage(ProtoInputStream protoInputStream) throws IOException {
        String str = "";
        long j = 0;
        while (true) {
            int nextField = protoInputStream.nextField();

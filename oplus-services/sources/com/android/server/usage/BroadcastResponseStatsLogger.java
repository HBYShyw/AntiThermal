...
public class BroadcastResponseStatsLogger {
    ...
    private static final class LogBuffer<T extends Data> extends RingBuffer<T> {
        LogBuffer(Class<T> cls, int i) {
            super(cls, i);
        }

        void logBroadcastDispatchEvent(int i, String str, UserHandle userHandle, long j, long j2, int i2) {
        ...
        void logNotificationEvent(int i, String str, UserHandle userHandle, long j) {
            Data data = (Data) getNextSlot();
            if (data == null) {
                return;
            }
    ...
    private static String notificationEventToString(int i) {

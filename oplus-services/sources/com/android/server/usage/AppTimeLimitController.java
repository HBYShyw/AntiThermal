...
public class AppTimeLimitController {
    ...
    public class SessionUsageGroup extends UsageGroup implements AlarmManager.OnAlarmListener {
        ...
        public void noteUsageStop(long j) {
            ...
            AppTimeLimitController.this.getAlarmManager().setExact(3, this.mNewSessionThresholdMs + AppTimeLimitController.this.getElapsedRealtime(), AppTimeLimitController.TAG, this, AppTimeLimitController.this.mHandler);
        }

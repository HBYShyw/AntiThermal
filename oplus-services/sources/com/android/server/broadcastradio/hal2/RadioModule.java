...
public final class RadioModule {
    ...
    public class AnonymousClass1 extends ITunerCallback.Stub {
        ...
        public /* synthetic */ void lambda$onTuneFailed$1(ProgramSelector programSelector, int i) {
            ...
            synchronized (RadioModule.this.mLock) {
                RadioModule.this.fanoutAidlCallbackLocked(new AidlCallbackRunnable() { // from class: com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda3
        ...
        public void onCurrentProgramInfoChanged(final ProgramInfo programInfo) {
            RadioModule.this.fireLater(new Runnable() { // from class: com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onParametersUpdated(final ArrayList<VendorKeyValue> arrayList) {
            RadioModule.this.fireLater(new Runnable() { // from class: com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    RadioModule.AnonymousClass1.this.lambda$onParametersUpdated$8(arrayList);
                }
            });
        }
    ...
    public static RadioModule tryLoadingModule(int i, String str) {
        try {
            Slog.i(TAG, "Try loading module for idx " + i + ", fqName " + str);
            IBroadcastRadio service = IBroadcastRadio.getService(str);
            if (service == null) {
                Slog.w(TAG, "No service found for fqName " + str);
                return null;
            }
            final Mutable mutable = new Mutable();
            service.getAmFmRegionConfig(false, new IBroadcastRadio.getAmFmRegionConfigCallback() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda1
            ...
            service.getDabRegionConfig(new IBroadcastRadio.getDabRegionConfigCallback() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda2
    ...
    public void fireLater(final Runnable runnable) {
        this.mHandler.post(new Runnable() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                runnable.run();
            }
    ...
    public void fanoutAidlCallback(final AidlCallbackRunnable aidlCallbackRunnable) {
        fireLater(new Runnable() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
        ...
        for (TunerSession tunerSession : this.mAidlTunerSessions) {
            ...
            if (i == currentUser || i == 0) {
                try {
                    ...
                    Slog.e(TAG, "Failed to invoke ITunerCallback: ", e);
                }
            }
        }
        if (arrayList != null) {
    ...
    public ICloseHandle addAnnouncementListener(int[] iArr, IAnnouncementListener iAnnouncementListener) throws RemoteException {
        ...
        final Mutable mutable = new Mutable();
        this.mService.registerAnnouncementListener(arrayList, new AnonymousClass2(iAnnouncementListener), new IBroadcastRadio.registerAnnouncementListenerCallback() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda0
    ...
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes.dex */
    public class AnonymousClass2 extends IAnnouncementListener.Stub {

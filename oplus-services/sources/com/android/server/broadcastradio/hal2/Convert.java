...
public class Convert {
    ...
    private static int[] identifierTypesToProgramTypes(int[] iArr) {
        ...
        return hashSet.stream().mapToInt(new AudioService$$ExternalSyntheticLambda3()).toArray();
    }
    ...
    private static RadioManager.BandDescriptor[] amfmConfigToBands(AmFmRegionConfig amFmRegionConfig) {
        ...
        while (it.hasNext()) {
            ...
            if (band == FrequencyBand.UNKNOWN) {
                Slog.e(TAG, "Unknown frequency band at " + next.lowerBound + "kHz");
    ...
    private static Map<String, Integer> dabConfigFromHal(List<DabTableEntry> list) {
        ...
        return (Map) list.stream().collect(Collectors.toMap(new Function() { // from class: com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda1
    ...
    public static RadioManager.ModuleProperties propertiesFromHal(int i, String str, Properties properties, AmFmRegionConfig amFmRegionConfig, List<DabTableEntry> list) {
        ...
        int[] array = properties.supportedIdentifierTypes.stream().mapToInt(new AudioService$$ExternalSyntheticLambda3()).toArray();
    ...
    public static android.hardware.broadcastradio.V2_0.ProgramSelector programSelectorToHal(ProgramSelector programSelector) {
        ...
        Stream map = Arrays.stream(programSelector.getSecondaryIds()).map(new Function() { // from class: com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda7
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    private static boolean isEmpty(android.hardware.broadcastradio.V2_0.ProgramSelector programSelector) {
    ...
    public static ProgramSelector programSelectorFromHal(android.hardware.broadcastradio.V2_0.ProgramSelector programSelector) {
        ...
        ProgramSelector.Identifier[] identifierArr = (ProgramSelector.Identifier[]) programSelector.secondaryIds.stream().map(new Function() { // from class: com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda9
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    private static RadioMetadata metadataFromHal(ArrayList<Metadata> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            if (metadataDef == null) {
                Slog.i(TAG, "Ignored unknown metadata entry: " + MetadataKey.toString(next.key));
    ...
    public static ProgramList.Chunk programListChunkFromHal(ProgramListChunk programListChunk) {
        return new ProgramList.Chunk(programListChunk.purge, programListChunk.complete, (Set) programListChunk.modified.stream().map(new Function() { // from class: com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
        ...
        }).collect(Collectors.toSet()), (Set) programListChunk.removed.stream().map(new Function() { // from class: com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda4
            @Override // java.util.function.Function
            public final Object apply(Object obj) {

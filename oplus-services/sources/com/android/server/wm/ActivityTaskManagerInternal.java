...
public abstract class ActivityTaskManagerInternal {
    ...
    public abstract boolean dumpActivity(FileDescriptor fileDescriptor, PrintWriter printWriter, String str, String[] strArr, int i, boolean z, boolean z2, boolean z3, int i2, int i3);
    ...
    public abstract void preBindApplication(WindowProcessController windowProcessController, Configuration configuration, Bundle bundle);
    ...
    public abstract void setProfileOwnerUids(Set<Integer> set);

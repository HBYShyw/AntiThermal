...
public class DisplayAreaOrganizerController extends IDisplayAreaOrganizerController.Stub {
    ...
    public /* synthetic */ void lambda$registerOrganizer$1(final int i, final List list, final IDisplayAreaOrganizer iDisplayAreaOrganizer, DisplayContent displayContent) {
        ...
        displayContent.forAllDisplayAreas(new Consumer() { // from class: com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
        ...
        try {
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ...
                    this.mOrganizersByFeatureIds.entrySet().removeIf(new Predicate() { // from class: com.android.server.wm.DisplayAreaOrganizerController$$ExternalSyntheticLambda4
    ...
    private TaskDisplayArea createTaskDisplayArea(final RootDisplayArea rootDisplayArea, String str, int i) {

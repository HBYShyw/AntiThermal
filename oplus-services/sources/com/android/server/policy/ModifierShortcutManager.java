...
class ModifierShortcutManager {
    ...
    private boolean handleIntentShortcut(KeyCharacterMap keyCharacterMap, int i, int i2) {
        if (this.mSearchKeyShortcutPending) {
            ...
            if ((458752 & i2) == 0) {
                ...
                try {
                    ...
                    Slog.w(TAG, "Dropping application launch key because the activity to which it is registered was not found: keyCode=" + KeyEvent.keyCodeToString(i) + ", category=" + str);
                }
                return true;
            }
            i2 &= -458753;
        ...
        try {
            ...
            Slog.w(TAG, "Dropping shortcut key combination because the activity to which it is registered was not found: META+ or SEARCH" + KeyEvent.keyCodeToString(i));
        }
        return true;
    }
    ...
    public static final class ShortcutInfo {
        ...
        ShortcutInfo(String str, Intent intent) {
            this.title = str;
            this.intent = intent;
        }
    }

...
public abstract class SoftRestrictedPermissionPolicy {
    ...
    public static SoftRestrictedPermissionPolicy forPermission(Context context, ApplicationInfo applicationInfo, AndroidPackage androidPackage, UserHandle userHandle, String str) {
        ...
        if (!str.equals("android.permission.READ_EXTERNAL_STORAGE")) {
            if (str.equals("android.permission.WRITE_EXTERNAL_STORAGE")) {
                if (applicationInfo != null) {
                    boolean z9 = (context.getPackageManager().getPermissionFlags(str, applicationInfo.packageName, userHandle) & FLAGS_PERMISSION_RESTRICTION_ANY_EXEMPT) != 0;
        ...
        if (applicationInfo != null) {
            ...
            boolean z10 = (permissionFlags & FLAGS_PERMISSION_RESTRICTION_ANY_EXEMPT) != 0;
    ...
    private static boolean hasUidRequestedLegacyExternalStorage(int i, Context context) {
        PackageManager packageManager = context.getPackageManager();
    ...
    private static boolean hasWriteMediaStorageGrantedForUid(int i, Context context) {
        PackageManager packageManager = context.getPackageManager();
        String[] packagesForUid = packageManager.getPackagesForUid(i);
        if (packagesForUid == null) {
            return false;

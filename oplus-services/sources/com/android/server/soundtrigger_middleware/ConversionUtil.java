...
class ConversionUtil {
    ...
    static Properties hidl2aidlProperties(ISoundTriggerHw.Properties properties) {
    ...
    static String hidl2aidlUuid(Uuid uuid) {
        byte[] bArr = uuid.node;
    ...
    static Uuid aidl2hidlUuid(String str) {
    ...
    static ISoundTriggerHw.Phrase aidl2hidlPhrase(Phrase phrase) {
    ...
    static android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra aidl2hidlPhraseRecognitionExtra(PhraseRecognitionExtra phraseRecognitionExtra) {
    ...
    static PhraseRecognitionExtra hidl2aidlPhraseRecognitionExtra(android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra phraseRecognitionExtra) {
        ...
        for (int i = 0; i < phraseRecognitionExtra.levels.size(); i++) {
            phraseRecognitionExtra2.levels[i] = hidl2aidlConfidenceLevel((android.hardware.soundtrigger.V2_0.ConfidenceLevel) phraseRecognitionExtra.levels.get(i));
        }
        return phraseRecognitionExtra2;
    }

    static android.hardware.soundtrigger.V2_0.ConfidenceLevel aidl2hidlConfidenceLevel(ConfidenceLevel confidenceLevel) {
    ...
    static ConfidenceLevel hidl2aidlConfidenceLevel(android.hardware.soundtrigger.V2_0.ConfidenceLevel confidenceLevel) {
    ...
    static RecognitionEvent hidl2aidlRecognitionEvent(ISoundTriggerHwCallback.RecognitionEvent recognitionEvent) {
        ...
        while (true) {
            ...
            bArr[i] = ((Byte) recognitionEvent.data.get(i)).byteValue();
            i++;
        }
    ...
    static PhraseRecognitionEvent hidl2aidlPhraseRecognitionEvent(ISoundTriggerHwCallback.PhraseRecognitionEvent phraseRecognitionEvent) {
        ...
        for (int i = 0; i < phraseRecognitionEvent.phraseExtras.size(); i++) {
            phraseRecognitionEvent2.phraseExtras[i] = hidl2aidlPhraseRecognitionExtra((android.hardware.soundtrigger.V2_0.PhraseRecognitionExtra) phraseRecognitionEvent.phraseExtras.get(i));
        }
    ...
    static AudioConfig hidl2aidlAudioConfig(android.hardware.audio.common.V2_0.AudioConfig audioConfig, boolean z) {
    ...
    static AudioOffloadInfo hidl2aidlOffloadInfo(android.hardware.audio.common.V2_0.AudioOffloadInfo audioOffloadInfo) {
    ...
    private static HidlMemory parcelFileDescriptorToHidlMemory(ParcelFileDescriptor parcelFileDescriptor, int i) {
        if (i > 0) {

...
public class SoundTriggerMiddlewareValidation implements ISoundTriggerMiddlewareInternal, Dumpable {
    ...
    static RuntimeException handleException(Exception exc) {
        ...
        Log.wtf(TAG, "Unexpected exception", exc);
        ...
        synchronized (this) {
            ...
            if (map != null) {
                ...
                while (it.hasNext()) {
                    ...
                    printWriter.println("=========================================");
                    Iterator<Session> it2 = moduleState.sessions.iterator();
                    while (it2.hasNext()) {
    ...
    private class Session extends ISoundTriggerModule.Stub {
        ...
        Session(int i, ISoundTriggerCallback iSoundTriggerCallback) {
        ...
        void attach(ISoundTriggerModule iSoundTriggerModule) {
        ...
        public void stopRecognition(int i) {
            synchronized (SoundTriggerMiddlewareValidation.this) {
                ...
                if (this.mLoadedModels.get(Integer.valueOf(i)) == null) {
                    throw new IllegalStateException("Invalid handle: " + i);
                }
            }
            try {
        ...
        public class CallbackWrapper implements ISoundTriggerCallback, IBinder.DeathRecipient {
            ...
            CallbackWrapper(ISoundTriggerCallback iSoundTriggerCallback) {
                ...
                synchronized (SoundTriggerMiddlewareValidation.this) {
                    for (Map.Entry entry2 : Session.this.mLoadedModels.entrySet()) {
                        if (sparseArray.get(((Integer) entry2.getKey()).intValue()) != ((ModelState) entry2.getValue()).activityState) {
                            Log.e(SoundTriggerMiddlewareValidation.TAG, "Unexpected state update in binderDied. Race occurred!");
                        }
                    }

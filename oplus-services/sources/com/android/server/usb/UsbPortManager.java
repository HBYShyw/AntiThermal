...
public class UsbPortManager implements IBinder.DeathRecipient {
    ...
    private final ArrayMap<IBinder, IDisplayPortAltModeInfoListener> mDisplayPortListeners = new ArrayMap<>();
    private final Handler mHandler = new Handler(FgThread.get().getLooper()) { // from class: com.android.server.usb.UsbPortManager.1
        ...
        public void handleMessage(Message message) {
            ...
            ArrayList parcelableArrayList = message.getData().getParcelableArrayList(UsbPortManager.PORT_INFO, RawPortInfo.class);
    ...
    private void updateContaminantNotification() {
        ...
        if (i3 != 3 || (i2 = this.mIsPortContaminatedNotificationId) == 52) {
            ...
            if (i3 == 2) {
                ...
                CharSequence text = resources.getText(17041788);
                String str = SystemNotificationChannels.ALERTS;
                CharSequence text2 = resources.getText(17041787);
                this.mNotificationManager.notifyAsUser(null, this.mIsPortContaminatedNotificationId, new Notification.Builder(this.mContext, str).setSmallIcon(R.drawable.jog_dial_arrow_long_middle_yellow).setTicker(text).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).setContentTitle(text).setContentText(text2).setVisibility(1).setStyle(new Notification.BigTextStyle().bigText(text2)).build(), UserHandle.ALL);
                return;
            }
            return;
        }
        ...
        CharSequence text3 = resources.getText(17041786);
        String str2 = SystemNotificationChannels.ALERTS;
        CharSequence text4 = resources.getText(17041785);
        Intent intent = new Intent();
        intent.addFlags(268435456);
        intent.setComponent(ComponentName.unflattenFromString(resources.getString(R.string.dump_heap_notification_detail)));
    ...
    public void binderDied(IBinder iBinder) {
        synchronized (this.mDisplayPortListenerLock) {
            ...
            Slog.d(TAG, "DisplayPortEventDispatcherListener died at " + iBinder);
        }
    }
    ...
    private void addOrUpdatePortLocked(String str, int i, int i2, int i3, boolean z, int i4, boolean z2, int i5, boolean z3, boolean z4, int i6, boolean z5, int i7, int i8, boolean z6, int i9, boolean z7, int[] iArr, int i10, int i11, DisplayPortAltModeInfo displayPortAltModeInfo, IndentingPrintWriter indentingPrintWriter) {
        boolean z8;
        int i12;
        int i13;
        int i14;
    ...
    private void handlePortComplianceWarningLocked(PortInfo portInfo, IndentingPrintWriter indentingPrintWriter) {
    ...
    private void handleDpAltModeLocked(PortInfo portInfo, IndentingPrintWriter indentingPrintWriter) {
    ...
    private static int[] toStatsLogConstant(int[] iArr) {
        IntArray intArray = new IntArray();
        for (int i : iArr) {
            if (i == 1) {
                intArray.add(4);
    ...
    private void sendDpAltModeCallbackLocked(PortInfo portInfo, IndentingPrintWriter indentingPrintWriter) {
        String id = portInfo.mUsbPort.getId();
        synchronized (this.mDisplayPortListenerLock) {
            Iterator<IDisplayPortAltModeInfoListener> it = this.mDisplayPortListeners.values().iterator();
            while (it.hasNext()) {
                try {
    ...
    private void disableLimitPowerTransferIfNeeded(PortInfo portInfo, IndentingPrintWriter indentingPrintWriter) {
    ...
    private void logToStatsdComplianceWarnings(PortInfo portInfo) {
        ...
        FrameworkStatsLog.write(582, portInfo.mUsbPort.getId(), toStatsLogConstant(portInfo.mUsbPortStatus.getComplianceWarnings()));
    }
    ...
    public static final class PortInfo {
        ...
        PortInfo(UsbManager usbManager, String str, int i, int i2, boolean z, boolean z2, boolean z3, int i3) {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:10:0x0037, code lost:
            ...
            if (r16.mUsbPortStatus.getSupportedRoleCombinations() != r23) goto L17;
         */
        ...
        */
        public boolean setStatus(int i, boolean z, int i2, boolean z2, int i3, boolean z3, int i4) {
            ...
            if (usbPortStatus != null && usbPortStatus.getCurrentMode() == i) {
                if (this.mUsbPortStatus.getCurrentPowerRole() == i2) {
                    ...
                    this.mUsbPortStatus = new UsbPortStatus(i, i2, i3, i4, 0, 0, 0, false, 0, new int[0], 0, (DisplayPortAltModeInfo) null);
                    z4 = true;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:20:0x0069, code lost:
            ...
            if (r16.mUsbPortStatus.getPowerBrickConnectionStatus() != r28) goto L32;
         */
                            ...
                            if (this.mUsbPortStatus.getContaminantProtectionStatus() == i5) {
                                if (this.mUsbPortStatus.getContaminantDetectionStatus() == i6) {
                                    if (this.mUsbPortStatus.getUsbDataStatus() == i7) {
                                        ...
                                        this.mUsbPortStatus = new UsbPortStatus(i, i2, i3, i4, i5, i6, i7, z4, i8, new int[0], 0, (DisplayPortAltModeInfo) null);
                                        z5 = true;
                                        if (!this.mUsbPortStatus.isConnected() && this.mConnectedAtMillis == 0) {
                                            this.mConnectedAtMillis = SystemClock.elapsedRealtime();
                                            this.mLastConnectDurationMillis = 0L;

...
public class EventLogTags {
    ...
    public static void writeBatterySaverMode(int i, int i2, int i3, int i4, int i5, String str, int i6) {
        EventLog.writeEvent(BATTERY_SAVER_MODE, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), str, Integer.valueOf(i6));
    }
    ...
    public static void writeThermalChanged(String str, int i, float f, int i2, int i3) {
        EventLog.writeEvent(THERMAL_CHANGED, str, Integer.valueOf(i), Float.valueOf(f), Integer.valueOf(i2), Integer.valueOf(i3));
    }
    ...
    public static void writeNotificationAdjusted(String str, String str2, String str3) {
        EventLog.writeEvent(NOTIFICATION_ADJUSTED, str, str2, str3);
    }
    ...
    public static void writeSystemServerStart(int i, long j, long j2) {
        EventLog.writeEvent(SYSTEM_SERVER_START, Integer.valueOf(i), Long.valueOf(j), Long.valueOf(j2));
    }
    ...
    public static void writePmPackageStats(long j, long j2, long j3, long j4, long j5, long j6) {
        EventLog.writeEvent(3121, Long.valueOf(j), Long.valueOf(j2), Long.valueOf(j3), Long.valueOf(j4), Long.valueOf(j5), Long.valueOf(j6));
    }

    public static void writePmSnapshotStats(int i, int i2, int i3, int i4, int i5, long j) {
        EventLog.writeEvent(3130, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Long.valueOf(j));
    }
    ...
    public static void writeImfShowIme(String str, String str2, String str3, String str4) {
        EventLog.writeEvent(IMF_SHOW_IME, str, str2, str3, str4);
    }

    public static void writeImfHideIme(String str, String str2, String str3, String str4) {
        EventLog.writeEvent(IMF_HIDE_IME, str, str2, str3, str4);
    }
    ...
    public static void writeNetstatsMobileSample(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9) {
        EventLog.writeEvent(NETSTATS_MOBILE_SAMPLE, Long.valueOf(j), Long.valueOf(j2), Long.valueOf(j3), Long.valueOf(j4), Long.valueOf(j5), Long.valueOf(j6), Long.valueOf(j7), Long.valueOf(j8), Long.valueOf(j9));
    }

    public static void writeNetstatsWifiSample(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9) {
        EventLog.writeEvent(NETSTATS_WIFI_SAMPLE, Long.valueOf(j), Long.valueOf(j2), Long.valueOf(j3), Long.valueOf(j4), Long.valueOf(j5), Long.valueOf(j6), Long.valueOf(j7), Long.valueOf(j8), Long.valueOf(j9));
    }

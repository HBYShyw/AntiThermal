...
public class BatteryExternalStatsWorker implements BatteryStatsImpl.ExternalStatsSync {
    ...
    BatteryExternalStatsWorker(Injector injector, BatteryStatsImpl batteryStatsImpl) {
        this.mExecutorService = Executors.newSingleThreadScheduledExecutor(new ThreadFactory() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda4
        ...
        this.mSyncTask = new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker.1
            ...
            public void run() {
                ...
                synchronized (BatteryExternalStatsWorker.this) {
                    ...
                    i3 = i & BatteryStatsImpl.ExternalStatsSync.UPDATE_ALL;
                    if (i3 == 127) {
    ...
    public Future<?> scheduleCpuSyncDueToWakelockChange(long j) {
        ...
        synchronized (this) {
            scheduleDelayedSyncLocked = scheduleDelayedSyncLocked(this.mWakelockChangesUpdate, new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$scheduleCpuSyncDueToWakelockChange$3() {
        ...
        scheduleRunnable(new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public Future<?> scheduleSyncDueToBatteryLevelChange(long j) {
        Future<?> scheduleDelayedSyncLocked;
        synchronized (this) {
            scheduleDelayedSyncLocked = scheduleDelayedSyncLocked(this.mBatteryLevelSync, new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$scheduleSyncDueToBatteryLevelChange$4() {
        scheduleSync("battery-level", BatteryStatsImpl.ExternalStatsSync.UPDATE_ALL);
    }
    ...
    public Future<?> scheduleCleanupDueToRemovedUser(final int i) {
        ...
        synchronized (this) {
            ...
            Runnable runnable = new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
            ...
            scheduledExecutorService.schedule(runnable, EXTERNAL_STATS_SYNC_TIMEOUT_MILLIS, timeUnit);
            schedule = this.mExecutorService.schedule(new Runnable() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    BatteryExternalStatsWorker.this.lambda$scheduleCleanupDueToRemovedUser$7(i);
                }
            }, JobStatus.DEFAULT_TRIGGER_UPDATE_DELAY, timeUnit);
        }
        return schedule;
    }
    ...
    public synchronized Future<?> scheduleWrite() {
        ...
        scheduleSyncLocked("write", BatteryStatsImpl.ExternalStatsSync.UPDATE_ALL);
        try {
    ...
    */
    public void updateExternalStatsLocked(String str, int i, boolean z, boolean z2, int i2, int[] iArr, boolean z3) {
        ...
        if ((i & 2) != 0) {
            ...
            if (wifiManager == null || !wifiManager.isEnhancedPowerReportingSupported()) {
                ...
                }, new WifiManager.OnWifiActivityEnergyInfoListener() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker$$ExternalSyntheticLambda2
        ...
        if ((i & 8) == 0 || (defaultAdapter = BluetoothAdapter.getDefaultAdapter()) == null) {
            ...
            defaultAdapter.requestControllerActivityEnergyInfo(new SystemServerInitThreadPool$.ExternalSyntheticLambda1(), new BluetoothAdapter.OnBluetoothActivityEnergyInfoCallback() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker.4
                ...
                public void onBluetoothActivityEnergyInfoError(int i5) {
                    Slog.w(BatteryExternalStatsWorker.TAG, "error reading Bluetooth stats: " + i5);
                    Bundle bundle = new Bundle();
        ...
        if ((i & 4) != 0) {
            if (this.mTelephony != null) {
                ...
                this.mTelephony.requestModemActivityInfo(new SystemServerInitThreadPool$.ExternalSyntheticLambda1(), new OutcomeReceiver<ModemActivityInfo, TelephonyManager.ModemActivityInfoException>() { // from class: com.android.server.power.stats.BatteryExternalStatsWorker.5
        ...
        synchronized (batteryStatsImpl) {
            ...
            try {
                ...
                int i6 = i & BatteryStatsImpl.ExternalStatsSync.UPDATE_ALL;
                if (i6 == 127) {
                ...
                if (awaitControllerInfo == null) {
                    ...
                    j2 = elapsedRealtime2222;
                    i3 = 127;
                    Slog.w(TAG, "bluetooth info is invalid: " + awaitControllerInfo);
                }

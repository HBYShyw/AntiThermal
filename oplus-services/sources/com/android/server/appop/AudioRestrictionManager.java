...
public class AudioRestrictionManager {
    ...
    private static String cameraRestrictionModeToName(int i) {
    ...
    static {
        ...
        for (int i : AudioAttributes.SDK_USAGES) {
            ...
            if (i2 == 1 || i2 == 2 || i2 == 4) {
                ...
                Slog.e(TAG, "Unknown audio suppression behavior" + i2);
            }
        }
    ...
    private int checkZenModeRestrictionLocked(int i, int i2, int i3, String str) {

...
public final class AutofillManagerServiceShellCommand extends ShellCommand {
    ...
    private int setTemporaryDetectionService(PrintWriter printWriter) {
    ...
    private int isFieldDetectionServiceEnabled(PrintWriter printWriter) {
        printWriter.println(this.mService.isFieldDetectionServiceEnabledForUser(getNextIntArgRequired()));
        return 0;
    }

    private int setTemporaryAugmentedService(PrintWriter printWriter) {
        int nextIntArgRequired = getNextIntArgRequired();
        String nextArg = getNextArg();
        if (nextArg == null) {
    ...
    private int getDefaultAugmentedServiceEnabled(PrintWriter printWriter) {
        printWriter.println(this.mService.isDefaultAugmentedServiceEnabled(getNextIntArgRequired()));
        return 0;
    }

    private int setDefaultAugmentedServiceEnabled(PrintWriter printWriter) {
        int nextIntArgRequired = getNextIntArgRequired();
    ...
    private int getSavedPasswordCount(final PrintWriter printWriter) {
        int nextIntArgRequired = getNextIntArgRequired();
        final CountDownLatch countDownLatch = new CountDownLatch(1);

...
public final class AutoFillUI {
    ...
    public void showFillUi(final AutofillId autofillId, final FillResponse fillResponse, final String str, String str2, ComponentName componentName, final CharSequence charSequence, final Drawable drawable, final AutoFillUiCallback autoFillUiCallback, final Context context, int i, boolean z) {
        if (Helper.sDebug) {
            Slogf.d(TAG, "showFillUi(): id=%s, filter=%d chars, displayId=%d", new Object[]{autofillId, Integer.valueOf(str == null ? 0 : str.length()), Integer.valueOf(context.getDisplayId())});
        }
        ...
        Runnable runnable = new Runnable() { // from class: com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                AutoFillUI.this.lambda$showFillUi$6(autoFillUiCallback, context, fillResponse, autofillId, str, charSequence, drawable, addTaggedData);
            }
        };
        if (isSaveUiShowing()) {
            if (Helper.sDebug) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFillUi$6(final AutoFillUiCallback autoFillUiCallback, Context context, final FillResponse fillResponse, final AutofillId autofillId, String str, CharSequence charSequence, Drawable drawable, final LogMaker logMaker) {
        if (autoFillUiCallback != this.mCallback) {
            return;
        }
        lambda$hideAll$10(autoFillUiCallback);
        this.mFillUi = new FillUi(context, fillResponse, autofillId, str, this.mOverlayControl, charSequence, drawable, this.mUiModeMgr.isNightMode(), new FillUi.Callback() { // from class: com.android.server.autofill.ui.AutoFillUI.1
            ...
            public void onResponsePicked(FillResponse fillResponse2) {
                ...
                if (AutoFillUI.this.mCallback != null) {
                    AutoFillUI.this.mCallback.authenticate(fillResponse2.getRequestId(), BluetoothStatsLog.BLUETOOTH_DEVICE_INFO_REPORTED__ADDRESS_TYPE__ADDRESS_TYPE_UNKNOWN, fillResponse2.getAuthentication(), fillResponse2.getClientState(), 1);
                }
            }
    ...
    public void showSaveUi(final CharSequence charSequence, final Drawable drawable, final String str, final SaveInfo saveInfo, final ValueFinder valueFinder, final ComponentName componentName, final AutoFillUiCallback autoFillUiCallback, final Context context, final PendingUi pendingUi, final boolean z, final boolean z2, final boolean z3, final SaveEventLogger saveEventLogger) {
        if (Helper.sVerbose) {
            Slogf.v(TAG, "showSaveUi(update=%b) for %s and display %d: %s", new Object[]{Boolean.valueOf(z), componentName.toShortString(), Integer.valueOf(context.getDisplayId()), saveInfo});
        }
        ...
        this.mHandler.post(new Runnable() { // from class: com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                AutoFillUI.this.lambda$showSaveUi$7(autoFillUiCallback, context, pendingUi, charSequence, drawable, str, componentName, saveInfo, valueFinder, addTaggedData, saveEventLogger, z, z2, z3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSaveUi$7(final AutoFillUiCallback autoFillUiCallback, Context context, final PendingUi pendingUi, CharSequence charSequence, Drawable drawable, String str, ComponentName componentName, SaveInfo saveInfo, ValueFinder valueFinder, final LogMaker logMaker, final SaveEventLogger saveEventLogger, boolean z, boolean z2, boolean z3) {
        if (autoFillUiCallback != this.mCallback) {
            return;
        }
        lambda$hideAll$10(autoFillUiCallback);
        ...
        this.mSaveUi = new SaveUi(context, pendingUi, charSequence, drawable, str, componentName, saveInfo, valueFinder, this.mOverlayControl, new SaveUi.OnSaveListener() { // from class: com.android.server.autofill.ui.AutoFillUI.2
            ...
            public void onSave() {
                logMaker.setType(4);
                SaveEventLogger saveEventLogger2 = saveEventLogger;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFillDialog$8(final AutoFillUiCallback autoFillUiCallback, final FillResponse fillResponse, final AutofillId autofillId, String str, Drawable drawable, String str2, ComponentName componentName, final PresentationStatsEventLogger presentationStatsEventLogger, final LogMaker logMaker) {
        if (autoFillUiCallback != this.mCallback) {
            return;
        }
        lambda$hideAll$10(autoFillUiCallback);
        this.mFillDialog = new DialogFillUi(this.mContext, fillResponse, autofillId, str, drawable, str2, componentName, this.mOverlayControl, this.mUiModeMgr.isNightMode(), new DialogFillUi.UiCallback() { // from class: com.android.server.autofill.ui.AutoFillUI.3
            ...
            public void onResponsePicked(FillResponse fillResponse2) {
                ...
                AutoFillUI.this.lambda$hideFillDialog$4(autoFillUiCallback);
                if (AutoFillUI.this.mCallback != null) {
                    AutoFillUI.this.mCallback.authenticate(fillResponse2.getRequestId(), BluetoothStatsLog.BLUETOOTH_DEVICE_INFO_REPORTED__ADDRESS_TYPE__ADDRESS_TYPE_UNKNOWN, fillResponse2.getAuthentication(), fillResponse2.getClientState(), 3);
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void hideFillUiUiThread(AutoFillUiCallback autoFillUiCallback, boolean z) {
    ...
    public void lambda$hideFillDialog$4(AutoFillUiCallback autoFillUiCallback) {
        DialogFillUi dialogFillUi = this.mFillDialog;
        if (dialogFillUi != null) {
            if (autoFillUiCallback == null || autoFillUiCallback == this.mCallback) {
    ...
    public void lambda$destroyAll$11(PendingUi pendingUi, AutoFillUiCallback autoFillUiCallback, boolean z) {
    ...
    public void lambda$hideAll$10(AutoFillUiCallback autoFillUiCallback) {
        hideFillUiUiThread(autoFillUiCallback, true);
        lambda$hideFillDialog$4(autoFillUiCallback);

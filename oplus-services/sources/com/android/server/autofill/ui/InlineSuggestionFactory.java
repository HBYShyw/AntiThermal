...
public final class InlineSuggestionFactory {
    ...
    public static InlineSuggestion createInlineAuthentication(InlineFillUi.InlineFillUiInfo inlineFillUiInfo, FillResponse fillResponse, final InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
        ...
        return createInlineSuggestion(inlineFillUiInfo, "android:autofill", "android:autofill:action", new Runnable() { // from class: com.android.server.autofill.ui.InlineSuggestionFactory$$ExternalSyntheticLambda2
            ...
            public final void run() {
                InlineFillUi.InlineSuggestionUiCallback.this.authenticate(requestId, BluetoothStatsLog.BLUETOOTH_DEVICE_INFO_REPORTED__ADDRESS_TYPE__ADDRESS_TYPE_UNKNOWN);
            }
    ...
    public static SparseArray<Pair<Dataset, InlineSuggestion>> createInlineSuggestions(InlineFillUi.InlineFillUiInfo inlineFillUiInfo, String str, List<Dataset> list, final InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
        ...
        if (Helper.sDebug) {
            Slog.d(TAG, "createInlineSuggestions(source=" + str + ") called");
        }
    ...
    private static InlineSuggestion createInlineSuggestion(InlineFillUi.InlineFillUiInfo inlineFillUiInfo, String str, String str2, Runnable runnable, InlinePresentation inlinePresentation, InlineSuggestion inlineSuggestion, InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    ...
    private static InlineSuggestion createInlineSuggestionTooltip(InlineSuggestionsRequest inlineSuggestionsRequest, InlineFillUi.InlineFillUiInfo inlineFillUiInfo, String str, InlinePresentation inlinePresentation) {
    ...
    private static IInlineContentProvider createInlineContentProvider(InlineFillUi.InlineFillUiInfo inlineFillUiInfo, InlinePresentation inlinePresentation, Runnable runnable, InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {

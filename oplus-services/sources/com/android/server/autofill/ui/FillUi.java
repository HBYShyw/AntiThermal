...
public final class FillUi {
    ...
    private static final int THEME_ID_DARK = 16974807;
    private static final int THEME_ID_LIGHT = 16974819;
    ...
    private final AutofillWindowPresenter mWindowPresenter;
    ...
    public FillUi(Context context, final FillResponse fillResponse, AutofillId autofillId, String str, OverlayControl overlayControl, CharSequence charSequence, Drawable drawable, boolean z, Callback callback) {
        ...
        if (isFullScreen) {
            viewGroup = (ViewGroup) from.inflate(R.layout.breadcrumbs_in_fragment_material, (ViewGroup) null);
        } else if (sanitizeRemoteView != null || sanitizeRemoteView2 != null) {
            viewGroup = (ViewGroup) from.inflate(R.layout.calendar_view, (ViewGroup) null);
        } else {
            viewGroup = (ViewGroup) from.inflate(R.layout.breadcrumbs_in_fragment, (ViewGroup) null);
        }
        viewGroup.setClipToOutline(true);
        TextView textView = (TextView) viewGroup.findViewById(R.id.button5);
        if (textView != null) {
            textView.setText(contextThemeWrapper.getString(R.string.biometric_error_user_canceled, charSequence));
        }
        ImageView imageView = (ImageView) viewGroup.findViewById(R.id.butt);
        if (imageView != null) {
        ...
        if (AutofillManagerService.getVisibleDatasetsMaxCount() > 0) {
            ...
            this.mVisibleDatasetsMaxCount = contextThemeWrapper.getResources().getInteger(R.integer.button_pressed_animation_duration);
        }
        RemoteViews.InteractionHandler interactionHandler2 = new RemoteViews.InteractionHandler() { // from class: com.android.server.autofill.ui.FillUi$$ExternalSyntheticLambda3
        ...
        if (fillResponse.getAuthentication() != null) {
            ...
            this.mFooter = null;
            this.mAdapter = null;
            ViewGroup viewGroup3 = (ViewGroup) viewGroup.findViewById(R.id.button4);
            try {
                ...
                viewGroup3.setOnClickListener(new View.OnClickListener() { // from class: com.android.server.autofill.ui.FillUi$$ExternalSyntheticLambda4
        ...
        if (sanitizeRemoteView != null) {
            ...
            View applyWithTheme2 = sanitizeRemoteView.applyWithTheme(contextThemeWrapper, null, interactionHandler, i2);
            this.mHeader = applyWithTheme2;
            LinearLayout linearLayout = (LinearLayout) viewGroup.findViewById(R.id.bundle_array);
        ...
        if (sanitizeRemoteView2 != null) {
            LinearLayout linearLayout2 = (LinearLayout) viewGroup.findViewById(R.id.bundle);
            if (linearLayout2 != null) {
                View applyWithTheme3 = sanitizeRemoteView2.applyWithTheme(contextThemeWrapper, viewGroup2, interactionHandler == null ? newInteractionBlocker() : interactionHandler, i2);
            ...
            if (indexOf >= 0) {
                ...
                if (sanitizeRemoteView3 == null) {
                    ...
                    try {
                        ...
                        i = size;
                        try {
                            View applyWithTheme4 = sanitizeRemoteView3.applyWithTheme(this.mContext, null, interactionHandler2, this.mThemeId);
        ...
        ListView listView = (ListView) viewGroup.findViewById(R.id.button0);
    ...
    public final class AnchoredWindow {
        ...
        public void show(WindowManager.LayoutParams layoutParams) {
            ...
            try {
                ...
                if (!this.mShowing) {
                    layoutParams.accessibilityTitle = this.mContentView.getContext().getString(R.string.autofill_save_type_payment_card);
                ...
                Slog.wtf(FillUi.TAG, "Exception showing window " + layoutParams, e);
                FillUi.this.mCallback.onDestroy();
            }
        }
            ...
            protected Filter.FilterResults performFiltering(final CharSequence charSequence) {
                List list = (List) ItemsAdapter.this.mAllItems.stream().filter(new Predicate() { // from class: com.android.server.autofill.ui.FillUi$ItemsAdapter$1$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        ...
                        lambda$performFiltering$0 = FillUi.ItemsAdapter.AnonymousClass1.lambda$performFiltering$0(charSequence, (FillUi.ViewItem) obj);
    ...
    public final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                format = FillUi.this.mContext.getString(R.string.autofill_save_type_username);
            } else {
                HashMap hashMap = new HashMap();
                hashMap.put(AssistDataRequester.KEY_RECEIVER_EXTRA_COUNT, Integer.valueOf(count));
                format = PluralsMessageFormatter.format(FillUi.this.mContext.getResources(), hashMap, R.string.autofill_save_yes);
            }

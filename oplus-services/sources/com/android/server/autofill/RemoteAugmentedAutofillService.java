...
public final class RemoteAugmentedAutofillService extends ServiceConnector.Impl<IAugmentedAutofillService> {
    ...
    public RemoteAugmentedAutofillService(Context context, int i, ComponentName componentName, int i2, RemoteAugmentedAutofillServiceCallbacks remoteAugmentedAutofillServiceCallbacks, boolean z, boolean z2, int i3, int i4) {
        super(context, new Intent("android.service.autofill.augmented.AugmentedAutofillService").setComponent(componentName), z ? AudioDevice.OUT_SPEAKER_SAFE : 0, i2, new Function() { // from class: com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda2
    ...
    void dispatchCancellation(final ICancellationSignal iCancellationSignal) {

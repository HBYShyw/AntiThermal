...
public final class AutofillUriGrantsManager {
    private static final String TAG = "AutofillUriGrantsManager";
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e;
                    Slog.e(TAG, "Granting URI permissions failed: uri=" + uri + str5 + this.mSourceUid + str2 + userIdFromUri + str3 + str + ", targetUserId=" + i + str4 + Integer.toHexString(iBinder.hashCode()), e);
                }
            } finally {

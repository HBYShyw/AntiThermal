...
public class SystemConfigService extends SystemService {
    ...
    class AnonymousClass1 extends ISystemConfig.Stub {
        ...
        public Map getDisabledUntilUsedPreinstalledCarrierAssociatedApps() {
            ...
            return (Map) SystemConfig.getInstance().getDisabledUntilUsedPreinstalledCarrierAssociatedApps().entrySet().stream().collect(Collectors.toMap(new Function() { // from class: com.android.server.SystemConfigService$1$$ExternalSyntheticLambda1
                ...
                public final Object apply(Object obj) {
                    ...
                    lambda$getDisabledUntilUsedPreinstalledCarrierAssociatedApps$1 = SystemConfigService.AnonymousClass1.lambda$getDisabledUntilUsedPreinstalledCarrierAssociatedApps$1((Map.Entry) obj);
        ...
        public static /* synthetic */ List lambda$getDisabledUntilUsedPreinstalledCarrierAssociatedApps$1(Map.Entry entry) {
            return (List) ((List) entry.getValue()).stream().map(new Function() { // from class: com.android.server.SystemConfigService$1$$ExternalSyntheticLambda0
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    String str;

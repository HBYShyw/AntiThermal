...
public class TextServicesManagerService extends ITextServicesManager.Stub {
    ...
    public TextServicesManagerService(Context context) {
        ...
        textServicesMonitor.getWrapper().getExtImpl().register(context, (Looper) null, UserHandle.ALL, true, new int[]{19});
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public SpellCheckerInfo findAvailSystemSpellCheckerLocked(String str, TextServicesData textServicesData) {
    ...
    private boolean canCallerAccessSpellChecker(SpellCheckerInfo spellCheckerInfo, int i, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCurrentSpellCheckerLocked(SpellCheckerInfo spellCheckerInfo, TextServicesData textServicesData) {
        if (spellCheckerInfo != null) {
    ...
    public static final class SessionRequest {
        ...
        SessionRequest(int i, String str, ITextServicesSessionListener iTextServicesSessionListener, ISpellCheckerSessionListener iSpellCheckerSessionListener, Bundle bundle, int i2) {
            this.mUid = i;
            this.mLocale = str;

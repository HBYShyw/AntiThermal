...
public final class TvInputManagerService extends SystemService {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public SessionState getSessionStateLocked(IBinder iBinder, int i, UserState userState) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public boolean createSessionInternalLocked(ITvInputService iTvInputService, IBinder iBinder, int i) {
        boolean z;
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public void updateTvInputInfoLocked(UserState userState, TvInputInfo tvInputInfo) {
        String id = tvInputInfo.getId();
    ...
    private final class BinderService extends ITvInputManager.Stub {
        ...
        */
        ...
        public void addHardwareDevice(int i) {
            TvInputManagerService.this.mTvInputHardwareManager.onDeviceAvailable(new TvInputHardwareInfo.Builder().deviceId(i).type(9).audioType(0).audioAddress("0").hdmiPortId(0).build(), new TvStreamConfig[]{new TvStreamConfig.Builder().streamId(19001).generation(1).maxHeight(PhoneWindowManager.TOAST_WINDOW_ANIM_BUFFER).maxWidth(IInputExt.KEY_OFFSET_VALUE).type(1).build()});
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public List<TunedInfo> getCurrentTunedInfosInternalLocked(UserState userState, int i, int i2) {
        Integer num;
        int i3;
        ArrayList arrayList = new ArrayList();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void logTuneStateChanged(int i, SessionState sessionState, TvInputState tvInputState) {
        int i2;
        int i3;
        int i4;
        int i5;

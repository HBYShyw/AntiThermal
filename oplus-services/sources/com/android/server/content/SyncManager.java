...
public class SyncManager {
    ...
    ISyncManagerExt mSyncManagerExt = (ISyncManagerExt) ExtLoader.type(ISyncManagerExt.class).base(this).create();
    private final String[] mEjSyncAllowedPackages = {"com.google.android.google", "com.android.frameworks.servicestests"};
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void updateRunningAccounts(SyncStorageEngine.EndPoint endPoint) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearAllBackoffs(String str) {
    ...
    public SyncManager(Context context, boolean z) {
        ...
        if (!this.mProvisioned) {
            ...
            ContentObserver contentObserver = new ContentObserver(handler) { // from class: com.android.server.content.SyncManager.11
    ...
    public void onBootPhase(int i) {
        this.mSyncManagerExt.onBootPhase(i);
        if (i != 550) {
            return;
        }
    ...
    protected boolean isContactSharingAllowedForCloneProfile() {
        return this.mContext.getResources().getBoolean(17891653) && this.mAppCloningDeviceConfigHelper.getEnableAppCloningBuildingBlocks();
    }

    @VisibleForTesting
    protected boolean shouldDisableSyncForUser(UserInfo userInfo, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setAuthorityPendingState(SyncStorageEngine.EndPoint endPoint) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x029f, code lost:
        ...
        if (r14.mSyncStorageEngine.getSyncAutomatically(r15.account, r15.userId, r9) != false) goto L100;
     */
    ...
    */
    private void scheduleSync(Account account, final int i, final int i2, String str, Bundle bundle, final int i3, final long j, boolean z, final int i4, final int i5, final int i6, final String str2) {
        int i7;
        Bundle bundle2;
        char c;
        boolean z2;
            ...
            if (i8 < 0 || (i10 = accountAndUser3.userId) < 0 || i8 == i10) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (computeSyncable != 0) {
                        RegisteredServicesCache.ServiceInfo serviceInfo = syncManager2.mSyncAdapters.getServiceInfo(SyncAdapterType.newKey(str5, accountAndUser3.account.type), accountAndUser3.userId);
                        if (serviceInfo != null) {
                            ...
                            if (computeSyncable == i11) {
                                ...
                                if (syncManager2.wasPackageEverLaunched(packageName, i8)) {
                                    ...
                                    syncManager2.mAccountManagerInternal.requestAccountAccess(accountAndUser3.account, packageName, i, new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda8
                                ...
                                if ((i3 == -2 || i3 == computeSyncable) && (((SyncAdapterType) serviceInfo.type).supportsUploading() || !z4)) {
                                    if (computeSyncable < 0 || z6) {
                                        ...
                                        if (z3) {
                                            ...
                                            if (computeSyncable != -1) {
                                                ...
                                                bundle3 = bundle7;
                                                c2 = 65535;
                                                sendOnUnsyncableAccount(syncManager.mContext, serviceInfo, accountAndUser.userId, new OnReadyCallback() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda9
    ...
    private boolean canAccessAccount(Account account, String str, int i) {
        ...
        try {
            this.mContext.getPackageManager().getApplicationInfoAsUser(str, AudioDevice.OUT_FM, UserHandle.getUserId(i));
            return true;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeSyncsForAuthority(SyncStorageEngine.EndPoint endPoint, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postScheduleSyncMessage(SyncOperation syncOperation, long j) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearBackoffSetting(SyncStorageEngine.EndPoint endPoint, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void increaseBackoffSetting(SyncStorageEngine.EndPoint endPoint) {
        long j;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setDelayUntilTime(SyncStorageEngine.EndPoint endPoint, long j) {
        long j2 = j * 1000;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean isAdapterDelayed(SyncStorageEngine.EndPoint endPoint) {
        long elapsedRealtime = SystemClock.elapsedRealtime();
        Pair<Long, Long> backoff = this.mSyncStorageEngine.getBackoff(endPoint);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void scheduleSyncOperationH(SyncOperation syncOperation, long j) {
        long j2;
        long j3;
        boolean z;
        ...
        if (syncOperation.isPeriodic) {
            ...
            if (syncOperation != syncOperation2 && j3 == 0) {
                int i4 = syncOperation2.syncExemptionFlag;
                int i5 = syncOperation.syncExemptionFlag;
                if (i4 < i5) {
    ...
    static Intent getAdapterBindIntent(Context context, ComponentName componentName, int i) {
        ...
        intent.putExtra("android.intent.extra.client_label", 17041727);
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, boolean z) {
        this.mSyncManagerExt.dump(fileDescriptor, printWriter, z);
    ...
    protected void dumpPendingSyncs(PrintWriter printWriter, SyncAdapterStateFetcher syncAdapterStateFetcher) {
        ...
        printWriter.println(countIf(allPendingSyncs, new Predicate() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda3
    ...
    protected void dumpPeriodicSyncs(PrintWriter printWriter, SyncAdapterStateFetcher syncAdapterStateFetcher) {
        ...
        printWriter.println(countIf(allPendingSyncs, new Predicate() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda12
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean z;
        ...
        while (i2 < length) {
            ...
            while (it2.hasNext()) {
                ...
                if (((SyncAdapterType) serviceInfo.type).accountType.equals(accountAndUser.account.type)) {
                    ...
                    QuadConsumer quadConsumer = new QuadConsumer() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda4
                    ...
                    int i3 = length;
                    quadConsumer.accept("Total", syncStatusInfo.totalStats, new Function() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda5
                    ...
                    quadConsumer.accept("Today", syncStatusInfo.todayStats, new Function() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda6
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                            String zeroToEmpty;
                    ...
                    quadConsumer.accept("Yestr", syncStatusInfo.yesterdayStats, new Function() { // from class: com.android.server.content.SyncManager$$ExternalSyntheticLambda6
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                            String zeroToEmpty;
                            zeroToEmpty = SyncManager.this.zeroToEmpty(((Integer) obj).intValue());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public String zeroToEmpty(int i) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x036c, code lost:
        ...
        if (r9.downstreamActivity != 0) goto L61;
     */
    ...
    */
    private void dumpRecentHistory(PrintWriter printWriter) {
        ...
        if (j > 0) {
            ...
            while (it3.hasNext()) {
                ...
                printWriter.printf(format2, str15, String.format("%d/%d%%", Integer.valueOf(authoritySyncStats2.times), Long.valueOf((r4 * 100) / j2)), String.format("%ds/%d%%", Long.valueOf(j5 / 1000), Long.valueOf((j5 * 100) / j)));
                ...
                while (it5.hasNext()) {
                    ...
                    int i7 = accountSyncStats2.times;
                    Iterator it6 = it5;
                    printWriter.printf(str19, accountSyncStats2.name, String.format("%d/%d%%", Integer.valueOf(i7), Long.valueOf((i7 * 100) / j2)), String.format(str18, Long.valueOf(j6 / 1000), Long.valueOf((j6 * 100) / j)));
                    format2 = str20;
                    str18 = str18;
                    it5 = it6;
                }
        ...
        while (i10 < i9) {
            ...
            SyncStorageEngine.SyncHistoryItem syncHistoryItem = arrayList5.get(i10);
            ...
            if (l == null) {
                ...
                if (longValue < 60) {
                    ...
                    if (longValue < 3600) {
                        ...
                        String format4 = String.format("%02d:%02d", Long.valueOf(longValue / 60), Long.valueOf(longValue % 60));
                        i = i9;
                        format = format4;
                    } else {
                        arrayList2 = arrayList5;
                    ...
                    i10++;
                    printWriter.printf("  #%-3d: %s %8s  %5.1fs  %8s", Integer.valueOf(i10), formatTime(j8), SyncStorageEngine.SOURCES[syncHistoryItem.source], Float.valueOf(((float) j7) / 1000.0f), format);
                    ...
                    if (str10 != null && !SyncStorageEngine.MESG_SUCCESS.equals(str10)) {
        ...
        while (i12 < i11) {
            ...
            SyncStorageEngine.SyncHistoryItem syncHistoryItem2 = arrayList6.get(i12);
            ...
            if (bundle == null || bundle.size() == 0) {
                ...
                printWriter.printf("  #%-3d: %s %8s ", Integer.valueOf(i12 + 1), formatTime(syncHistoryItem2.eventTime), SyncStorageEngine.SOURCES[syncHistoryItem2.source]);
    ...
    public class SyncHandler extends Handler {
        ...
        public PowerManager.WakeLock getSyncWakeLock(SyncOperation syncOperation) {
            ...
            PowerManager.WakeLock newWakeLock = SyncManager.this.mPowerManager.newWakeLock(1, SyncManager.SYNC_WAKE_LOCK_PREFIX + wakeLockName);
        ...
        private void startSyncH(SyncOperation syncOperation) {
            ...
            if (syncOperation.isPeriodic) {
                ...
                while (it.hasNext()) {
                    int i = ((SyncOperation) it.next()).sourcePeriodicId;
                ...
                while (it2.hasNext()) {
                    int i3 = it2.next().mSyncOperation.sourcePeriodicId;
        ...
        private int computeSyncOpState(SyncOperation syncOperation) {
            ...
            synchronized (SyncManager.this.mAccountsLock) {
                ...
                if (!SyncManager.this.mSyncManagerExt.isSyncValid(syncOperation.owningUid, syncOperation.owningPackage)) {
                    return 4;
                }
        ...
        private boolean dispatchSyncOperation(SyncOperation syncOperation) {
            ...
            if (SyncManager.this.mSyncManagerExt.interceptDispatchSyncOperation(i, syncOperation, componentName)) {
                return false;
            }
        ...
        private void installHandleTooManyDeletesNotification(Account account, String str, long j, int i) {
            ...
            PendingIntent activityAsUser = PendingIntent.getActivityAsUser(SyncManager.this.mContext, 0, intent, AudioFormat.AAC_ADIF, null, userHandle);
            CharSequence text = SyncManager.this.mContext.getResources().getText(R.string.expand_button_content_description_collapsed);
            Context contextForUser = SyncManager.this.getContextForUser(userHandle);
            Notification build = new Notification.Builder(contextForUser, SystemNotificationChannels.ACCOUNT).setSmallIcon(R.drawable.sym_keyboard_num3).setTicker(SyncManager.this.mContext.getString(R.string.eventTypeOther)).setWhen(System.currentTimeMillis()).setColor(contextForUser.getColor(R.color.system_notification_accent_color)).setContentTitle(contextForUser.getString(R.string.expand_action_accessibility)).setContentText(String.format(text.toString(), loadLabel)).setContentIntent(activityAsUser).build();
            build.flags |= 2;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void cancelJob(SyncOperation syncOperation, String str) {
        if (syncOperation == null) {

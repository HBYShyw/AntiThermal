...
public final class IconsContentProvider extends ContentProvider {
    ...
    private final ContentProvider.PipeDataWriter<Pair<IconsUriHelper.ResourceInfo, Integer>> mWriter = new ContentProvider.PipeDataWriter() { // from class: com.android.server.textclassifier.IconsContentProvider$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$new$0(ParcelFileDescriptor parcelFileDescriptor, Uri uri, String str, Bundle bundle, Pair pair) {
        try {
            ...
            try {
                ...
                getBitmap(Icon.createWithResource(resourceInfo.packageName, resourceInfo.id).loadDrawableAsUser(getContext(), ((Integer) pair.second).intValue())).compress(Bitmap.CompressFormat.PNG, 100, autoCloseOutputStream);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        try {
            return openPipeHelper(uri, MIME_TYPE, null, new Pair(resourceInfo, Integer.valueOf(UserHandle.getCallingUserId())), this.mWriter);
        } catch (IOException e) {

...
public class AppMetadataBackupWriter {
    ...
    private byte[] getManifestBytes(PackageInfo packageInfo, boolean z) {
    ...
    private void writeWidgetData(DataOutputStream dataOutputStream, byte[] bArr) throws IOException {
        dataOutputStream.writeInt(UserBackupManagerService.BACKUP_WIDGET_METADATA_TOKEN);

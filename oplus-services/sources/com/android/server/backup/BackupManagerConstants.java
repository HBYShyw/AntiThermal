...
public class BackupManagerConstants extends KeyValueSettingObserver {
    ...
    public String getSettingValue(ContentResolver contentResolver) {
        return Settings.Secure.getStringForUser(contentResolver, SETTING, contentResolver.getUserId());
    }
    ...
    public synchronized void update(KeyValueListParser keyValueListParser) {
        ...
        this.mKeyValueBackupFuzzMilliseconds = keyValueListParser.getLong(KEY_VALUE_BACKUP_FUZZ_MILLISECONDS, DEFAULT_KEY_VALUE_BACKUP_FUZZ_MILLISECONDS);

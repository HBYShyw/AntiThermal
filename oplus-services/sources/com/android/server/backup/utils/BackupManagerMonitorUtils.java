...
public class BackupManagerMonitorUtils {
    ...
    public static IBackupManagerMonitor monitorAgentLoggingResults(IBackupManagerMonitor iBackupManagerMonitor, PackageInfo packageInfo, IBackupAgent iBackupAgent) {
        ...
        try {
            ...
            return sendAgentLoggingResults(iBackupManagerMonitor, packageInfo, (List) androidFuture.get(500L, timeUnit), ((Integer) androidFuture2.get(500L, timeUnit)).intValue());
    ...
    public static IBackupManagerMonitor sendAgentLoggingResults(IBackupManagerMonitor iBackupManagerMonitor, PackageInfo packageInfo, List<BackupRestoreEventLogger.DataTypeResult> list, int i) {

...
public final class JobSchedulerShellCommand extends BasicShellCommandHandler {
    ...
    private boolean printError(int i, String str, int i2, String str2, int i3) {
        switch (i) {
    ...
    */
    ...
    private int getEstimatedNetworkBytes(PrintWriter printWriter, int i) throws Exception {
        char c;
    ...
    private int getTransferredNetworkBytes(PrintWriter printWriter, int i) throws Exception {
        char c;
    ...
    private int resetExecutionQuota(PrintWriter printWriter) throws Exception {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int stop(PrintWriter printWriter) throws Exception {

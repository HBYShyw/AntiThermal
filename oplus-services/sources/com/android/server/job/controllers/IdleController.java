...
public final class IdleController extends RestrictingController implements IdlenessListener {
    ...
    public IIdleControllerExt mIdleControllerExt;
    ...
    public IdleController(JobSchedulerService jobSchedulerService, FlexibilityController flexibilityController) {
        ...
        IIdleControllerExt iIdleControllerExt = (IIdleControllerExt) ExtLoader.type(IIdleControllerExt.class).base(this).create();
        this.mIdleControllerExt = iIdleControllerExt;
        iIdleControllerExt.initFastIdle(jobSchedulerService);
    ...
    public void maybeStartTrackingJobLocked(JobStatus jobStatus, JobStatus jobStatus2) {
        if (jobStatus.hasIdleConstraint()) {
            ...
            this.mIdleControllerExt.addTasks(jobStatus);
    ...
    public void maybeStopTrackingJobLocked(JobStatus jobStatus, JobStatus jobStatus2) {
        if (jobStatus.clearTrackingController(8)) {
            ...
            this.mIdleControllerExt.removeTasks(jobStatus);
        }
    }

...
public final class GrantedUriPermissions {
    ...
    private GrantedUriPermissions(int i, int i2, String str) throws RemoteException {
        this.mGrantFlags = i;
    ...
    private static GrantedUriPermissions grantClip(ClipData clipData, int i, String str, int i2, int i3, String str2, GrantedUriPermissions grantedUriPermissions) {
    ...
    private static GrantedUriPermissions grantUri(Uri uri, int i, String str, int i2, int i3, String str2, GrantedUriPermissions grantedUriPermissions) {
        try {
    ...
    private static GrantedUriPermissions grantItem(ClipData.Item item, int i, String str, int i2, int i3, String str2, GrantedUriPermissions grantedUriPermissions) {
        if (item.getUri() != null) {

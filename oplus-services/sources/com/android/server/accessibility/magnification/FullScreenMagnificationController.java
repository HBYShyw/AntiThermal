...
public class FullScreenMagnificationController implements WindowManagerInternal.AccessibilityControllerInternal.UiChangesForAccessibilityCallbacks {
    ...
    @GuardedBy({"mLock"})
    private final ArrayList<MagnificationInfoChangedCallback> mMagnificationInfoChangedCallbacks;
    ...
    public final class DisplayMagnification implements WindowManagerInternal.MagnificationCallbacks {
        ...
        void unregister(boolean z) {
            if (this.mRegistered) {
                ...
                FullScreenMagnificationController.this.mControllerCtx.getWindowManager().setMagnificationCallbacks(this.mDisplayId, (WindowManagerInternal.MagnificationCallbacks) null);
        ...
        public void onMagnificationRegionChanged(Region region) {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda7
        ...
        public void onRectangleOnScreenRequested(int i, int i2, int i3, int i4) {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new QuintConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda2
        ...
        public void onUserContextChanged() {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda5
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
        ...
        public void onImeWindowVisibilityChanged(boolean z) {
            FullScreenMagnificationController.this.mControllerCtx.getHandler().sendMessage(PooledLambda.obtainMessage(new TriConsumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda4
        ...
        void onMagnificationChangedLocked() {
            ...
            final MagnificationConfig build = new MagnificationConfig.Builder().setMode(1).setActivated(this.mMagnificationActivated).setScale(scale).setCenterX(centerX).setCenterY(centerY).build();
            FullScreenMagnificationController.this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    FullScreenMagnificationController.DisplayMagnification.this.lambda$onMagnificationChangedLocked$0(build, (FullScreenMagnificationController.MagnificationInfoChangedCallback) obj);
                }
            });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onMagnificationChangedLocked$0(MagnificationConfig magnificationConfig, MagnificationInfoChangedCallback magnificationInfoChangedCallback) {
        ...
        private boolean setActivated(boolean z) {
            ...
            if (z2) {
                ...
                FullScreenMagnificationController.this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda6
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        FullScreenMagnificationController.DisplayMagnification.this.lambda$setActivated$1((FullScreenMagnificationController.MagnificationInfoChangedCallback) obj);
                    }
                });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$setActivated$1(MagnificationInfoChangedCallback magnificationInfoChangedCallback) {
        ...
        boolean setScale(float f, float f2, float f3, boolean z, int i) {
            ...
            return setScaleAndCenter(constrainScale, f6 + ((width - f6) * f8), f7 + f9, FullScreenMagnificationController.transformToStubCallback(z), i);
        }
        ...
        boolean setScaleAndCenter(float f, float f2, float f3, MagnificationAnimationCallback magnificationAnimationCallback, int i) {
            ...
            if (isActivated() && i != -1) {
                this.mIdOfLastServiceToMagnify = i;
                FullScreenMagnificationController.this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$DisplayMagnification$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        FullScreenMagnificationController.DisplayMagnification.this.lambda$setScaleAndCenter$2((FullScreenMagnificationController.MagnificationInfoChangedCallback) obj);
                    }
                });
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$setScaleAndCenter$2(MagnificationInfoChangedCallback magnificationInfoChangedCallback) {
        ...
        @GuardedBy({"mLock"})
        void refreshThumbnail(float f, float f2, float f3) {
            MagnificationThumbnail magnificationThumbnail = this.mMagnificationThumbnail;
            if (magnificationThumbnail != null) {
    ...
    public FullScreenMagnificationController(Context context, AccessibilityTraceManager accessibilityTraceManager, Object obj, MagnificationInfoChangedCallback magnificationInfoChangedCallback, MagnificationScaleProvider magnificationScaleProvider, Executor executor) {
        this(new ControllerContext(context, accessibilityTraceManager, (WindowManagerInternal) LocalServices.getService(WindowManagerInternal.class), new Handler(context.getMainLooper()), context.getResources().getInteger(R.integer.config_longAnimTime)), obj, magnificationInfoChangedCallback, magnificationScaleProvider, (Supplier<MagnificationThumbnail>) null, executor);
    }

    @VisibleForTesting
    public FullScreenMagnificationController(final ControllerContext controllerContext, Object obj, MagnificationInfoChangedCallback magnificationInfoChangedCallback, MagnificationScaleProvider magnificationScaleProvider, Supplier<MagnificationThumbnail> supplier, Executor executor) {
        ...
        magnificationThumbnailFeatureFlag.addOnChangedListener(executor, new Runnable() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda2
        ...
        if (supplier != null) {
            ...
            this.mThumbnailSupplier = new Supplier() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ MagnificationThumbnail lambda$new$0(ControllerContext controllerContext) {
        if (this.mMagnificationThumbnailFeatureFlag.isFeatureFlagEnabled()) {
            return new MagnificationThumbnail(controllerContext.getContext(), (WindowManager) controllerContext.getContext().getSystemService(WindowManager.class), new Handler(controllerContext.getContext().getMainLooper()));
        }
        return null;
    }
    ...
    public void notifyImeWindowVisibilityChanged(final int i, final boolean z) {
        synchronized (this.mLock) {
            this.mMagnificationInfoChangedCallbacks.forEach(new Consumer() { // from class: com.android.server.accessibility.magnification.FullScreenMagnificationController$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    ((FullScreenMagnificationController.MagnificationInfoChangedCallback) obj).onImeWindowVisibilityChanged(i, z);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addInfoChangedCallback(MagnificationInfoChangedCallback magnificationInfoChangedCallback) {
        synchronized (this.mLock) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void removeInfoChangedCallback(MagnificationInfoChangedCallback magnificationInfoChangedCallback) {
        synchronized (this.mLock) {

...
public class MagnificationController implements WindowMagnificationManager.Callback, MagnificationGestureHandler.Callback, FullScreenMagnificationController.MagnificationInfoChangedCallback, WindowManagerInternal.AccessibilityControllerInternal.UiChangesForAccessibilityCallbacks {
    ...
    public MagnificationController(final AccessibilityManagerService accessibilityManagerService, Object obj, Context context, MagnificationScaleProvider magnificationScaleProvider, Executor executor) {
        ...
        AlwaysOnMagnificationFeatureFlag alwaysOnMagnificationFeatureFlag = new AlwaysOnMagnificationFeatureFlag(context);
    ...
    public void transitionMagnificationConfigMode(final int i, MagnificationConfig magnificationConfig, boolean z, int i2) {
        float scale;
        float centerX;
        float centerY;
        synchronized (this.mLock) {
            ...
            try {
                ...
                MagnificationAnimationCallback magnificationAnimationCallback = z ? new MagnificationAnimationCallback() { // from class: com.android.server.accessibility.magnification.MagnificationController$$ExternalSyntheticLambda1
                    public final void onResult(boolean z2) {
                        MagnificationController.this.lambda$transitionMagnificationConfigMode$0(i, mode, z2);
                    }
                } : null;
                if (mode == 2) {
                    fullScreenMagnificationController.reset(i, false);
                    if (isActivated) {
                        windowMagnificationMgr.enableWindowMagnification(i, scale, pointF.x, pointF.y, magnificationAnimationCallback, i2);
                    } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setTransitionState(Integer num, Integer num2) {
        synchronized (this.mLock) {

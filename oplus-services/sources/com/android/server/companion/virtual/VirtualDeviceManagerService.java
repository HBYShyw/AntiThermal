...
public class VirtualDeviceManagerService extends SystemService {
    ...
    public void onCameraAccessBlocked(int i) {
        ...
        for (int i2 = 0; i2 < virtualDevicesSnapshot.size(); i2++) {
            ...
            virtualDeviceImpl.showToastWhereUidIsRunning(i, getContext().getString(17041814, virtualDeviceImpl.getDisplayName()), 1, Looper.myLooper());
        }
    }
    ...
    public void syncVirtualDevicesToCdmAssociations(List<AssociationInfo> list) {
        ...
        synchronized (this.mVirtualDeviceManagerLock) {
            ...
            for (int i = 0; i < this.mVirtualDevices.size(); i++) {
                ...
                if (!hashSet2.contains(Integer.valueOf(valueAt.getAssociationId()))) {
                    hashSet.add(valueAt);
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public ArrayList<VirtualDeviceImpl> getVirtualDevicesSnapshot() {
    ...
    private final class LocalService extends VirtualDeviceManagerInternal {
        ...
        @GuardedBy({"mVirtualDeviceManagerLock"})
        private final ArraySet<Integer> mAllUidsOnVirtualDevice;

        @GuardedBy({"mVirtualDeviceManagerLock"})
        private final ArrayList<VirtualDeviceManagerInternal.AppsOnVirtualDeviceListener> mAppsOnVirtualDeviceListeners;

        @GuardedBy({"mVirtualDeviceManagerLock"})
        private final ArrayList<VirtualDeviceManagerInternal.VirtualDisplayListener> mVirtualDisplayListeners;
        ...
        public void onAuthenticationPrompt(int i) {
            synchronized (VirtualDeviceManagerService.this.mVirtualDeviceManagerLock) {
                for (int i2 = 0; i2 < VirtualDeviceManagerService.this.mVirtualDevices.size(); i2++) {
                    ((VirtualDeviceImpl) VirtualDeviceManagerService.this.mVirtualDevices.valueAt(i2)).showToastWhereUidIsRunning(i, R.string.autofill_name_on_card_re, 1, Looper.getMainLooper());
                }
            }
        }
        ...
        @Override // com.android.server.companion.virtual.VirtualDeviceManagerInternal
        public void unregisterVirtualDisplayListener(VirtualDeviceManagerInternal.VirtualDisplayListener virtualDisplayListener) {
            synchronized (VirtualDeviceManagerService.this.mVirtualDeviceManagerLock) {
                this.mVirtualDisplayListeners.remove(virtualDisplayListener);
            }
        }
        ...
        @Override // com.android.server.companion.virtual.VirtualDeviceManagerInternal
        public void unregisterAppsOnVirtualDeviceListener(VirtualDeviceManagerInternal.AppsOnVirtualDeviceListener appsOnVirtualDeviceListener) {
            synchronized (VirtualDeviceManagerService.this.mVirtualDeviceManagerLock) {

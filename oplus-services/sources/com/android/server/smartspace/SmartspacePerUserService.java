...
public class SmartspacePerUserService extends AbstractPerUserSystemService<SmartspacePerUserService, SmartspaceManagerService> implements RemoteSmartspaceService.RemoteSmartspaceServiceCallbacks {
    ...
    @GuardedBy({"mLock"})
    protected boolean resolveService(SmartspaceSessionId smartspaceSessionId, AbstractRemoteService.AsyncRequest<ISmartspaceService> asyncRequest) {
        RemoteSmartspaceService remoteServiceLocked = getRemoteServiceLocked();
        if (remoteServiceLocked != null) {
    ...
    public static final class SmartspaceSessionInfo {
        ...
        SmartspaceSessionInfo(SmartspaceSessionId smartspaceSessionId, SmartspaceConfig smartspaceConfig, IBinder iBinder, IBinder.DeathRecipient deathRecipient) {
        ...
        void resurrectSessionLocked(final SmartspacePerUserService smartspacePerUserService, IBinder iBinder) {

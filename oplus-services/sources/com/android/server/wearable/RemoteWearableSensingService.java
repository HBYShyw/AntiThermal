...
import com.android.server.ambientcontext.RemoteWearableSensingService$;
...
final class RemoteWearableSensingService extends ServiceConnector.Impl<IWearableSensingService> {
    ...
    public RemoteWearableSensingService(Context context, ComponentName componentName, int i) {
        super(context, new Intent("android.service.wearable.WearableSensingService").setComponent(componentName), 67112960, i, new RemoteWearableSensingService$.ExternalSyntheticLambda3());
        connect();
    }

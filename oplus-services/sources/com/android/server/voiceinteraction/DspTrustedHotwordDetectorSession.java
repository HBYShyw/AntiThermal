...
public final class DspTrustedHotwordDetectorSession extends DetectorSession {
    ...
    @GuardedBy({"mLock"})
    private HotwordRejectedResult mLastHotwordRejectedResult;
    ...
    public void detectFromDspSourceLocked(final SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEvent, final IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback) {
        ...
        final IDspHotwordDetectionCallback.Stub stub = new IDspHotwordDetectionCallback.Stub() { // from class: com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession.1
            public void onDetected(HotwordDetectedResult hotwordDetectedResult) throws RemoteException {
                synchronized (DspTrustedHotwordDetectorSession.this.mLock) {
                    ...
                    if (!DspTrustedHotwordDetectorSession.this.mValidatingDspTrigger) {
                        Slog.i(DspTrustedHotwordDetectorSession.TAG, "Ignoring #onDetected due to a process restart or previous #onRejected result = " + DspTrustedHotwordDetectorSession.this.mLastHotwordRejectedResult);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Slog.i(DspTrustedHotwordDetectorSession.TAG, "Egressed " + HotwordDetectedResult.getUsageSize(startCopyingAudioStreams) + " bits from hotword trusted process");
                                if (DspTrustedHotwordDetectorSession.this.mDebugHotwordLogging) {
                                    Slog.i(DspTrustedHotwordDetectorSession.TAG, "Egressed detected result: " + startCopyingAudioStreams);
                                }
                            ...
                            try {
                                Slog.w(DspTrustedHotwordDetectorSession.TAG, "Ignoring #onDetected due to a IOException", e2);
                                iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(new HotwordDetectionServiceFailure(6, "Copy audio stream failure."));
                        ...
                        Slog.w(DspTrustedHotwordDetectorSession.TAG, "Ignoring #onDetected due to a SecurityException", e4);
                        HotwordMetricsLogger.writeKeyphraseTriggerEvent(1, 8, DspTrustedHotwordDetectorSession.this.mVoiceInteractionServiceUid);
                        try {
                            iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(new HotwordDetectionServiceFailure(5, "Security exception occurs in #onDetected method."));
            ...
            public void onRejected(HotwordRejectedResult hotwordRejectedResult) throws RemoteException {
                synchronized (DspTrustedHotwordDetectorSession.this.mLock) {
                    ...
                    if (!DspTrustedHotwordDetectorSession.this.mValidatingDspTrigger) {
                        Slog.i(DspTrustedHotwordDetectorSession.TAG, "Ignoring #onRejected due to a process restart");
                    ...
                    try {
                        ...
                        if (DspTrustedHotwordDetectorSession.this.mDebugHotwordLogging && hotwordRejectedResult != null) {
                            Slog.i(DspTrustedHotwordDetectorSession.TAG, "Egressed rejected result: " + hotwordRejectedResult);
                        }
                    } catch (RemoteException e) {
                        DspTrustedHotwordDetectorSession.this.notifyOnDetectorRemoteException();
        ...
        this.mLastHotwordRejectedResult = null;
        this.mRemoteDetectionService.run(new ServiceConnector.VoidJob() { // from class: com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$detectFromDspSourceLocked$1(final AtomicBoolean atomicBoolean, final IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback, SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEvent, IDspHotwordDetectionCallback iDspHotwordDetectionCallback, ISandboxedDetectionService iSandboxedDetectionService) throws Exception {
        this.mCancellationKeyPhraseDetectionFuture = this.mScheduledExecutorService.schedule(new Runnable() { // from class: com.android.server.voiceinteraction.DspTrustedHotwordDetectorSession$$ExternalSyntheticLambda0
        ...
        }, MAX_VALIDATION_TIMEOUT_MILLIS, TimeUnit.MILLISECONDS);
        iSandboxedDetectionService.detectFromDspSource(keyphraseRecognitionEvent, keyphraseRecognitionEvent.getCaptureFormat(), VALIDATION_TIMEOUT_MILLIS, iDspHotwordDetectionCallback);
    }
    ...
    public /* synthetic */ void lambda$detectFromDspSourceLocked$0(AtomicBoolean atomicBoolean, IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback) {
        ...
        try {
            iHotwordRecognitionStatusCallback.onHotwordDetectionServiceFailure(new HotwordDetectionServiceFailure(4, "Timeout to response to the detection result."));
        } catch (RemoteException e) {

...
final class VoiceInteractionManagerServiceShellCommand extends ShellCommand {
    ...
    private int requestShow(final PrintWriter printWriter) {
    ...
    private int requestHide(PrintWriter printWriter) {
    ...
    private int requestDisable(PrintWriter printWriter) {
        boolean parseBoolean = Boolean.parseBoolean(getNextArgRequired());
        Slog.i(TAG, "requestDisable(): " + parseBoolean);
        try {
    ...
    private int requestRestartDetection(PrintWriter printWriter) {
    ...
    private int setDebugHotwordLogging(PrintWriter printWriter) {
        boolean parseBoolean = Boolean.parseBoolean(getNextArgRequired());
        Slog.i(TAG, "setDebugHotwordLogging(): " + parseBoolean);
        try {
    ...
    private static int handleError(PrintWriter printWriter, String str, Exception exc) {
        Slog.e(TAG, "error calling " + str, exc);

...
public final class TimeDetectorService extends ITimeDetectorService.Stub implements IBinder.DeathRecipient {
    ...
    public static class Lifecycle extends SystemService {
        ...
        public void onStart() {
            ...
            publishBinderService(TimeDetectorService.TAG, new TimeDetectorService(context, handler, CallerIdentityInjector.REAL, serviceConfigAccessorImpl, create, NtpTrustedTime.getInstance(context)));
        }
    }

...
public final class UserState implements RemotePrintSpooler.PrintSpoolerCallbacks, RemotePrintService.PrintServiceCallbacks, RemotePrintServiceRecommendationService.RemotePrintServiceRecommendationServiceCallbacks {
    ...
    public void onPrintJobQueued(PrintJobInfo printJobInfo) {
        ...
        if (remotePrintService != null) {
            ...
            this.mSpooler.setPrintJobState(printJobInfo.getId(), 6, this.mContext.getString(R.string.whichImageCaptureApplicationLabel));
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0045 A[Catch: all -> 0x0052, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x000d, B:8:0x0039, B:12:0x004d, B:14:0x0045, B:15:0x004a, B:17:0x003e, B:22:0x0050), top: B:3:0x0003 }] */
    /*
    ...
    */
    ...
    public void createPrinterDiscoverySession(IPrinterDiscoveryObserver iPrinterDiscoveryObserver) {
        ...
        synchronized (this.mLock) {
            ...
            if (printerDiscoverySessionMediator == null) {
                AnonymousClass1 anonymousClass1 = new PrinterDiscoverySessionMediator() { // from class: com.android.server.print.UserState.1
                    AnonymousClass1() {
                    }
                ...
                this.mPrinterDiscoverySession = anonymousClass1;
    ...
    public void addPrintJobStateChangeListener(IPrintJobStateChangeListener iPrintJobStateChangeListener, int i) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintJobStateChangeListenerRecords.add(new PrintJobStateChangeListenerRecord(iPrintJobStateChangeListener, i) { // from class: com.android.server.print.UserState.2
                AnonymousClass2(IPrintJobStateChangeListener iPrintJobStateChangeListener2, int i2) throws RemoteException {
    ...
    public void addPrintServicesChangeListener(IPrintServicesChangeListener iPrintServicesChangeListener) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintServicesChangeListenerRecords.add(new ListenerRecord<IPrintServicesChangeListener>(iPrintServicesChangeListener) { // from class: com.android.server.print.UserState.3
                AnonymousClass3(IPrintServicesChangeListener iPrintServicesChangeListener2) throws RemoteException {
    ...
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes2.dex */
    public class AnonymousClass3 extends ListenerRecord<IPrintServicesChangeListener> {
        AnonymousClass3(IPrintServicesChangeListener iPrintServicesChangeListener2) throws RemoteException {
            super(iPrintServicesChangeListener2);
        }
    ...
    public void addPrintServiceRecommendationsChangeListener(IRecommendationsChangeListener iRecommendationsChangeListener) throws RemoteException {
        synchronized (this.mLock) {
            ...
            this.mPrintServiceRecommendationsChangeListenerRecords.add(new ListenerRecord<IRecommendationsChangeListener>(iRecommendationsChangeListener) { // from class: com.android.server.print.UserState.4
                AnonymousClass4(IRecommendationsChangeListener iRecommendationsChangeListener2) throws RemoteException {
    ...
    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes2.dex */
    public class AnonymousClass4 extends ListenerRecord<IRecommendationsChangeListener> {
        AnonymousClass4(IRecommendationsChangeListener iRecommendationsChangeListener2) throws RemoteException {
            super(iRecommendationsChangeListener2);
        }
    ...
    private void readInstalledPrintServicesLocked() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!"android.permission.BIND_PRINT_SERVICE".equals(resolveInfo.serviceInfo.permission)) {
                ...
                Slog.w(LOG_TAG, "Skipping print service " + new ComponentName(serviceInfo.packageName, serviceInfo.name).flattenToShortString() + " since it does not require permission android.permission.BIND_PRINT_SERVICE");
            } else {
    ...
    public void removeServiceLocked(RemotePrintService remotePrintService) {
        failActivePrintJobsForService(remotePrintService.getComponentName());
        PrinterDiscoverySessionMediator printerDiscoverySessionMediator = this.mPrinterDiscoverySession;
        if (printerDiscoverySessionMediator != null) {
    ...
    public void failScheduledPrintJobsForServiceInternal(ComponentName componentName) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                this.mSpooler.setPrintJobState(printJobInfos.get(i).getId(), 6, this.mContext.getString(R.string.whichImageCaptureApplicationLabel));
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    ...
    public void handleDispatchPrintJobStateChanged(PrintJobId printJobId, IntSupplier intSupplier) {
    ...
    public void handleDispatchPrintServiceRecommendationsUpdated(List<RecommendationInfo> list) {
        synchronized (this.mLock) {
            if (this.mPrintServiceRecommendationsChangeListenerRecords == null) {
                return;
            }
    ...
    public class PrinterDiscoverySessionMediator {
        ...
        /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes2.dex */
        public class AnonymousClass1 extends RemoteCallbackList<IPrinterDiscoveryObserver> {
            AnonymousClass1() {
            }
        ...
        public void onPrintersRemovedLocked(List<PrinterId> list) {
            ...
            if (arrayList != null) {
                Handler.getMain().sendMessage(PooledLambda.obtainMessage(new UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda9(), this, arrayList));
            }
        }
    ...
    public final class PrintJobForAppCache {
        ...
        /* synthetic */ PrintJobForAppCache(UserState userState, PrintJobForAppCacheIA printJobForAppCacheIA) {
            this();
        }
        ...
        public class AnonymousClass1 implements IBinder.DeathRecipient {
            ...
            AnonymousClass1(IBinder iBinder, int i) {
                r2 = iBinder;
                r3 = i;
            }
        ...
        public boolean onPrintJobCreated(IBinder iBinder, int i, PrintJobInfo printJobInfo) {
            try {
                iBinder.linkToDeath(new IBinder.DeathRecipient() { // from class: com.android.server.print.UserState.PrintJobForAppCache.1
                    ...
                    AnonymousClass1(IBinder iBinder2, int i2) {
                        r2 = iBinder2;
                        r3 = i2;
                    }
                ...
                synchronized (UserState.this.mLock) {
                    List<PrintJobInfo> list = this.mPrintJobsForRunningApp.get(i2);
                    if (list == null) {
                        list = new ArrayList<>();

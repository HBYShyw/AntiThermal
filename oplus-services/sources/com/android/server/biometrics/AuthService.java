...
public class AuthService extends SystemService {
    ...
    private final class AuthServiceImpl extends IAuthService.Stub {
        ...
        public String getUiPackage() {
            ...
            return AuthService.this.getContext().getResources().getString(R.string.config_deviceSpecificDevicePolicyManagerService);
        }
        ...
        public CharSequence getButtonLabel(int i, String str, @BiometricManager.Authenticators.Types int i2) throws RemoteException {
            ...
            try {
                ...
                if (credentialBackupModality == 0) {
                    ...
                    str2 = AuthService.this.getContext().getString(17041566);
                } else if (credentialBackupModality == 2) {
                    str2 = AuthService.this.getContext().getString(R.string.keyguard_password_enter_puk_prompt);
                } else if (credentialBackupModality == 8) {
                    str2 = AuthService.this.getContext().getString(R.string.immersive_cling_title);
                } else {
                    str2 = AuthService.this.getContext().getString(R.string.capability_desc_canControlMagnification);
                }
                return str2;
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        public CharSequence getPromptMessage(int i, String str, @BiometricManager.Authenticators.Types int i2) throws RemoteException {
            ...
            try {
                ...
                if (credentialBackupModality == 0) {
                    ...
                    str2 = AuthService.this.getContext().getString(17041567);
                } else if (credentialBackupModality != 2) {
                    if (credentialBackupModality != 8) {
                        if (isCredentialRequested) {
                            str2 = AuthService.this.getContext().getString(R.string.capability_title_canRequestTouchExploration);
                        } else {
                            str2 = AuthService.this.getContext().getString(R.string.capability_desc_canPerformGestures);
                        }
                    } else if (isCredentialRequested) {
                        str2 = AuthService.this.getContext().getString(R.string.keyboardview_keycode_alt);
                    } else {
                        str2 = AuthService.this.getContext().getString(R.string.inputMethod);
                    }
                } else if (isCredentialRequested) {
                    str2 = AuthService.this.getContext().getString(R.string.kg_password_instructions);
                } else {
                    str2 = AuthService.this.getContext().getString(R.string.keyguard_password_wrong_pin_code);
                }
                return str2;
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        public CharSequence getSettingName(int i, String str, @BiometricManager.Authenticators.Types int i2) throws RemoteException {
            ...
            try {
                ...
                if (supportedModalities == 0) {
                    ...
                    if (i3 == 2) {
                        str2 = AuthService.this.getContext().getString(R.string.kg_login_username_hint);
                    } else if (i3 == 8) {
                        str2 = AuthService.this.getContext().getString(R.string.js_dialog_title_default);
                    } else {
                        str2 = AuthService.this.getContext().getString(R.string.capability_title_canRequestFilterKeyEvents);
                    }
                }
                return str2;
            } finally {
    ...
    public void onStart() {
        ...
        Slog.d(TAG, "Aidl Properties: " + SystemProperties.get("vendor.fingerprint.aidl.support", "0"));
        SensorConfig[] sensorConfigArr = null;
        if (!"1".equals(SystemProperties.get("vendor.fingerprint.aidl.support", "0")) && !this.mInjector.isHidlDisabled(getContext())) {
            ...
            for (int i2 = 0; i2 < configuration.length; i2++) {
                sensorConfigArr2[i2] = new SensorConfig(configuration[i2]);
            }
            sensorConfigArr = sensorConfigArr2;
        }
    ...
    private FingerprintSensorPropertiesInternal getHidlFingerprintSensorProps(int i, @BiometricManager.Authenticators.Types int i2) {
        int[] intArray = getContext().getResources().getIntArray(17236162);
        boolean z = !ArrayUtils.isEmpty(intArray);
        int i3 = z ? 3 : getContext().getResources().getBoolean(17891727) ? 4 : 1;
        int integer = getContext().getResources().getInteger(R.integer.config_multiuserMaximumUsers);
        ArrayList arrayList = new ArrayList();
    ...
    private FaceSensorPropertiesInternal getHidlFaceSensorProps(int i, @BiometricManager.Authenticators.Types int i2) {
        boolean z = getContext().getResources().getBoolean(17891693);
        return new FaceSensorPropertiesInternal(i, Utils.authenticatorStrengthToPropertyStrength(i2), getContext().getResources().getInteger(R.integer.config_multiuserMaxRunningUsers), new ArrayList(), 0, false, z, true);
    }

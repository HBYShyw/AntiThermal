...
import com.android.server.biometrics.sensors.face.aidl.FaceStopUserClient;
...
public class UserAwareBiometricScheduler extends BiometricScheduler {
    ...
    public class ClientFinishedCallback implements ClientMonitorCallback {
        ...
        ClientFinishedCallback(BaseClientMonitor baseClientMonitor) {
        ...
        public /* synthetic */ void lambda$onClientFinished$0(BaseClientMonitor baseClientMonitor, boolean z) {
            ...
            if (!z && baseClientMonitor != null && (baseClientMonitor instanceof FaceStopUserClient)) {
                Slog.d(UserAwareBiometricScheduler.this.getTag(), "force call onUserStopped to idle");
                UserAwareBiometricScheduler.this.onUserStopped();
            }
    ...
    public void startNextOperationIfIdle() {
        ...
        try {
            ...
            Slog.e(getTag(), "exception when get nextUserId", e);
        }
    }

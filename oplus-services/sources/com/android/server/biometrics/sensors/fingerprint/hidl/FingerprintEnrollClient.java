...
public class FingerprintEnrollClient extends EnrollClient<IBiometricsFingerprint> implements Udfps {
    ...
    protected boolean hasReachedEnrollmentLimit() {
        if (this.mBiometricUtils.getBiometricsForUser(getContext(), getTargetUserId()).size() < getContext().getResources().getInteger(R.integer.config_multiuserMaximumUsers)) {
            return false;
        }
    ...
    public void startHalOperation() {
        ...
        try {
            getFreshDaemon().enroll(this.mHardwareAuthToken, this.mBaseClientMonitorExt.hookTargetUserId(getTargetUserId()), this.mTimeoutSec);

...
public class FaceService extends SystemService {
    ...
    private IFaceServiceExt mIFaceServiceExt;
    private final LockPatternUtils mLockPatternUtils;
    private final LockoutResetDispatcher mLockoutResetDispatcher;
    private IFaceServiceWrapper mOplusFaceServiceWrapper;
    ...
    public final class FaceServiceWrapper extends IFaceService.Stub {
        ...
        public long enroll(int i, IBinder iBinder, byte[] bArr, IFaceServiceReceiver iFaceServiceReceiver, String str, int[] iArr, Surface surface, boolean z) {
            ...
            FaceService.this.getWrapper().getExtImpl().scheduleEnroll();
        ...
        public long authenticate(IBinder iBinder, long j, IFaceServiceReceiver iFaceServiceReceiver, FaceAuthenticateOptions faceAuthenticateOptions) {
            if (FaceService.this.getWrapper().getExtImpl().isBiometricDisabled()) {
                return -1L;
            }
            ...
            FaceService.this.getWrapper().getExtImpl().authPreOperation(iBinder, opPackageName);
        ...
        public void prepareForAuthentication(boolean z, IBinder iBinder, long j, IBiometricSensorReceiver iBiometricSensorReceiver, FaceAuthenticateOptions faceAuthenticateOptions, long j2, int i, boolean z2) {
            ...
            if (providerForSensor == null) {
                ...
                FaceService.this.getWrapper().getExtImpl().authPreOperation(iBinder, faceAuthenticateOptions.getOpPackageName());
                ...
                try {
                    if (strArr.length > 1 && "--proto".equals(strArr[0]) && "--state".equals(strArr[1])) {
                        ...
                        for (ServiceProvider serviceProvider3 : FaceService.this.mRegistry.getProviders()) {
                            Iterator<FaceSensorPropertiesInternal> it3 = serviceProvider3.getSensorProperties().iterator();
                            while (it3.hasNext()) {
                                serviceProvider3.dumpHal(it3.next().sensorId, fileDescriptor, (String[]) Arrays.copyOfRange(strArr, 1, strArr.length, strArr.getClass()));
                            }
                        }
                    } else {
                        for (ServiceProvider serviceProvider4 : FaceService.this.mRegistry.getProviders()) {
                            for (FaceSensorPropertiesInternal faceSensorPropertiesInternal : serviceProvider4.getSensorProperties()) {
                                ...
                                FaceService.this.getWrapper().getExtImpl().dumpInternal(serviceProvider4, printWriter, strArr);
                                printWriter.println();
                            }
                        }
                    }
        ...
        public List<Face> getEnrolledFaces(int i, int i2, String str) {
            ...
            return FaceService.this.getWrapper().getExtImpl().getEnrolledFacesExcludePalms(providerForSensor.getEnrolledFaces(i, i2));
        }
        ...
        public boolean hasEnrolledFaces(int i, int i2, String str) {
            ...
            ServiceProvider providerForSensor = FaceService.this.mRegistry.getProviderForSensor(i);
            if (providerForSensor != null) {
                return FaceService.this.getWrapper().getExtImpl().getEnrolledFacesExcludePalms(providerForSensor.getEnrolledFaces(i, i2)).size() > 0;
            }
        ...
        private List<ServiceProvider> getAidlProviders() {
            ...
            if (declaredInstances != null && declaredInstances.length != 0) {
                ...
                FaceService.this.getWrapper().getExtImpl().onSystemReady();
            }
            return arrayList;
        }
    ...
    public FaceService(Context context) {
        super(context);
        this.mOplusFaceServiceWrapper = new OplusFaceServiceWrapper();
        this.mIFaceServiceExt = (IFaceServiceExt) ExtLoader.type(IFaceServiceExt.class).base(this).create();
    ...
    public IFaceServiceWrapper getWrapper() {
        return this.mOplusFaceServiceWrapper;
    }

    /* loaded from: C:\Users\HuangYW\Desktop\Realme反编译\services\classes.dex */
    private class OplusFaceServiceWrapper implements IFaceServiceWrapper {
        private OplusFaceServiceWrapper() {
        }

        @Override // com.android.server.biometrics.sensors.face.IFaceServiceWrapper
        public IFaceServiceExt getExtImpl() {
            return FaceService.this.mIFaceServiceExt;
        }

        @Override // com.android.server.biometrics.sensors.face.IFaceServiceWrapper
        public void setExtensionWrapper(IBinder iBinder) {
            FaceService.this.mServiceWrapper.setExtension(iBinder);
        }

        @Override // com.android.server.biometrics.sensors.face.IFaceServiceWrapper
        public ServiceProvider getProviderForSensorWrapper(int i) {
            return FaceService.this.mRegistry.getProviderForSensor(i);
        }

        @Override // com.android.server.biometrics.sensors.face.IFaceServiceWrapper
        public Pair<Integer, ServiceProvider> getSingleProviderWrapper() {
            return FaceService.this.mRegistry.getSingleProvider();
        }
    }
}

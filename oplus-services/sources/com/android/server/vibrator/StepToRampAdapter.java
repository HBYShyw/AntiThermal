...
final class StepToRampAdapter implements VibrationEffectAdapters.SegmentsAdapter<VibratorInfo> {
    ...
    private void convertStepsToRamps(VibratorInfo vibratorInfo, List<VibrationEffectSegment> list) {
        int size = list.size();
    ...
    private int splitLongRampSegments(VibratorInfo vibratorInfo, List<VibrationEffectSegment> list, int i) {

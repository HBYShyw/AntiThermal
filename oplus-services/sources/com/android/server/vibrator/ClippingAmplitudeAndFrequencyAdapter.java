...
final class ClippingAmplitudeAndFrequencyAdapter implements VibrationEffectAdapters.SegmentsAdapter<VibratorInfo> {
    ...
    private StepSegment apply(StepSegment stepSegment, VibratorInfo vibratorInfo) {
    ...
    private RampSegment apply(RampSegment rampSegment, VibratorInfo vibratorInfo) {

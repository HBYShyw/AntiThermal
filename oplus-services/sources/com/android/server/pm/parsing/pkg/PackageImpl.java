...
public class PackageImpl implements ParsedPackage, AndroidPackageInternal, AndroidPackageHidden, ParsingPackage, ParsingPackageHidden, Parcelable {
    ...
    private static final Comparator<ParsedMainComponent> ORDER_COMPARATOR = new Comparator() { // from class: com.android.server.pm.parsing.pkg.PackageImpl$$ExternalSyntheticLambda0
    ...
    @Override // com.android.server.pm.pkg.AndroidPackage, com.android.server.pm.pkg.parsing.ParsingPackage
    ...
    @Override // com.android.server.pm.parsing.pkg.AndroidPackageInternal
    ...
    @Override // com.android.server.pm.parsing.pkg.AndroidPackageHidden, com.android.server.pm.pkg.parsing.ParsingPackageHidden
    ...
    private PackageImpl setBoolean(@Booleans.Flags long j, boolean z) {
        if (z) {
    ...
    private boolean getBoolean(@Booleans.Flags long j) {
        return (this.mBooleans & j) != 0;
    }

    private PackageImpl setBoolean2(@Booleans2.Flags long j, boolean z) {
        if (z) {
    ...
    private boolean getBoolean2(@Booleans2.Flags long j) {

...
public abstract class InstantAppResolver {
    ...
    */
    public static AuxiliaryResolveInfo doInstantAppResolutionPhaseOne(Computer computer, UserManagerService userManagerService, InstantAppResolverConnection instantAppResolverConnection, InstantAppRequest instantAppRequest) {
        ...
        if (DEBUG_INSTANT) {
            Log.d(TAG, "[" + str2 + "] Phase1; resolving");
        }
        ...
        try {
            ...
            if (instantAppResolveInfoList == null || instantAppResolveInfoList.size() <= 0) {
                ...
                String str3 = instantAppRequest.resolvedType;
        ...
        if (DEBUG_INSTANT && auxiliaryResolveInfo == null) {
            if (i2 != i) {
                ...
                String str5 = str;
                if (i2 == 3) {
                    Log.d(str5, "[" + str2 + "] Phase1; call timed out");
                } else if (i2 != 0) {
                    Log.d(str5, "[" + str2 + "] Phase1; service connection error");
                } else {
                    Log.d(str5, "[" + str2 + "] Phase1; No results matched");
                }
            }
        }
        return (auxiliaryResolveInfo == null || (intent.getFlags() & 2048) == 0) ? auxiliaryResolveInfo : new AuxiliaryResolveInfo(str2, false, createFailureIntent(intent, str2), (List) null, instantAppRequest.hostDigestPrefixSecure);
    }
    ...
    private static List<AuxiliaryResolveInfo.AuxiliaryFilter> computeResolveFilters(Computer computer, UserManagerService userManagerService, Intent intent, String str, int i, String str2, String str3, InstantAppResolveInfo instantAppResolveInfo) {

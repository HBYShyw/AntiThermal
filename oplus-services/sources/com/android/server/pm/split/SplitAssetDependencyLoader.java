...
public class SplitAssetDependencyLoader extends SplitDependencyLoader<IllegalArgumentException> implements SplitAssetLoader {
    ...
    private static ApkAssets loadApkAssets(String str, int i) throws IllegalArgumentException {
    ...
    protected void constructSplit(int i, int[] iArr, int i2) throws IllegalArgumentException {

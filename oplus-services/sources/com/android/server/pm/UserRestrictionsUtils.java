...
public class UserRestrictionsUtils {
    ...
    private static final Set<String> MAIN_USER_ONLY_RESTRICTIONS = Sets.newArraySet(new String[]{"no_bluetooth", "no_usb_file_transfer", "no_config_tethering", "no_network_reset", "no_factory_reset", "no_add_user", "no_config_cell_broadcasts", "no_config_mobile_networks", "no_physical_media", "no_sms", "no_fun", "no_safe_boot", "no_create_windows", "no_data_roaming", "no_airplane_mode"});
    private static final Set<String> DEVICE_OWNER_ONLY_RESTRICTIONS = Sets.newArraySet(new String[]{"no_user_switch", "disallow_config_private_dns", "disallow_microphone_toggle", "disallow_camera_toggle", "no_change_wifi_state", "no_wifi_tethering", "no_wifi_direct", "no_add_wifi_config", "no_cellular_2g", "no_ultra_wideband_radio"});
    ...
    private static final Set<String> PROFILE_OWNER_ORGANIZATION_OWNED_GLOBAL_RESTRICTIONS = Sets.newArraySet(new String[]{"no_airplane_mode", "no_config_date_time", "disallow_config_private_dns", "no_change_wifi_state", "no_debugging_features", "no_wifi_tethering", "no_wifi_direct", "no_add_wifi_config", "no_cellular_2g", "no_ultra_wideband_radio"});
    ...
    private static boolean isSystemApp(int i, String[] strArr) {
    ...
    public static void writeRestrictions(XmlSerializer xmlSerializer, Bundle bundle, String str) throws IOException {
        writeRestrictions(XmlUtils.makeTyped(xmlSerializer), bundle, str);
    }
    ...
    public static void readRestrictions(XmlPullParser xmlPullParser, Bundle bundle) {
        readRestrictions(XmlUtils.makeTyped(xmlPullParser), bundle);
    }
    ...
    public static Bundle readRestrictions(XmlPullParser xmlPullParser) {
        return readRestrictions(XmlUtils.makeTyped(xmlPullParser));
    }
    ...
    public static void moveRestriction(String str, SparseArray<RestrictionsSet> sparseArray, RestrictionsSet restrictionsSet) {
    ...
    private static void setInstallMarketAppsRestriction(ContentResolver contentResolver, int i, int i2) {
        Settings.Secure.putIntForUser(contentResolver, "install_non_market_apps", i2, i);
    }

    private static int getNewUserRestrictionSetting(Context context, int i, String str, boolean z) {

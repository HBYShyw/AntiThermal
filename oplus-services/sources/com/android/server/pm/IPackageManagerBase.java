...
public abstract class IPackageManagerBase extends IPackageManager.Stub {
    ...
    public final String getAttentionServicePackageName() {
        return this.mService.ensureSystemPackageName(snapshot(), this.mService.getPackageFromComponentString(R.string.config_managed_provisioning_package));
    }
    ...
    public final String[] getPackagesForUid(int i) {
        ...
        if (!this.mService.mPackageManagerServiceExt.skipCheckCrossUserPermission(callingUid, userId)) {
    ...
    public final String getRotationResolverPackageName() {
        return this.mService.ensureSystemPackageName(snapshot(), this.mService.getPackageFromComponentString(R.string.config_radio_access_family));
    }
    ...
    public final String getSystemCaptionsServicePackageName() {
        return this.mService.ensureSystemPackageName(snapshot(), this.mService.getPackageFromComponentString(R.string.config_retailDemoPackageSignature));
    }
    ...
    public final ParceledListSlice<ResolveInfo> queryIntentActivities(Intent intent, String str, long j, int i) {
        try {
            ...
            List<ResolveInfo> queryIntentActivitiesExtAtBegin = this.mService.mPackageManagerServiceExt.queryIntentActivitiesExtAtBegin(intent, str, j, i);
            if (queryIntentActivitiesExtAtBegin != null) {
                return new ParceledListSlice<>(queryIntentActivitiesExtAtBegin);
            }

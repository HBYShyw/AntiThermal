...
public final class DistractingPackageHelper {
    ...
    public String[] setDistractingPackageRestrictionsAsUser(Computer computer, String[] strArr, final int i, final int i2, int i3) {
        ...
        if (PackageManagerService.DEBUG_SETTINGS) {
            Slog.d("PackageManager", "setDistractingPackageRestrictionsAsUser start: " + strArr.length + ", " + i + ", " + i2 + ", from " + Binder.getCallingUid() + ", " + Binder.getCallingPid());
        }
        ...
        if (PackageManagerService.DEBUG_SETTINGS) {
            Slog.d("PackageManager", "setDistractingPackageRestrictionsAsUser end");
        }
    ...
    public void removeDistractingPackageRestrictions(Computer computer, String[] strArr, final int i) {
        ...
        IntArray intArray = new IntArray(strArr.length);
        if (PackageManagerService.DEBUG_SETTINGS) {
            Slog.d("PackageManager", "removeDistractingPackageRestrictions start: " + String.valueOf(strArr.length) + ", " + i);
        }
    ...
    void sendDistractingPackagesChanged(String[] strArr, int[] iArr, final int i, int i2) {
        ...
        this.mInjector.getHandler().post(new Runnable() { // from class: com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ void lambda$sendDistractingPackagesChanged$3(Bundle bundle, int i) {
        this.mBroadcastHelper.sendPackageBroadcast("android.intent.action.DISTRACTING_PACKAGES_CHANGED", null, bundle, 1073741824, null, null, new int[]{i}, null, null, new BiFunction() { // from class: com.android.server.pm.DistractingPackageHelper$$ExternalSyntheticLambda1

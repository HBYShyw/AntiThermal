...
public class PackageUserStateImpl extends WatchableImpl implements PackageUserStateInternal, Snappable {
    ...
    public PackageUserStateImpl(Watchable watchable, PackageUserStateImpl packageUserStateImpl) {
        ...
        this.mPackageUserStateExt.setExtraData(packageUserStateImpl.mPackageUserStateExt);
    }
    ...
    public boolean ignorePackageDisabledInIsEnabled(int i, long j) {
        return this.mPackageUserStateExt.ignorePackageDisabledInIsEnabled(i, j);
    }
    ...
    public OverlayPaths getAllOverlayPaths() {
        ...
        if (watchedArrayMap != null) {
            Iterator<OverlayPaths> it = watchedArrayMap.values().iterator();
            while (it.hasNext()) {
    ...
    public PackageUserStateImpl setEnabledComponents(WatchedArraySet<String> watchedArraySet) {
        this.mEnabledComponentsWatched = watchedArraySet;
        if (watchedArraySet != null) {
            watchedArraySet.registerObserver(this.mSnapshot);
        }
        onChanged();
        return this;
    ...
    public PackageUserStateImpl setDisabledComponents(WatchedArraySet<String> watchedArraySet) {
        this.mDisabledComponentsWatched = watchedArraySet;
        if (watchedArraySet != null) {
            watchedArraySet.registerObserver(this.mSnapshot);
        }
    ...
    public PackageUserStateImpl setSharedLibraryOverlayPaths(ArrayMap<String, OverlayPaths> arrayMap) {
        if (arrayMap == null) {
            return this;
        }
        if (this.mSharedLibraryOverlayPaths == null) {
    ...
    public PackageUserStateImpl setComponentLabelIconOverrideMap(ArrayMap<ComponentName, Pair<String, Integer>> arrayMap) {
        if (arrayMap == null) {
            return this;
        }
        if (this.mComponentLabelIconOverrideMap == null) {
    ...
    public PackageUserStateImpl setDisabledComponentsWatched(WatchedArraySet<String> watchedArraySet) {
        this.mDisabledComponentsWatched = watchedArraySet;
        return this;
    }

    public PackageUserStateImpl setEnabledComponentsWatched(WatchedArraySet<String> watchedArraySet) {
        this.mEnabledComponentsWatched = watchedArraySet;
        return this;
    }

    public PackageUserStateImpl setSharedLibraryOverlayPaths(WatchedArrayMap<String, OverlayPaths> watchedArrayMap) {
        this.mSharedLibraryOverlayPaths = watchedArrayMap;
        return this;
    }

    public PackageUserStateImpl setSuspendParams(WatchedArrayMap<String, SuspendParams> watchedArrayMap) {
        this.mSuspendParams = watchedArrayMap;
        return this;
    }

    public PackageUserStateImpl setComponentLabelIconOverrideMap(WatchedArrayMap<ComponentName, Pair<String, Integer>> watchedArrayMap) {

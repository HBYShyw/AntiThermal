...
public class UserManagerServiceShellCommand extends ShellCommand {
    ...
    private int runReportPackageAllowlistProblems() {
        char c;
        PrintWriter outPrintWriter = getOutPrintWriter();
        int i = JobSchedulerShellCommand.CMD_ERR_NO_PACKAGE;
        boolean z = false;
        boolean z2 = false;
        while (true) {
            String nextOption = getNextOption();
            if (nextOption != null) {
                ...
                Slog.d(LOG_TAG, "runReportPackageAllowlistProblems(): verbose=" + z + ", criticalOnly=" + z2 + ", mode=" + UserSystemPackageInstaller.modeToString(i));
            ...
            if (nextOption == null) {
                ...
                switch (nextArgRequired.hashCode()) {
                    ...
                    case 3154575:
                        ...
                        break;
                    case 1544803905:
                        if (nextArgRequired.equals(HealthServiceWrapperHidl.INSTANCE_VENDOR)) {
                            c = 2;
                            break;
                        }
                        c = 65535;
                ...
                Slogf.d(LOG_TAG, "Updating system property %s to %s", "persist.debug.user_mode_emulation", nextArgRequired);
                ...
                if (z3) {
                    ...
                    Slogf.i(LOG_TAG, "Restarting Android runtime(PID=%d) to finalize changes", Integer.valueOf(myPid));
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(17891761)));
                }
                return 0;
            }
        }
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                if (!z) {
                    ...
                    outPrintWriter.printf("effective=%b real=%b\n", Boolean.valueOf(isVisibleBackgroundUsersOnDefaultDisplayEnabled), Boolean.valueOf(Resources.getSystem().getBoolean(17891762)));
                }
                return 0;
            }
        }

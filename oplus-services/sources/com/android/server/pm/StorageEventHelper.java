...
public final class StorageEventHelper extends StorageEventListener {
    ...
    */
    public void lambda$loadPrivatePackages$0(VolumeInfo volumeInfo) {
        ...
        for (PackageStateInternal packageStateInternal : volumePackagesLPr) {
            ...
            synchronized (this.mPm.mInstallLock) {
                try {
                    arrayList2.add(installPackageHelper.initPackageTracedLI(packageStateInternal.getPath(), defParseFlags, 512));
        ...
        if (PackageManagerService.DEBUG_INSTALL) {
            Slog.d("PackageManager", "Loaded packages " + arrayList2);
        }
    ...
    public void lambda$unloadPrivatePackages$1(VolumeInfo volumeInfo) {
        String str = volumeInfo.fsUuid;
        if (TextUtils.isEmpty(str)) {
        ...
        if (PackageManagerService.DEBUG_INSTALL) {
            Slog.d("PackageManager", "Unloaded packages " + arrayList);
        }
    ...
    private void sendResourcesChangedBroadcast(boolean z, boolean z2, ArrayList<AndroidPackage> arrayList) {
    ...
    private List<String> collectAbsoluteCodePaths(Computer computer) {
        ArrayList arrayList = new ArrayList();

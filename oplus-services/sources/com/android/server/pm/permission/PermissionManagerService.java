    ...
    public static final class PermissionCheckerService extends IPermissionChecker.Stub {
        ...
        */
        ...
        private static int checkPermission(Context context, PermissionManagerServiceInternal permissionManagerServiceInternal, String str, AttributionSource attributionSource, String str2, boolean z, boolean z2, boolean z3, int i) {
            ...
            if (permissionInfo == null) {
                try {
                    ...
                    if (PackageManagerService.PLATFORM_PACKAGE_NAME.equals(permissionInfo.packageName) || HealthConnectManager.isHealthPermission(context, str)) {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        private static int checkAppOpPermission(Context context, PermissionManagerServiceInternal permissionManagerServiceInternal, String str, AttributionSource attributionSource, String str2, boolean z, boolean z2) {
            String str3;
            ...
            while (true) {
                ...
                int performOpTransaction = performOpTransaction(context, attributionSource.getToken(), permissionToOpCode, attributionSource3, str2, z, false, z3, z4 || next == null, z4, -1, 0, 0, -1);
        ...
        */
        private static int checkRuntimePermission(Context context, PermissionManagerServiceInternal permissionManagerServiceInternal, String str, AttributionSource attributionSource, String str2, boolean z, boolean z2, boolean z3, int i) {
            ...
            while (true) {
                ...
                if (((z5 && attributionSource5.equals(attributionSource3)) ? i6 : 0) == 0 && next != null && !attributionSource5.isTrusted(context)) {
                    return 2;
                }
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        private static int checkOp(Context context, int i, PermissionManagerServiceInternal permissionManagerServiceInternal, AttributionSource attributionSource, String str, boolean z, boolean z2) {
        ...
        private static int performOpTransaction(Context context, IBinder iBinder, int i, AttributionSource attributionSource, String str, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, int i2, int i3, int i4, int i5) {
            ...
            if (z2) {
                ...
                if (i2 == -1 || i2 == i) {
                    ...
                    str2 = ":";
                    i9 = appOpsManager3.checkOpNoThrow(i, resolveAttributionSource.getUid(), resolveAttributionSource.getPackageName());
                    if (i9 == 2) {
                        return i9;
                    }
                    i8 = i2;
            ...
            if (z4) {
                ...
                try {
                    ...
                    String str9 = "Security exception for op " + i6 + " with source " + attributionSource.getUid() + ":" + attributionSource.getPackageName() + ", " + attributionSource.getNextUid() + ":" + attributionSource.getNextPackageName();
                    if (attributionSource.getNext() != null) {
                        AttributionSource next4 = attributionSource.getNext();
                        str9 = str9 + ", " + next4.getNextPackageName() + ":" + next4.getNextUid();
                    }
                    throw new SecurityException(str9 + ":" + e2.getMessage());
                }
            }

...
public class DomainVerificationShell {
    ...
    private boolean runSetAppLinks(BasicShellCommandHandler basicShellCommandHandler) {
        String str = null;
        while (true) {
            ...
            if (nextOption != null) {
                ...
                ArraySet<String> arraySet = new ArraySet<>(getRemainingArgs(basicShellCommandHandler));
                if (arraySet.isEmpty()) {
                    basicShellCommandHandler.getErrPrintWriter().println("No domains specified");
                    return false;
                }
                try {
                    this.mCallback.setDomainVerificationStatusInternal(str, i, (arraySet.size() == 1 && arraySet.contains("all")) ? null : arraySet);
                    return true;
    ...
    private boolean runSetAppLinksUserState(BasicShellCommandHandler basicShellCommandHandler) {
        String str = null;
        Integer num = null;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
            if (nextOption != null) {
                ...
                try {
                    ...
                    try {
                        this.mCallback.setDomainVerificationUserSelectionInternal(valueOf.intValue(), str, parseEnabled, (arraySet.size() == 1 && arraySet.contains("all")) ? null : arraySet);
                        return true;
                    } catch (PackageManager.NameNotFoundException unused) {
                        basicShellCommandHandler.getErrPrintWriter().println("Package not found: " + str);
                        return false;
    ...
    private boolean runGetAppLinks(BasicShellCommandHandler basicShellCommandHandler) {
        Integer num = null;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
            if (nextOption != null) {
    ...
    private boolean runResetAppLinks(BasicShellCommandHandler basicShellCommandHandler) {
        Integer num = null;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
            if (nextOption != null) {
    ...
    private boolean runVerifyAppLinks(BasicShellCommandHandler basicShellCommandHandler) {
        boolean z = false;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
            if (nextOption != null) {
    ...
    private boolean runSetAppLinksAllowed(BasicShellCommandHandler basicShellCommandHandler) {
        String str = null;
        Integer num = null;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
    ...
    private boolean runGetAppLinkOwners(BasicShellCommandHandler basicShellCommandHandler) {
        String str = null;
        Integer num = null;
        while (true) {
            String nextOption = basicShellCommandHandler.getNextOption();
    ...
    private ArrayList<String> getRemainingArgs(BasicShellCommandHandler basicShellCommandHandler) {
    ...
    private boolean parseEnabled(String str) throws IllegalArgumentException {

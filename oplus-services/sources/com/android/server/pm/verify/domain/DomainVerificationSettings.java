...
class DomainVerificationSettings {
    ...
    public void writeSettings(TypedXmlSerializer typedXmlSerializer, DomainVerificationStateMap<DomainVerificationPkgState> domainVerificationStateMap, Function<String, String> function) {
    }

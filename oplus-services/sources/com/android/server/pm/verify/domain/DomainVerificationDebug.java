...
public class DomainVerificationDebug {
    ...
    boolean printState(IndentingPrintWriter indentingPrintWriter, DomainVerificationPkgState domainVerificationPkgState, AndroidPackage androidPackage, ArrayMap<String, Integer> arrayMap, boolean z) {
        boolean z2;
        arrayMap.clear();
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            Integer valueAt = arrayMap.valueAt(i3);
            indentingPrintWriter.print(keyAt);
            indentingPrintWriter.print(": ");
            indentingPrintWriter.println(DomainVerificationState.stateToDebugString(valueAt.intValue()));
        }
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.decreaseIndent();
        return z2;
    ...
    void printState(IndentingPrintWriter indentingPrintWriter, DomainVerificationPkgState domainVerificationPkgState, AndroidPackage androidPackage, Integer num, ArraySet<String> arraySet, boolean z) {
        if (num == null) {
            return;
        }
    ...
    boolean printState(IndentingPrintWriter indentingPrintWriter, DomainVerificationPkgState domainVerificationPkgState, int i, DomainVerificationInternalUserState domainVerificationInternalUserState, ArraySet<String> arraySet, ArraySet<String> arraySet2, boolean z) {
        boolean z2;
        arraySet.clear();

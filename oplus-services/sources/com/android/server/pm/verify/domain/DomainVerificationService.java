...
public class DomainVerificationService extends SystemService implements DomainVerificationManagerInternal, DomainVerificationShell.Callback {
    ...
    private void removeUserStatesForDomain(DomainVerificationPkgState domainVerificationPkgState, String str) {
            ...
            if (i == -1) {
                for (int i2 : this.mConnection.getAllUserIds()) {
                    ...
                    if (z) {
                        ...
                        orCreateUserState.removeHosts((Set<String>) arraySet);
                    }
                }
            } else {
                ...
                if (z) {
                    ...
                    orCreateUserState2.removeHosts((Set<String>) arraySet);
                }
            }
        }
        this.mConnection.scheduleWriteSettings();
    ...
    @GuardedBy({"mLock"})
    private int revokeOtherUserSelectionsLocked(DomainVerificationInternalUserState domainVerificationInternalUserState, int i, Set<String> set, Computer computer) {
    ...
    private SparseArray<List<String>> getOwnersForDomainInternal(String str, boolean z, final int i, final Computer computer) {
        int i2;
    ...
    private boolean applyImmutableState(PackageStateInternal packageStateInternal, ArrayMap<String, Integer> arrayMap, ArraySet<String> arraySet) {
    ...
    private void printOwnersForPackage(IndentingPrintWriter indentingPrintWriter, String str, Integer num, Computer computer) throws PackageManager.NameNotFoundException {
        PackageStateInternal packageStateInternal = computer.getPackageStateInternal(str);
        AndroidPackageInternal pkg = packageStateInternal == null ? null : packageStateInternal.getPkg();
        if (pkg == null) {
            throw DomainVerificationUtils.throwPackageUnavailable(str);
    ...
    private void printOwnersForDomain(IndentingPrintWriter indentingPrintWriter, String str, Integer num, Computer computer) {
    ...
    @GuardedBy({"mLock"})
    private GetAttachedResult getAndValidateAttachedLocked(UUID uuid, Set<String> set, boolean z, int i, Integer num, Computer computer) throws PackageManager.NameNotFoundException {
    ...
    private void resetDomainState(ArrayMap<String, Integer> arrayMap, PackageStateInternal packageStateInternal) {
    ...
    private int fillMapWithApprovalLevels(ArrayMap<ResolveInfo, Integer> arrayMap, String str, int i, Function<String, PackageStateInternal> function) {
        int size = arrayMap.size();
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            if (arrayMap.valueAt(i3) == null) {
                ...
                if (apply == null) {
                    ...
                    int approvalLevelForDomain = approvalLevelForDomain(apply, str, false, i, false, str);
    ...
    private void filterToLastFirstInstalled(ArrayMap<ResolveInfo, Integer> arrayMap, Function<String, PackageStateInternal> function) {
        int size = arrayMap.size();
        String str = null;
    ...
    private void filterToLastDeclared(List<ResolveInfo> list, Function<String, PackageStateInternal> function) {
    ...
    private int approvalLevelForDomain(PackageStateInternal packageStateInternal, String str, boolean z, int i, boolean z2, Object obj) {
    ...
    */
    private int approvalLevelForDomainInternal(PackageStateInternal packageStateInternal, String str, boolean z, int i, boolean z2, Object obj) {
        String packageName = packageStateInternal.getPackageName();
        AndroidPackageInternal pkg = packageStateInternal.getPkg();
    ...
    @GuardedBy({"mLock"})
    private Pair<List<String>, Integer> getApprovedPackagesLocked(String str, int i, int i2, Computer computer) {

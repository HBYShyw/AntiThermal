...
public class SnapshotStatistics {
    ...
    private final BinMap mUseBins = new BinMap(new int[]{1, 10, 100, 1000, 10000});
    ...
    public class Stats {
        ...
        public void logSnapshotStatistics(int i) {
            ...
            FrameworkStatsLog.write(544, this.mTimes, this.mUsed, this.mMaxBuildTimeUs, this.mMaxUsedCount, i2 == 0 ? 0L : this.mTotalTimeUs / i2, i2 == 0 ? 0 : this.mTotalUsed / i2, i);
        }
    }
    ...
    private void tick() {
        synchronized (this.mLock) {
            ...
            if (currentTimeMicro - this.mLastLogTimeUs > SNAPSHOT_LOG_INTERVAL_US) {
                ...
                this.mLastLogTimeUs = currentTimeMicro;
                this.mLong[r3.length - 1].logSnapshotStatistics(this.mPackageCount);
            }

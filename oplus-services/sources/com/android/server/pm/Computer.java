...
public interface Computer extends PackageDataSnapshot {
    ...
    boolean shouldFilterApplication(PackageStateInternal packageStateInternal, int i, ComponentName componentName, int i2, int i3, boolean z);

    boolean shouldFilterApplicationIncludingUninstalled(SharedUserSetting sharedUserSetting, int i, int i2);

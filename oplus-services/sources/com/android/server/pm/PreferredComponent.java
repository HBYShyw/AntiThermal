...
public class PreferredComponent {
    ...
    public PreferredComponent(Callbacks callbacks, TypedXmlPullParser typedXmlPullParser) throws XmlPullParserException, IOException {
        ...
        int i = 0;
        this.mMatch = typedXmlPullParser.getAttributeIntHex((String) null, ATTR_MATCH, 0);
        int attributeInt = typedXmlPullParser.getAttributeInt((String) null, "set", 0);
        this.mAlways = typedXmlPullParser.getAttributeBoolean((String) null, ATTR_ALWAYS, true);
    ...
    public void writeToXml(TypedXmlSerializer typedXmlSerializer, boolean z) throws IOException {
        ...
        if (z) {
            int i = this.mMatch;
            if (i != 0) {
                typedXmlSerializer.attributeIntHex((String) null, ATTR_MATCH, i);
            }
            typedXmlSerializer.attributeBoolean((String) null, ATTR_ALWAYS, this.mAlways);
    ...
    private boolean sameComponent(ComponentName componentName) {

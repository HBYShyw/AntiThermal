...
public class KeySetManagerService {
    ...
    void addDefinedKeySetsToPackageLPw(PackageSetting packageSetting, Map<String, ArraySet<PublicKey>> map) {
    ...
    void addUpgradeKeySetsToPackageLPw(PackageSetting packageSetting, Set<String> set) {
    ...
    void writePublicKeysLPr(TypedXmlSerializer typedXmlSerializer) throws IOException {
        typedXmlSerializer.startTag((String) null, "keys");
        for (int i = 0; i < this.mPublicKeys.size(); i++) {
            long keyAt = this.mPublicKeys.keyAt(i);
            PublicKeyHandle valueAt = this.mPublicKeys.valueAt(i);
            typedXmlSerializer.startTag((String) null, "public-key");
            typedXmlSerializer.attributeLong((String) null, "identifier", keyAt);
            typedXmlSerializer.attributeBytesBase64((String) null, "value", valueAt.getKey().getEncoded());
            typedXmlSerializer.endTag((String) null, "public-key");
        }
        typedXmlSerializer.endTag((String) null, "keys");
    }

    void writeKeySetsLPr(TypedXmlSerializer typedXmlSerializer) throws IOException {
    ...
    void readKeysLPw(TypedXmlPullParser typedXmlPullParser) throws XmlPullParserException, IOException {
        int depth = typedXmlPullParser.getDepth();
        while (true) {
            int next = typedXmlPullParser.next();
            if (next == 1) {
    ...
    void readKeySetListLPw(TypedXmlPullParser typedXmlPullParser) throws XmlPullParserException, IOException {
        int depth = typedXmlPullParser.getDepth();
        long j = 0;
        while (true) {
            int next = typedXmlPullParser.next();
    ...
    void readPublicKeyLPw(TypedXmlPullParser typedXmlPullParser) throws XmlPullParserException {

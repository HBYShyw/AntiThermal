...
public class PackageProperty {
    ...
    private static <T extends ParsedComponent> ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> addComponentProperties(List<T> list, ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> arrayMap) {
        int size = list.size();
    ...
    private static ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> addProperties(Map<String, PackageManager.Property> map, ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> arrayMap) {
        if (map.size() == 0) {
            return arrayMap;
        }
        if (arrayMap == null) {
    ...
    private static <T extends ParsedComponent> ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> removeComponentProperties(List<T> list, ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> arrayMap) {
        int size = list.size();
    ...
    private static ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> removeProperties(Map<String, PackageManager.Property> map, ArrayMap<String, ArrayMap<String, ArrayList<PackageManager.Property>>> arrayMap) {

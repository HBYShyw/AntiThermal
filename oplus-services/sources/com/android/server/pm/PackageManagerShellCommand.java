...
public class PackageManagerShellCommand extends ShellCommand {
    ...
    private static final Set<String> ART_SERVICE_COMMANDS;
    ...
    IPackageManagerShellCommandExt mPackageManagerScExt = (IPackageManagerShellCommandExt) ExtLoader.type(IPackageManagerShellCommandExt.class).base(this).create();
    ...
    private static String enabledSettingToString(int i) {
        return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? "unknown" : "disabled-until-used" : "disabled-user" : ServiceConfigAccessor.PROVIDER_MODE_DISABLED : ServiceConfigAccessor.PROVIDER_MODE_ENABLED : HealthServiceWrapperHidl.INSTANCE_VENDOR;
    }
    ...
    public int onCommand(String str) {
        ...
        try {
            ...
            switch (c) {
                ...
                case ThermalManagerService.MAX_FORECAST_SEC /* 60 */:
                ...
                default:
                    if (this.mPackageManagerScExt.customMatchedOnCommand(str)) {
                        return this.mPackageManagerScExt.customLogicOnCommand(this, str);
                    }
    ...
    private int runLegacyDexoptCommand(String str) throws RemoteException, Installer.LegacyDexoptDisabledException {
        char c;
    ...
    private int runRollbackApp() throws RemoteException {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                try {
                    Context createPackageContextAsUser = this.mContext.createPackageContextAsUser(VibratorManagerService.VibratorManagerShellCommand.SHELL_PACKAGE_NAME, 0, Binder.getCallingUserHandle());
    ...
    private int runList() throws RemoteException {
        ...
        switch (nextArg.hashCode()) {
            ...
            case 111578632:
                ...
                break;
            case 544550766:
                if (nextArg.equals(ParsingPackageUtils.TAG_INSTRUMENTATION)) {
                    c = 6;
                    break;
                }
                c = 65535;
        ...
        switch (c) {
            ...
            default:
                int customLogicOnRunList = this.mPackageManagerScExt.customLogicOnRunList(this, nextArg);
                if (customLogicOnRunList >= 0) {
                    return customLogicOnRunList;
                }
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int runListPackages(boolean z, boolean z2) throws RemoteException {
        String str;
        int i;
        int i2;
        boolean z3;
                ...
                if (nextOption != null) {
                    ...
                    switch (c) {
                        ...
                        case 11:
                            ...
                            z9 = true;
                        case '\f':
                            i4 |= DumpState.DUMP_COMPILER_STATS;
                        case '\r':
                    ...
                    while (i6 < length) {
                        ...
                        boolean z15 = z11;
                        long j = i4;
                        List list = this.mInterface.getInstalledPackages(j, translateUserId(i8, 0, "runListPackages")).getList();
                        int size = list.size();
                        int i10 = i4;
                        int i11 = 0;
                        while (i11 < size) {
                            ...
                            if (nextArg == null || packageInfo.packageName.contains(nextArg)) {
                                ...
                                if (i5 == -1 || z16 || packageInfo.applicationInfo.uid == i5) {
                                    boolean z17 = (z16 || (packageInfo.applicationInfo.flags & 1) == 0) ? false : true;
                                    i = i5;
                                    boolean z18 = !z16 && packageInfo.applicationInfo.enabled;
                                    if ((!z5 || !z18) && ((!z6 || z18) && ((!z7 || z17) && ((!z8 || !z17) && (!z9 || z16))))) {
                                        if (z2) {
                                            ParceledListSlice declaredSharedLibraries = this.mInterface.getDeclaredSharedLibraries(packageInfo.packageName, j, i8);
                                            if (declaredSharedLibraries != null) {
                                                ...
                                                while (true) {
                                                    if (i14 < size2) {
                                                        SharedLibraryInfo sharedLibraryInfo = (SharedLibraryInfo) list3.get(i14);
                                                        List list4 = list3;
                                                        int i15 = size2;
                                        ...
                                        if (z15) {
                                            sb.append(" stopped=");
                                            sb.append((packageInfo.applicationInfo.flags & DumpState.DUMP_COMPILER_STATS) != 0 ? "true" : "false");
                                        }
                                        if (z12) {
                                            sb.append("  installer=");
    ...
    */
    ...
    private int doRunInstall(InstallParams installParams) throws RemoteException {
        ...
        boolean z3 = (sessionParams.installFlags & 131072) != 0;
        ArrayList<String> remainingArgs = getRemainingArgs();
        boolean z4 = remainingArgs.isEmpty() || STDIN_PATH.equals(remainingArgs.get(0));
    ...
    */
    private int runCompile() throws RemoteException {
        ...
        PrintWriter outPrintWriter = getOutPrintWriter();
        if (this.mPackageManagerScExt.interceptInRunCompile(this)) {
            return 1;
        }
        String str2 = null;
        String str3 = null;
        ...
        while (true) {
            ...
            if (nextOption == null) {
                ...
                if (z2) {
                    ...
                    singletonList.removeIf(new Predicate() { // from class: com.android.server.pm.PackageManagerShellCommand$$ExternalSyntheticLambda1
                        @Override // java.util.function.Predicate
                        public final boolean test(Object obj) {
                            boolean lambda$runCompile$1;
                            lambda$runCompile$1 = PackageManagerShellCommand.lambda$runCompile$1((String) obj);
    ...
    private int runreconcileSecondaryDexFiles() throws RemoteException, Installer.LegacyDexoptDisabledException {
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    private int runBgDexOpt() throws RemoteException, Installer.LegacyDexoptDisabledException {
        char c;
        String nextOption = getNextOption();
        if (nextOption == null) {
            ArrayList arrayList = new ArrayList();
    ...
    private int cancelBgDexOptJob() throws RemoteException, Installer.LegacyDexoptDisabledException {
    ...
    private int runDeleteDexOpt() throws RemoteException {
        ...
        Slog.i(TAG, "delete-dexopt " + nextArg + " ,freed " + deleteOatArtifactsOfPackage + " bytes");
        return 0;
    }

    private int runDumpProfiles() throws RemoteException, Installer.LegacyDexoptDisabledException {
        PrintWriter outPrintWriter = getOutPrintWriter();
        boolean z = false;
        while (true) {
            String nextOption = getNextOption();
    ...
    private int runSnapshotProfile() throws RemoteException {
        ...
        PrintWriter outPrintWriter = getOutPrintWriter();
        String nextArg = getNextArg();
        boolean equals = PackageManagerService.PLATFORM_PACKAGE_NAME.equals(nextArg);
        String str4 = null;
        while (true) {
            String nextArg2 = getNextArg();
            if (nextArg2 != null) {
                ...
                String str5 = Binder.getCallingUid() == 0 ? "root" : VibratorManagerService.VibratorManagerShellCommand.SHELL_PACKAGE_NAME;
                ...
                try {
                        ...
                        if (!equals) {
                            try {
                                if (!Objects.equals(str, str2)) {
                                    str3 = STDIN_PATH + new File(str2).getName();
                                    String str6 = ART_PROFILE_SNAPSHOT_DEBUG_LOCATION + nextArg + str3 + ".prof";
                    ...
                    str3 = "";
                    String str62 = ART_PROFILE_SNAPSHOT_DEBUG_LOCATION + nextArg + str3 + ".prof";
    ...
    */
    private int runSuspend(boolean z) {
        ...
        while (true) {
            ...
            if (nextOption != null) {
                ...
                String str2 = Binder.getCallingUid() == 0 ? "root" : VibratorManagerService.VibratorManagerShellCommand.SHELL_PACKAGE_NAME;
                SuspendDialogInfo build = !TextUtils.isEmpty(str) ? new SuspendDialogInfo.Builder().setMessage(str).build() : null;
                try {
                    int translateUserId = translateUserId(i, -10000, "runSuspend");
                    this.mInterface.setPackagesSuspendedAsUser((String[]) remainingArgs.toArray(new String[0]), z, persistableBundle.size() > 0 ? persistableBundle : null, persistableBundle2.size() > 0 ? persistableBundle2 : null, build, str2, translateUserId);
                    for (int i2 = 0; i2 < remainingArgs.size(); i2++) {
                        String str3 = remainingArgs.get(i2);
    ...
    private String getApexPackageNameContainingPackage(String str) {
        return ApexManager.getInstance().getActiveApexPackageNameContainingPackage(str);
    }

    private boolean isApexApp(String str) {
    ...
    private String getPrivAppPermissionsString(String str, boolean z) {
    ...
    private int runGetOemPermissions() {
        ...
        arrayMap.forEach(new BiConsumer() { // from class: com.android.server.pm.PackageManagerShellCommand$$ExternalSyntheticLambda3
    ...
    */
    ...
    private boolean removeUser(IUserManager iUserManager, int i) throws RemoteException {
    ...
    private boolean removeUserAndWait(IUserManager iUserManager, final int i) throws RemoteException {
        Slog.i(TAG, "Removing (and waiting for completion) user " + i);
    ...
    private int removeUserWhenPossible(IUserManager iUserManager, int i) throws RemoteException {
    ...
    private int runRenameUser() throws RemoteException {
        ...
        String nextArg2 = getNextArg();
        if (nextArg2 == null) {
            Slog.i(TAG, "Resetting name of user " + resolveUserId);
        } else {
            Slog.i(TAG, "Renaming user " + resolveUserId + " to '" + nextArg2 + "'");
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private InstallParams makeInstallParams(Set<String> set) {
                    ...
                    switch (c) {
                        ...
                        case '\t':
                            if (installParams.installerPackageName == null) {
                                installParams.installerPackageName = VibratorManagerService.VibratorManagerShellCommand.SHELL_PACKAGE_NAME;
                            }
                        ...
                        case '\n':
                            ...
                            sessionParams.installFlags |= DumpState.DUMP_APEX;
                            break;
                        case 11:
                        ...
                        case PackageManagerService.MIN_INSTALLABLE_TARGET_SDK /* 23 */:
                            ...
                            break;
                        case 24:
                            sessionParams.installFlags |= DumpState.DUMP_SERVICE_PERMISSIONS;
                            break;
                        case 25:
    ...
    private static String checkAbiArgument(String str) {
        ...
        for (String str2 : (Build.MTK_HBT_ON_64BIT_ONLY_CHIP || Build.QCOM_TANGO_ON_64BIT_ONLY_CHIP) ? Build.MTK_HBT_SUPPORTED_ABIS : Build.SUPPORTED_ABIS) {
            if (str2.equals(str)) {
                return str;
            }
        }
                    ...
                    if (!arrayList.isEmpty() && !STDIN_PATH.equals(arrayList.get(0))) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (next.indexOf(58) == -1) {
                                processArgForLocalFile(next, session2);
                            } else if (processArgForStdin(next, session2) != 0) {
                ...
                try {
                    ...
                    if (STDIN_PATH.equals(str)) {
                        ...
                        if (str != null) {
                            ...
                            session2.write(str2, 0L, j2, parcelFileDescriptor);
                            if (z) {

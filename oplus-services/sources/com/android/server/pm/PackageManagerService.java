...
public class PackageManagerService implements PackageSender, TestUtilityService {
    ...
    public static boolean DEBUG_COMPRESSION = false;
    ...
    public static final int MIN_INSTALLABLE_TARGET_SDK = 23;
    ...
    private final PackageStateMutator mPackageStateMutator = new PackageStateMutator(new Function() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda35
        @Override // java.util.function.Function
        public final Object apply(Object obj) {
            return PackageManagerService.this.getPackageSettingForMutation((String) obj);
        }
    }, new Function() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda36
        @Override // java.util.function.Function
        public final Object apply(Object obj) {
    ...
    static {
        ...
        DEBUG_PER_UID_READ_TIMEOUTS = false;
        DEBUG_DEXOPT = false;
        DEBUG_ABI_SELECTION = false;
        DEBUG_INSTANT = z;
        DEBUG_APP_DATA = false;
        DEBUG_BROADCASTS = false;
        DEBUG_SHARED_LIBRARIES = false;
        EMPTY_INT_ARRAY = new int[0];
        REASON_SHARED = 14;
        REASON_LAST = 14;
        SYSTEM_PARTITIONS = Collections.unmodifiableList(PackagePartitions.getOrderedPartitions(new Function() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda67
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
        ...
        BACKGROUND_HANDLER_CALLBACK = new Handler.Callback() { // from class: com.android.server.pm.PackageManagerService.2
            ...
            public boolean handleMessage(Message message) {
                int i = message.what;
                if (i == 14) {
                    Trace.traceBegin(262144L, "PackageManagerBg writePendingRestrictions");
                ...
                Trace.traceBegin(262144L, "PackageManagerBg writePackageRestrictions");
    ...
    public void notifyInstallObserver(InstallRequest installRequest) {
        ...
        if (DEBUG_INSTALL) {
            ...
            sb.append("notifyInstallObserver ");
            if (installRequest == null) {
                str = null;
            } else {
                str = ", " + installRequest.getName() + ", " + installRequest.getReturnCode() + ", " + installRequest.getReturnMsg();
            }
            sb.append(str);
        ...
        this.mPackageManagerServiceExt.onNotifyInstallObserver(installRequest.getName(), installRequest.getReturnCode());
    }
    ...
    public void scheduleDeferredNoKillInstallObserver(InstallRequest installRequest) {
        ...
        this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(DEFERRED_NO_KILL_INSTALL_OBSERVER, packageName), 500L);
    }
    ...
    public void schedulePruneUnusedStaticSharedLibraries(boolean z) {
        this.mHandler.removeMessages(PRUNE_UNUSED_STATIC_SHARED_LIBRARIES);
        this.mHandler.sendEmptyMessageDelayed(PRUNE_UNUSED_STATIC_SHARED_LIBRARIES, z ? getPruneUnusedSharedLibrariesDelay() : 0L);
    }
    ...
    public void requestFileChecksums(File file, final String str, final int i, final int i2, List list, final IOnChecksumsReadyListener iOnChecksumsReadyListener) throws FileNotFoundException {
        ...
        backgroundExecutor.execute(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda54
    ...
    public /* synthetic */ void lambda$requestFileChecksums$3(final Handler handler, List list, int i, int i2, String str, Certificate[] certificateArr, IOnChecksumsReadyListener iOnChecksumsReadyListener) {
        ApkChecksums.Injector.Producer producer = new ApkChecksums.Injector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda60
        ...
        ApkChecksums.Injector.Producer producer2 = new ApkChecksums.Injector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda61
            @Override // com.android.server.pm.ApkChecksums.Injector.Producer
            public final Object produce() {
        ...
        ApkChecksums.getChecksums(list, i, i2, str, certificateArr, iOnChecksumsReadyListener, new ApkChecksums.Injector(producer, producer2, new PackageManagerService$$ExternalSyntheticLambda41(packageManagerServiceInjector), new ApkChecksums.Injector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda62
            @Override // com.android.server.pm.ApkChecksums.Injector.Producer
            public final Object produce() {
    ...
    public void requestChecksumsInternal(Computer computer, String str, boolean z, final int i, final int i2, List list, final IOnChecksumsReadyListener iOnChecksumsReadyListener, int i3, Executor executor, final Handler handler) {
        ...
        final Certificate[] decodeCertificates = list != null ? decodeCertificates(list) : null;
        executor.execute(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda33
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$requestChecksumsInternal$7(final Handler handler, List list, int i, int i2, String str, Certificate[] certificateArr, IOnChecksumsReadyListener iOnChecksumsReadyListener) {
        ApkChecksums.Injector.Producer producer = new ApkChecksums.Injector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda39
            @Override // com.android.server.pm.ApkChecksums.Injector.Producer
            public final Object produce() {
        ...
        ApkChecksums.Injector.Producer producer2 = new ApkChecksums.Injector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda40
            @Override // com.android.server.pm.ApkChecksums.Injector.Producer
            public final Object produce() {
    ...
    void writePendingRestrictions() {
        synchronized (this.mLock) {
            ...
            synchronized (this.mDirtyUsers) {
                ...
                Integer[] numArr = (Integer[]) this.mDirtyUsers.toArray(new IntFunction() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda34
    ...
    public static PackageManagerService main(final Context context, final Installer installer, final DomainVerificationService domainVerificationService, boolean z) {
        ...
        PackageManagerServiceInjector.Producer producer = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda0
        ...
        PackageManagerServiceInjector.Producer producer2 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda11
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer3 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda22
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer4 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda26
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer5 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda27
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer6 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda28
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer7 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda29
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
                return PackageManagerService.lambda$main$15(packageManagerServiceInjector, packageManagerService);
            }
        };
        PackageManagerServiceInjector.Producer producer8 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda30
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer9 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda31
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer10 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda32
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer11 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda1
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer12 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda2
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
                return PackageManagerService.lambda$main$20(packageManagerServiceInjector, packageManagerService);
            }
        };
        PackageManagerServiceInjector.Producer producer13 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda3
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer14 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda4
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer15 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda5
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer16 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda6
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer17 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda7
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer18 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda8
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer19 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda9
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer20 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda10
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.ProducerWithArgument producerWithArgument = new PackageManagerServiceInjector.ProducerWithArgument() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda12
        ...
        PackageManagerServiceInjector.Producer producer21 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda13
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer22 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda14
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer23 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda15
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.Producer producer24 = new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda16
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        ...
        PackageManagerServiceInjector.ServiceProducer serviceProducer = new PackageManagerServiceInjector.ServiceProducer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda17
        ...
        }, new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda20
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector2, PackageManagerService packageManagerService) {
        ...
        }, new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda21
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector2, PackageManagerService packageManagerService) {
        ...
        }, new PackageManagerServiceInjector.Producer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda23
            @Override // com.android.server.pm.PackageManagerServiceInjector.Producer
            public final Object produce(PackageManagerServiceInjector packageManagerServiceInjector2, PackageManagerService packageManagerService) {
        ...
        CompatChange.ChangeListener changeListener = new CompatChange.ChangeListener() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda25
    ...
    public static /* synthetic */ PlatformCompat lambda$main$14(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        return ServiceManager.getService("platform_compat");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ SystemConfig lambda$main$15(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ ApexManager lambda$main$20(PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
    ...
    public static /* synthetic */ DefaultAppProvider lambda$main$25(final Context context, PackageManagerServiceInjector packageManagerServiceInjector, PackageManagerService packageManagerService) {
        return new DefaultAppProvider(new Supplier() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda63
        ...
        }, new Supplier() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda64
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    public static /* synthetic */ void lambda$main$42(PackageManagerService packageManagerService, String str) {
        synchronized (packageManagerService.mInstallLock) {
            ...
            if (!seInfo2.equals(seInfo)) {
                ...
                packageManagerService.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda38
    ...
    public PackageManagerService(PackageManagerServiceInjector packageManagerServiceInjector, boolean z, String str, boolean z2, boolean z3, int i, String str2) {
        ...
        settings.addSharedUserLPw("android.uid.phone", RADIO_UID, 1, 8);
        settings.addSharedUserLPw("android.uid.log", LOG_UID, 1, 8);
        settings.addSharedUserLPw("android.uid.nfc", 1027, 1, 8);
        settings.addSharedUserLPw("android.uid.bluetooth", BLUETOOTH_UID, 1, 8);
        ...
        this.mResolveIntentHelper = new ResolveIntentHelper(context, preferredActivityHelper, packageManagerServiceInjector.getCompatibility(), userManagerService, domainVerificationManagerInternal, userNeedsBadgingCache, new Supplier() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda43
            @Override // java.util.function.Supplier
            public final Object get() {
                ResolveInfo lambda$new$43;
                lambda$new$43 = PackageManagerService.this.lambda$new$43();
                return lambda$new$43;
            }
        }, new Supplier() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda44
            @Override // java.util.function.Supplier
            public final Object get() {
                ActivityInfo lambda$new$44;
                lambda$new$44 = PackageManagerService.this.lambda$new$44();
        ...
        String string = Resources.getSystem().getString(R.string.config_headlineFontFamilyMedium);
        ...
        this.mPromoteSystemApps = adjustIsUpgradeFlag && internalVersion.sdkVersion <= ENABLE_ROLLBACK_TIMEOUT;
        this.mIsPreNMR1Upgrade = adjustIsUpgradeFlag && internalVersion.sdkVersion < INTEGRITY_VERIFICATION_COMPLETE;
        ...
        if (isDeviceUpgrading()) {
            ...
            while (it.hasNext()) {
                this.mExistingPackages.add(it.next().getPackageName());
            }
        ...
        this.mShouldStopSystemPackagesByDefault = this.mContext.getResources().getBoolean(17891837);
        ...
        if (this.mIsUpgrade && (packageSetting = packagesLocked.get("com.oplus.pantanal.ums")) != null) {
            long versionCode = packageSetting.getVersionCode();
            if (versionCode < 13001182) {
                Slog.d(TAG, "pms detroy ce ums data start");
                try {
                    this.mInstaller.clearAppData(packageSetting.getVolumeUuid(), packageSetting.getPackageName(), 0, 2, packageSetting.getCeDataInode(0));
                } catch (Installer.InstallerException e2) {
                    Slog.d(TAG, e2.getMessage());
                }
                Slog.d(TAG, "pms detroy ce ums data finished. version " + versionCode);
            } else {
                Slog.d(TAG, "pms bypass detroy ce ums data. version " + versionCode);
            }
        }
        ...
        this.mDefaultTextClassifierPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.description_target_unlock_tablet));
        this.mSystemTextClassifierPackageName = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.config_screenRecorderComponent));
        this.mConfiguratorPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.config_systemUIServiceComponent));
        this.mAppPredictionServicePackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.config_mainBuiltInDisplayCutout));
        this.mIncidentReportApproverPackage = ensureSystemPackageName(computerLocked, this.mContext.getString(R.string.country_selection_title));
        ...
        this.mRecentsPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.decline_remote_bugreport_action));
        this.mAmbientContextDetectionPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.config_keyguardComponent));
        this.mWearableSensingPackage = ensureSystemPackageName(computerLocked, getPackageFromComponentString(R.string.config_signalXPath));
        ...
        forEachPackageState(computerLocked, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda45
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PackageManagerService.this.lambda$new$45(userIds, (PackageStateInternal) obj);
            }
        });
        ...
        if (this.mIsUpgrade) {
            FrameworkStatsLog.write(UsbDescriptor.CLASSID_MISC, 13, SystemClock.uptimeMillis() - uptimeMillis);
        }
            ...
            for (Map.Entry entry : systemConfig.getAppMetadataFilePaths().entrySet()) {
                ...
                if (disabledSystemPkgLPr == null) {
                    ...
                    if (packageLPr != null) {
                        ...
                        Slog.w(TAG, "Cannot set app metadata file for nonexistent package " + str8);
                    }
                } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ ResolveInfo lambda$new$43() {
        return this.mResolveInfo;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ ActivityInfo lambda$new$44() {
        return this.mInstantAppInstallerActivity;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$45(int[] iArr, PackageStateInternal packageStateInternal) {
    ...
    private String[] getRequiredButNotReallyRequiredVerifiersLPr(Computer computer) {
    ...
    private String getRequiredServicesExtensionPackageLPr(Computer computer) {
        String ensureSystemPackageName = ensureSystemPackageName(computer, this.mContext.getString(R.string.description_target_unlock_tablet));
    ...
    public ComponentName getInstantAppResolver(Computer computer) {
        String[] stringArray = this.mContext.getResources().getStringArray(R.array.config_priorityOnlyDndExemptPackages);
    ...
    public void freeStorage(String str, long j, int i) throws IOException {
        ...
        if (this.mEnableFreeCacheV2) {
            ...
            if (equals && this.mInstantAppRegistry.pruneInstalledInstantApps(snapshotComputer, j, Settings.Global.getLong(this.mContext.getContentResolver(), "installed_instant_app_min_cache_period", UnixCalendar.WEEK_IN_MILLIS))) {
                return;
            }
            synchronized (this.mInstallLock) {
                try {
                    this.mInstaller.freeCache(str, j, UsbTerminalTypes.TERMINAL_OUT_UNDEFINED);
            ...
            if (equals && this.mInstantAppRegistry.pruneUninstalledInstantApps(snapshotComputer, j, Settings.Global.getLong(this.mContext.getContentResolver(), "uninstalled_instant_app_min_cache_period", UnixCalendar.WEEK_IN_MILLIS))) {
                return;
            }
    ...
    public int checkPermission(String str, String str2, int i) {
        ...
        if (checkPermissionExtAtBegin != null) {
            return checkPermissionExtAtBegin.intValue();
        }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendPackageBroadcast$46(String str, String str2, Bundle bundle, int i, String str3, IIntentReceiver iIntentReceiver, int[] iArr, int[] iArr2, SparseArray sparseArray, Bundle bundle2) {
    ...
    public void sendPackageBroadcast(final String str, final String str2, final Bundle bundle, final int i, final String str3, final IIntentReceiver iIntentReceiver, final int[] iArr, final int[] iArr2, final SparseArray<int[]> sparseArray, final Bundle bundle2) {
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda66
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$sendPackageBroadcast$46(str, str2, bundle, i, str3, iIntentReceiver, iArr, iArr2, sparseArray, bundle2);
            }
        });
    }
    ...
    public void sendPackageAddedForNewUsers(Computer computer, final String str, boolean z, final boolean z2, final int i, final int[] iArr, final int[] iArr2, final int i2) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda47
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$sendPackageAddedForNewUsers$47(str, i, iArr, iArr2, i2, visibilityAllowList);
            }
        });
        if (!z || ArrayUtils.isEmpty(iArr)) {
            return;
        }
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda48
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$sendPackageAddedForNewUsers$48(iArr, str, z2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendPackageAddedForNewUsers$47(String str, int i, int[] iArr, int[] iArr2, int i2, SparseArray sparseArray) {
        this.mBroadcastHelper.sendPackageAddedForNewUsers(str, i, iArr, iArr2, i2, sparseArray);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendPackageAddedForNewUsers$48(int[] iArr, String str, boolean z) {
        for (int i : iArr) {
    ...
    public void unsuspendForSuspendingPackage(Computer computer, final String str, int i) {
        ...
        Objects.requireNonNull(str);
        suspendPackageHelper.removeSuspensionsBySuspendingPackage(computer, strArr, new Predicate() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda49
    ...
    public void setEnableRollbackCode(int i, int i2) {
        Message obtainMessage = this.mHandler.obtainMessage(ENABLE_ROLLBACK_STATUS);
        obtainMessage.arg1 = i;
    ...
    void notifyFirstLaunch(final String str, final String str2, final int i) {
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda50
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$notifyFirstLaunch$49(str, i, str2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$notifyFirstLaunch$49(String str, int i, String str2) {
    ...
    public String getDevicePolicyManagementRoleHolderPackageName(final int i) {
        return (String) Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingSupplier() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda55
            public final Object getOrThrow() {
                String lambda$getDevicePolicyManagementRoleHolderPackageName$50;
                lambda$getDevicePolicyManagementRoleHolderPackageName$50 = PackageManagerService.this.lambda$getDevicePolicyManagementRoleHolderPackageName$50(i);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ String lambda$getDevicePolicyManagementRoleHolderPackageName$50(int i) throws Exception {
    ...
    public void resetComponentEnabledSettingsIfNeededLPw(String str, final int i) {
        ...
        final ArrayList arrayList = new ArrayList();
        Consumer consumer = new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda53
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PackageManagerService.lambda$resetComponentEnabledSettingsIfNeededLPw$51(PackageSetting.this, i, arrayList, (ParsedMainComponent) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$resetComponentEnabledSettingsIfNeededLPw$51(PackageSetting packageSetting, int i, ArrayList arrayList, ParsedMainComponent parsedMainComponent) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$postPreferredActivityChangedBroadcast$52(int i) {
    ...
    public void postPreferredActivityChangedBroadcast(final int i) {
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda68
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$postPreferredActivityChangedBroadcast$52(i);
            }
        });
    }
    ...
    private String getRetailDemoPackageName() {
        ...
        String string2 = this.mContext.getString(R.string.default_audio_route_name);
    ...
    public void updateComponentLabelIcon(final ComponentName componentName, final String str, final Integer num, final int i) {
        ...
        String string = this.mContext.getString(R.string.date_picker_decrement_month_button);
        if (TextUtils.isEmpty(string)) {
        ...
        commitPackageStateMutation(null, packageName, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda52
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PackageManagerService.lambda$updateComponentLabelIcon$53(i, componentName, str, num, (PackageStateWrite) obj);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$updateComponentLabelIcon$53(int i, ComponentName componentName, String str, Integer num, PackageStateWrite packageStateWrite) {
    ...
    public void setEnabledSettings(List<PackageManager.ComponentEnabledSetting> list, int i, String str) {
        ...
        int i6;
        int i7;
        this.mPackageManagerServiceExt.onStartSetEnabledSettingForInformation(list, i, str);
        int callingUid = Binder.getCallingUid();
        snapshotComputer().enforceCrossUserPermission(callingUid, i, false, true, "set enabled");
        int callingPid = Binder.getCallingPid();
        int size = list.size();
        for (int i8 = 0; i8 < size; i8++) {
            int enabledState = list.get(i8).getEnabledState();
        ...
        if (size > 1) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                PackageManager.ComponentEnabledSetting componentEnabledSetting = list.get(i9);
        ...
        synchronized (this.mLock) {
            ...
            int i10 = 0;
            while (i10 < size) {
                PackageManager.ComponentEnabledSetting componentEnabledSetting2 = list.get(i10);
                    ...
                    if (packageLPr != null && !snapshotComputer.shouldFilterApplicationIncludingUninstalled(packageLPr, callingUid, i)) {
                        ...
                        if (callingUid == 2000 && (packageLPr.getFlags() & 256) == 0) {
                            ...
                            if (!componentEnabledSetting2.isComponent()) {
                                ...
                                if (enabledState2 != 3 && enabledState2 != 0 && enabledState2 != i7) {
                                }
                            }
            ...
            for (int i11 = 0; i11 < size; i11++) {
                PackageManager.ComponentEnabledSetting componentEnabledSetting3 = list.get(i11);
        ...
        for (int i12 = 0; i12 < size; i12++) {
            PackageManager.ComponentEnabledSetting componentEnabledSetting4 = list.get(i12);
        ...
        synchronized (this.mLock) {
            ...
            while (i14 < size) {
                if (zArr[i14]) {
                    PackageManager.ComponentEnabledSetting componentEnabledSetting5 = list.get(i14);
                    ...
                    if (!this.mPackageManagerServiceExt.interceptActionInSetEnabledSetting(callingUid, componentEnabledSetting5.getEnabledState(), packageName4)) {
                        ...
                        if (setEnabledSettingInternalLocked(snapshotComputer2, (PackageSetting) arrayMap2.get(packageName4), componentEnabledSetting5, i, str)) {
                            ...
                            if ((componentEnabledSetting5.getEnabledFlags() & 1) == 0) {
                                ...
                                i13 = componentEnabledSetting5.getEnabledFlags() | i4;
                                z2 = true;
                                z4 = true;
                            }
                            i14 = i5 + 1;
            ...
            if (z2) {
                ...
                if (z4 && !this.mHandler.hasMessages(1)) {
                    this.mHandler.sendEmptyMessageDelayed(1, (SystemClock.uptimeMillis() <= this.mServiceStartWithDelay || this.mPackageManagerServiceExt.useLongBroadcastDelayInSetEnabledSetting(i15)) ? 10000L : 1000L);
                }
                long clearCallingIdentity = Binder.clearCallingIdentity();
                try {
                    Computer snapshotComputer3 = snapshotComputer();
                    int i16 = 0;
                    while (i16 < arrayMap3.size()) {
                        String str2 = (String) arrayMap3.keyAt(i16);
                        int i17 = i16;
                        this.mPackageManagerServiceExt.sendPackageChangedBroadcastInSetEnabledSetting(snapshotComputer3, list, str2, (ArrayList) arrayMap3.valueAt(i16), UserHandle.getUid(i, ((PackageSetting) arrayMap2.get(str2)).getAppId()), null, i2);
                        i16 = i17 + 1;
                    }
                } finally {
                    Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public void sendPackageChangedBroadcast(Computer computer, final String str, final boolean z, final ArrayList<String> arrayList, final int i, final String str2) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda59
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$sendPackageChangedBroadcast$54(str, z, arrayList, i, str2, iArr, iArr2, visibilityAllowLists);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendPackageChangedBroadcast$54(String str, boolean z, ArrayList arrayList, int i, String str2, int[] iArr, int[] iArr2, SparseArray sparseArray) {
    ...
    public void systemReady() {
        ...
        this.mExistingPackages = null;
        DeviceConfig.addOnPropertiesChangedListener("package_manager_service", this.mInjector.getBackgroundExecutor(), new DeviceConfig.OnPropertiesChangedListener() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda58
            public final void onPropertiesChanged(DeviceConfig.Properties properties) {
                PackageManagerService.this.lambda$systemReady$55(properties);
            }
        });
        if (!DexOptHelper.useArtService()) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$systemReady$55(DeviceConfig.Properties properties) {
    ...
    private void disableSkuSpecificApps() {
        String[] stringArray = this.mContext.getResources().getStringArray(R.array.config_face_acquire_enroll_ignorelist);
        String[] stringArray2 = this.mContext.getResources().getStringArray(R.array.config_face_acquire_biometricprompt_ignorelist);
    ...
    private void deletePackageIfUnused(Computer computer, final String str) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda51
            @Override // java.lang.Runnable
            public final void run() {
                PackageManagerService.this.lambda$deletePackageIfUnused$56(str);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$deletePackageIfUnused$56(String str) {
    ...
    public void setSystemAppHiddenUntilInstalled(Computer computer, final String str, final boolean z) {
        int callingUid = Binder.getCallingUid();
        boolean z2 = callingUid == RADIO_UID || callingUid == 1000;
        if (!z2) {
        ...
        commitPackageStateMutation(null, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda37
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PackageManagerService.lambda$setSystemAppHiddenUntilInstalled$57(str, z, (PackageStateMutator) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$setSystemAppHiddenUntilInstalled$57(String str, boolean z, PackageStateMutator packageStateMutator) {
        ...
        if (this.mUserManager.exists(i)) {
            ...
            if (computer.getInstantAppPackageName(callingUid) == null) {
                ...
                if (packageStateForInstalledAndFiltered != null && userStateOrDefault.isStopped() != z) {
                    ...
                    commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda56
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            PackageManagerService.lambda$setPackageStoppedState$58(i, z, isNotLaunched, (PackageStateWrite) obj);
                        }
                    });
            ...
            this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda57
                @Override // java.lang.Runnable
                public final void run() {
                    PackageManagerService.this.lambda$setPackageStoppedState$59(str, i);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$setPackageStoppedState$58(int i, boolean z, boolean z2, PackageStateWrite packageStateWrite) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setPackageStoppedState$59(String str, int i) {
    ...
    public class IPackageManagerImpl extends IPackageManagerBase {
        ...
        public void notifyDexLoad(String str, Map<String, String> map, String str2) {
            ...
            if (!PackageManagerServiceUtils.isSystemOrRoot() && !snapshot.isCallerSameApp(str, callingUid, true)) {
                Slog.w(PackageManagerService.TAG, TextUtils.formatSimple("Invalid dex load report. loadingPackageName=%s, uid=%d", new Object[]{str, Integer.valueOf(callingUid)}));
                return;
            }
            ...
            if (dexUseManagerLocal != null) {
                ...
                try {
                    ...
                    if (Build.MTK_HBT_ON_64BIT_ONLY_CHIP && e.getMessage().contains("Unsupported isa 'arm'")) {
                        Slog.w(PackageManagerService.TAG, "Dex with art service is conflict with hbt_translator");
                    } else if (Build.QCOM_TANGO_ON_64BIT_ONLY_CHIP && e.getMessage().contains("Unsupported isa 'arm'")) {
                        Slog.w(PackageManagerService.TAG, "Dex with art service is conflict with tango_translator");
                    } else {
                        throw e;
                    }
                }
            ...
            ApplicationInfo applicationInfo2 = snapshot.getApplicationInfo(str, 0L, identifier);
            if (applicationInfo2 == null) {
                Slog.w(PackageManagerService.TAG, "Loading a package that does not exist for the calling user. package=" + str + ", user=" + identifier);
                return;
            }
            boolean isFirstNotifyDexLoad2 = PackageManagerService.this.mPackageManagerServiceExt.isFirstNotifyDexLoad(applicationInfo2, str, map);
            PackageManagerService.this.mDexManager.notifyDexLoad(applicationInfo2, map, str2, identifier, Process.isIsolated(callingUid));
            if (isFirstNotifyDexLoad2) {
                PackageManagerService.this.mPackageManagerServiceExt.notifyDexLoad(applicationInfo2, str, map, str2);
            }
        }
        ...
        public ParceledListSlice<PackageManager.Property> queryProperty(String str, int i) {
            ...
            List<PackageManager.Property> queryProperty = PackageManagerService.this.mPackageProperty.queryProperty(str, i, new Predicate() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda5
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
        ...
        public void registerDexModule(String str, final String str2, boolean z, final IDexModuleRegisterCallback iDexModuleRegisterCallback) {
            ...
            if (iDexModuleRegisterCallback != null) {
                PackageManagerService.this.mHandler.post(new Runnable() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public boolean setApplicationHiddenSettingAsUser(String str, final boolean z, final int i) {
            ...
            try {
                ...
                if (userStateOrDefault.isHidden() != z && userStateOrDefault.isInstalled() && !snapshotComputer.shouldFilterApplication(packageStateInternal, callingUid, i)) {
                    ...
                    PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda6
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
        ...
        public void setInstallerPackageName(final String str, final String str2) {
            ...
            FunctionalUtils.ThrowingCheckedFunction throwingCheckedFunction = new FunctionalUtils.ThrowingCheckedFunction() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda8
                public final Object apply(Object obj) {
            ...
            if (((Boolean) throwingCheckedFunction.apply(PackageManagerService.this.snapshotComputer())).booleanValue()) {
                ...
                synchronized (PackageManagerService.this.mLock) {
                    PackageStateMutator.Result commitPackageStateMutation = PackageManagerService.this.commitPackageStateMutation(recordInitialState, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda9
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
        ...
        public void relinquishUpdateOwnership(String str) {
            ...
            PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda4
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        public void setMimeGroup(final String str, final String str2, List<String> list) {
            ...
            PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda20
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
            ...
            if (packageManagerService.mComponentResolver.updateMimeGroup(packageManagerService.snapshotComputer(), str, str2)) {
                Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda21
        ...
        public boolean setRequiredForSystemUser(String str, final boolean z) {
            ...
            if (!PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda7
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        public void setSplashScreenTheme(String str, final String str2, final int i) {
            ...
            PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda11
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        public void setUpdateAvailable(String str, final boolean z) {
            ...
            PackageManagerService.this.commitPackageStateMutation(null, str, new Consumer() { // from class: com.android.server.pm.PackageManagerService$IPackageManagerImpl$$ExternalSyntheticLambda17
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public class PackageManagerInternalImpl extends PackageManagerInternalBase {
        ...
        public boolean isPlatformSigned(String str) {
            PackageStateInternal packageStateInternal = m2045snapshot().getPackageStateInternal(str);
            if (packageStateInternal == null) {
                return false;
            }
        ...
        public boolean isDataRestoreSafe(byte[] bArr, String str) {
            SigningDetails signingDetails = m2045snapshot().getSigningDetails(str);
        ...
        public boolean hasSignatureCapability(int i, int i2, @SigningDetails.CertCapabilities int i3) {
            Computer m2045snapshot = m2045snapshot();
            SigningDetails signingDetails = m2045snapshot.getSigningDetails(i);
            SigningDetails signingDetails2 = m2045snapshot.getSigningDetails(i2);
        ...
        public PackageList getPackageList(PackageManagerInternal.PackageListObserver packageListObserver) {
            final ArrayList arrayList = new ArrayList();
            PackageManagerService.this.forEachPackageState(m2045snapshot(), new Consumer() { // from class: com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        public String getDisabledSystemPackageName(String str) {
            PackageStateInternal disabledSystemPackage = m2045snapshot().getDisabledSystemPackage(str);
        ...
        public List<String> getTargetPackageNames(int i) {
            final ArrayList arrayList = new ArrayList();
            PackageManagerService.this.forEachPackageState(m2045snapshot(), new Consumer() { // from class: com.android.server.pm.PackageManagerService$PackageManagerInternalImpl$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        public void uninstallApex(String str, long j, int i, IntentSender intentSender, int i2) {
            ...
            PackageInfo packageInfo = m2045snapshot().getPackageInfo(str, 1073741824L, 0);
            if (packageInfo == null) {
        ...
        public void setIntegrityVerificationResult(int i, int i2) {
            Message obtainMessage = PackageManagerService.this.mHandler.obtainMessage(PackageManagerService.INTEGRITY_VERIFICATION_COMPLETE);
            obtainMessage.arg1 = i;
        ...
        public boolean isSameApp(String str, long j, int i, int i2) {
            ...
            return UserHandle.isSameApp(m2045snapshot().getPackageUid(str, j, i2), i);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setEnabledOverlayPackages(final int i, final ArrayMap<String, OverlayPaths> arrayMap, final Set<String> set, Set<String> set2) {
        int i2;
        String str;
        ...
        synchronized (this.mOverlayPathsLock) {
            ...
            commitPackageStateMutation(null, new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda65
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PackageManagerService.lambda$setEnabledOverlayPackages$60(size, arrayMap, set, i, arrayMap3, (PackageStateMutator) obj);
                }
            });
        }
        if (i == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$setEnabledOverlayPackages$60(int i, ArrayMap arrayMap, Set set, int i2, ArrayMap arrayMap2, PackageStateMutator packageStateMutator) {
    ...
    void forEachPackageInternal(Computer computer, Consumer<AndroidPackageInternal> consumer) {
        ArrayMap<String, ? extends PackageStateInternal> packageStates = computer.getPackageStates();
        int size = packageStates.size();
        for (int i = 0; i < size; i++) {
            PackageStateInternal valueAt = packageStates.valueAt(i);
    ...
    public void forEachInstalledPackage(Computer computer, final Consumer<AndroidPackage> consumer, final int i) {
        forEachPackageState(computer.getPackageStates(), new Consumer() { // from class: com.android.server.pm.PackageManagerService$$ExternalSyntheticLambda46
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PackageManagerService.lambda$forEachInstalledPackage$61(i, consumer, (PackageStateInternal) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$forEachInstalledPackage$61(int i, Consumer consumer, PackageStateInternal packageStateInternal) {
    ...
    public static boolean isPreapprovalRequestAvailable() {
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            if (Resources.getSystem().getBoolean(17891724)) {
                return DeviceConfig.getBoolean("package_manager_service", PROPERTY_IS_PRE_APPROVAL_REQUEST_AVAILABLE, true);
            }
            Binder.restoreCallingIdentity(clearCallingIdentity);
            return false;
        } finally {
    ...
    public static boolean isUpdateOwnershipEnforcementAvailable() {
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            return DeviceConfig.getBoolean("package_manager_service", PROPERTY_IS_UPDATE_OWNERSHIP_ENFORCEMENT_AVAILABLE, true);
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        }
    }
    ...
    private PerUidReadTimeouts[] parsePerUidReadTimeouts(Computer computer) {
        ...
        for (int i2 = 0; i2 < size; i2 = i + 1) {
            PerPackageReadTimeouts perPackageReadTimeouts = parseDigestersList.get(i2);

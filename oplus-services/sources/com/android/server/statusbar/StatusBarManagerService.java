...
public class StatusBarManagerService extends IStatusBarService.Stub implements DisplayManager.DisplayListener {
    ...
    private int mLastSystemKey;
    private final Object mLock;
    private NotificationDelegate mNotificationDelegate;
    private IOverlayManager mOverlayManager;
    private final PackageManagerInternal mPackageManagerInternal;
    private IStatusBarManagerServiceExt mSBMS;
    ...
    private class DeathRecipient implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            ...
            StatusBarManagerService.this.mSBMS.maybeClearAllNotifications();
        }
    ...
    public StatusBarManagerService(Context context) {
        ...
        StatusBarManagerInternal statusBarManagerInternal = new StatusBarManagerInternal() { // from class: com.android.server.statusbar.StatusBarManagerService.1
            ...
            public void collapsePanels() {
                if (StatusBarManagerService.this.mBar != null) {
                    ...
                    StatusBarManagerService.this.mSBMS.collapsePanels();
                }
            }
            ...
            public boolean showShutdownUi(boolean z, String str) {
                if (StatusBarManagerService.this.mContext.getResources().getBoolean(17891815) && StatusBarManagerService.this.mBar != null) {
                    try {
        ...
        IStatusBarManagerServiceExt iStatusBarManagerServiceExt = (IStatusBarManagerServiceExt) ExtLoader.type(IStatusBarManagerServiceExt.class).base(this).create();
        this.mSBMS = iStatusBarManagerServiceExt;
        iStatusBarManagerServiceExt.init(context);
    ...
    public void disable(int i, IBinder iBinder, String str) {
        Slog.i(TAG, "disable, what:" + i + ", pkg:" + str + " token:" + iBinder);
    ...
    private void disableLocked(int i, int i2, int i3, IBinder iBinder, String str, int i4) {
        ...
        if (this.mBar != null) {
            try {
                Slog.i(TAG, "disableLocked, what:" + Integer.toHexString(i3) + ", pkg:" + str + " userId: " + i2 + " token:" + iBinder + " net1:" + Integer.toHexString(gatherDisableActionsLocked) + " net2:" + Integer.toHexString(gatherDisableActionsLocked2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public UiState getUiState(int i) {
    ...
    public static class UiState {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setBarAttributes(int i, AppearanceRegion[] appearanceRegionArr, boolean z, int i2, int i3, String str, LetterboxDetails[] letterboxDetailsArr) {
            this.mAppearance = i;
    ...
    private boolean checkCanCollapseStatusBar(String str) {
        ...
        Slog.e(TAG, "Permission Denial: Method " + str + "() requires permission android.permission.STATUS_BAR, ignoring call.");
        return false;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean clearTileAddRequest(String str) {
        boolean z;
        synchronized (this.mCurrentRequestAddTilePackages) {
    ...
    public String[] getStatusBarIcons() {
        return this.mContext.getResources().getStringArray(17236147);
    }

...
public class CarrierMessagingClientServiceFinder extends AppServiceFinder<CarrierMessagingClientService, ICarrierMessagingClientService> {
    ...
    @Override // com.android.server.appbinding.finders.AppServiceFinder
    protected boolean isEnabled(AppBindingConstants appBindingConstants) {
        return appBindingConstants.SMS_SERVICE_ENABLED && this.mContext.getResources().getBoolean(17891889);
    }
    ...
    @Override // com.android.server.appbinding.finders.AppServiceFinder
    protected String validateService(ServiceInfo serviceInfo) {

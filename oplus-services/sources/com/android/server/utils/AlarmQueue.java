...
public abstract class AlarmQueue<K> implements AlarmManager.OnAlarmListener {
    ...
    public static class AlarmPriorityQueue<Q> extends PriorityQueue<Pair<Q, Long>> {
        private static final Comparator<Pair<?, Long>> sTimeComparator = new Comparator() { // from class: com.android.server.utils.AlarmQueue$AlarmPriorityQueue$$ExternalSyntheticLambda0
    ...
    private void setNextAlarmLocked(long j) {
        ...
        long min = Math.min(SIGNIFICANT_TRIGGER_TIME_CHANGE_THRESHOLD_MS, this.mMinTimeBetweenAlarmsMs);
        long j2 = this.mTriggerTimeElapsed;

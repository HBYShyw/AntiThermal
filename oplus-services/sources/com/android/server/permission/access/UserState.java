...
public final class UserState extends WritableState {
    ...
    @NotNull
    private final ArrayMap<String, ArrayMap<String, Integer>> packageAppOpModes;

    @NotNull
    private final SparseArray<ArrayMap<String, Integer>> uidAppOpModes;

    @NotNull
    private final SparseArray<ArrayMap<String, Integer>> uidPermissionFlags;
    ...
    private UserState(SparseArray<ArrayMap<String, Integer>> sparseArray, SparseArray<ArrayMap<String, Integer>> sparseArray2, ArrayMap<String, ArrayMap<String, Integer>> arrayMap) {

...
public final class PackageAppOpPolicy extends BaseAppOpPolicy {
    ...
    public static abstract class OnAppOpModeChangedListener {
        public abstract void onAppOpModeChanged(@NotNull String str, int i, @NotNull String str2, int i2, int i3);
    ...
    @Nullable
    public final ArrayMap<String, Integer> getAppOpModes(@NotNull GetStateScope getStateScope, @NotNull String str, int i) {
        return getStateScope.getState().getUserStates().get(i).getPackageAppOpModes().get(str);
    }

    public final boolean removeAppOpModes(@NotNull MutateStateScope mutateStateScope, @NotNull String str, int i) {
    ...
    public final int getAppOpMode(@NotNull GetStateScope getStateScope, @NotNull String str, int i, @NotNull String str2) {
        int indexOfKey;
    ...
    public final boolean setAppOpMode(@NotNull MutateStateScope mutateStateScope, @NotNull String str, int i, @NotNull String str2, int i2) {
        int indexOfKey;
        UserState userState = mutateStateScope.getNewState().getUserStates().get(i);

...
public final class FrameworkStatsLog {
    ...
    public static void write(int i, int[] iArr, String[] strArr, int i2, int i3, int i4, boolean z, int i5, int i6, int i7, long j, long j2, long j3, long j4, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int i15, int i16) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeAttributionChain(iArr == null ? new int[0] : iArr, strArr == null ? new String[0] : strArr);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
        newBuilder.writeInt(i4);
    ...
    public static void write(int i, int[] iArr, String[] strArr, String str, int i2, int i3, int i4, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, boolean z11, int i6, int i7, int i8, long j2, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, boolean z18, boolean z19, long j3, boolean z20, boolean z21, boolean z22, long j4, long j5, long j6, int i9, int i10, String str2) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeAttributionChain(iArr == null ? new int[0] : iArr, strArr == null ? new String[0] : strArr);
        newBuilder.writeString(str);
    ...
    public static void write(int i, int i2, int i3, boolean z, int i4, int i5, int i6, int i7, int i8, int i9, boolean z2, int[] iArr, int[] iArr2, String[] strArr, int[] iArr3, String str, int[] iArr4, int[] iArr5, int i10, boolean z3) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, boolean z, int i4, int i5, int i6, String[] strArr, int[] iArr, int[] iArr2, int[] iArr3, int i7, String[] strArr2, int[] iArr4, String[] strArr3, int[] iArr5, int[] iArr6, int[] iArr7, int i8, String[] strArr4, int[] iArr8, int i9, boolean z2) {
        ...
        newBuilder.writeIntArray(iArr3 == null ? new int[0] : iArr3);
        newBuilder.writeInt(i7);
        newBuilder.writeStringArray(strArr2 == null ? new String[0] : strArr2);
        newBuilder.writeIntArray(iArr4 == null ? new int[0] : iArr4);
        newBuilder.writeStringArray(strArr3 == null ? new String[0] : strArr3);
        newBuilder.writeIntArray(iArr5 == null ? new int[0] : iArr5);
        newBuilder.writeIntArray(iArr6 == null ? new int[0] : iArr6);
        newBuilder.writeIntArray(iArr7 == null ? new int[0] : iArr7);
        newBuilder.writeInt(i8);
        newBuilder.writeStringArray(strArr4 == null ? new String[0] : strArr4);
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, int i6, boolean z, int i7, byte[] bArr, boolean z2) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, boolean z, int i13, int i14, int i15, int i16, int i17, boolean z2, boolean z3, boolean z4, int i18, int i19, long j, long j2, int i20, int i21, int i22, int i23) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, long j, int i6, String[] strArr, int[] iArr, boolean z) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, int i4, int i5, String str, String str2, int i6, int i7) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (477 == i) {
    ...
    public static void write(int i, int i2, int i3, long j, boolean z, int i4, float f) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, String str, int i4, boolean z, int i5, String str2, String str3, int i6, String str4, String str5, int i7, int i8) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (476 == i) {
    ...
    public static void write(int i, int i2, int i3, String str, int i4, int i5, int i6, int i7, int i8, boolean z, String str2, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, float f, boolean z2, boolean z3, long j, boolean z4, long j2) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeInt(i3);
    ...
    public static void write(int i, int i2, int i3, String str, int i4, int i5, long j, long j2, long j3, int i6, String str2, String str3, int i7, int i8, int i9, int i10, int i11, int i12) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (475 == i) {
    ...
    public static void write(int i, int i2, long j, int i3, int i4, int i5, int i6, int i7) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (581 == i) {
    ...
    public static void write(int i, int i2, long j, long j2, long j3, long j4, long j5, long j6, int i3) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeLong(j);
    ...
    public static void write(int i, int i2, String str, int i3, boolean z, int i4, int i5, int i6, int i7, int i8, boolean z2, boolean z3, int i9, int i10, int i11, boolean z4, int i12, int i13, boolean z5, int i14, int i15, int i16, int[] iArr, long[] jArr, int i17, int i18, int i19, int i20, long j, long j2) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (60 == i) {
    ...
    public static void write(int i, int i2, String str, int i3, String str2, boolean z, int i4, String str3, String str4, int i5, int i6, int i7, boolean z2, int i8) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (495 == i) {
    ...
    public static void write(int i, int i2, String str, int i3, String str2, String str3, boolean z, long j, int i4, int i5, int i6, int i7, int i8, String str4, int i9, int i10, int i11, int i12, boolean z2, boolean z3, boolean z4, int i13, long j2, int i14, int i15, int i16) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (48 == i) {
    ...
    public static void write(int i, long j, int i2, String str, int i3, String str2, int i4, boolean z, int i5, int i6, int i7, long j2, long j3, boolean z2, int i8, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, String str3, int i9, long j4, int i10, int i11, boolean z3) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeLong(j);
        newBuilder.writeInt(i2);
    ...
    public static void write(int i, String str, int i2, int i3, int i4) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeString(str);
        newBuilder.writeInt(i2);
    ...
    public static void write_non_chained(int i, int i2, String str, int i3, int i4, int i5, boolean z, int i6, int i7, int i8, long j, long j2, long j3, long j4, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i16, int i17) {
        write(i, new int[]{i2}, new String[]{str}, i3, i4, i5, z, i6, i7, i8, j, j2, j3, j4, i9, i10, i11, i12, i13, i14, i15, iArr, iArr2, iArr3, iArr4, i16, i17);
    }

    public static void write_non_chained(int i, int i2, String str, int i3, long j) {
        write(i, new int[]{i2}, new String[]{str}, i3, j);
    }

    public static void write_non_chained(int i, int i2, String str, int i3, String str2, int i4, int i5) {
        write(i, new int[]{i2}, new String[]{str}, i3, str2, i4, i5);
    }

    public static void write_non_chained(int i, int i2, String str, int i3, String str2, int i4, int i5, int i6) {
        write(i, new int[]{i2}, new String[]{str}, i3, str2, i4, i5, i6);
    }

    public static void write_non_chained(int i, int i2, String str, String str2, int i3) {
        write(i, new int[]{i2}, new String[]{str}, str2, i3);
    }

    public static void write_non_chained(int i, int i2, String str, String str2, int i3, int i4) {
        write(i, new int[]{i2}, new String[]{str}, str2, i3, i4);
    }
    ...
    public static void write_non_chained(int i, int i2, String str, String str2, int i3, int i4, int i5, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i6, boolean z11, int i7, int i8, int i9, long j2, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, boolean z18, boolean z19, long j3, boolean z20, boolean z21, boolean z22, long j4, long j5, long j6, int i10, int i11, String str3) {
        write(i, new int[]{i2}, new String[]{str}, str2, i3, i4, i5, j, z, z2, z3, z4, z5, z6, z7, z8, z9, z10, i6, z11, i7, i8, i9, j2, z12, z13, z14, z15, z16, z17, z18, z19, j3, z20, z21, z22, j4, j5, j6, i10, i11, str3);
    }

    public static void write_non_chained(int i, int i2, String str, String str2, String str3, int i3) {
        write(i, new int[]{i2}, new String[]{str}, str2, str3, i3);
    }
    ...
    public static StatsEvent buildStatsEvent(int i, boolean z, boolean z2) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeBoolean(z);
        newBuilder.writeBoolean(z2);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, boolean z, boolean z2, int i3, String str, int i4, byte[] bArr) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        newBuilder.writeBoolean(z);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, boolean z, int i3, long j, long j2, long j3, long j4) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        if (10083 == i) {
            newBuilder.addBooleanAnnotation((byte) 2, true);
    ...
    public static StatsEvent buildStatsEvent(int i, int i2, int i3, int i4, int i5, boolean z) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeInt(i2);
        if (10071 == i) {
    ...
    public static StatsEvent buildStatsEvent(int i, String str, String str2, long j, long j2, long j3) {
        StatsEvent.Builder newBuilder = StatsEvent.newBuilder();
        newBuilder.setAtomId(i);
        newBuilder.writeString(str);
        newBuilder.writeString(str2);
    ...
    public static void write(int i, WorkSource workSource, int i2) {
        ...
        if (workChains != null) {
            for (WorkSource.WorkChain workChain : workChains) {
    ...
    public static void write(int i, WorkSource workSource, int i2, int i3, int i4, boolean z, int i5, int i6, int i7, long j, long j2, long j3, long j4, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i15, int i16) {
    ...
    public static void write(int i, WorkSource workSource, String str, int i2, int i3, int i4, long j, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, boolean z11, int i6, int i7, int i8, long j2, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, boolean z18, boolean z19, long j3, boolean z20, boolean z21, boolean z22, long j4, long j5, long j6, int i9, int i10, String str2) {
        for (int i11 = 0; i11 < workSource.size(); i11++) {
            write_non_chained(i, workSource.getUid(i11), workSource.getPackageName(i11), str, i2, i3, i4, j, z, z2, z3, z4, z5, z6, z7, z8, z9, z10, i5, z11, i6, i7, i8, j2, z12, z13, z14, z15, z16, z17, z18, z19, j3, z20, z21, z22, j4, j5, j6, i9, i10, str2);
        }
        List<WorkSource.WorkChain> workChains = workSource.getWorkChains();
        if (workChains != null) {
            for (WorkSource.WorkChain workChain : workChains) {
                write(i, workChain.getUids(), workChain.getTags(), str, i2, i3, i4, j, z, z2, z3, z4, z5, z6, z7, z8, z9, z10, i5, z11, i6, i7, i8, j2, z12, z13, z14, z15, z16, z17, z18, z19, j3, z20, z21, z22, j4, j5, j6, i9, i10, str2);
            }
        }
    }
